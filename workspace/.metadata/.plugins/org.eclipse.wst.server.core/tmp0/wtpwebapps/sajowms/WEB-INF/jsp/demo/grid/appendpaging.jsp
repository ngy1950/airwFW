...
<script type="text/javascript">
	...
	function gridEventPageEnd(gridId, dataCount){
		commonUtil.debugMsg("gridEventPageEnd : ", arguments);
	}
...
<div class="contentHeader">
	<div class="util">
		<button CB="Append SEARCH BTN_DISPLAY"></button>
