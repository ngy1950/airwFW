...
<script type="text/javascript">
	$(document).ready(function(){
		...
		gridList.setGrid({
	    	id : "gridListPaging",
			url : "/demo/Demo/paging/json/DEMOITEM.data",
			pageCount : 15
	    });
	});
	...
	function searchList(){
		if(validate.check("searchArea")){
			gridList.pageList("gridList", 1);
			gridList.pageList("gridListPaging", 1);
		}
	}
			...
			<div class="bottomSect type1">
				<div class="tabs">
					<ul class="tab type2">
						...
						<li><a href="#tabs1-2"><span CL='STD_SEARCH'>탭메뉴1</span></a></li>
					</ul>
					<div id="tabs1-1">
