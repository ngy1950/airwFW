...
<!-- 그리드 세개  -->
<script  type="text/javascript" src="/common/js/head-w.js"></script>
<script type="text/javascript">
	midAreaHeightSet = "250px"; 
...
<div class="content">
	<div class="innerContainer">
		...
		<div class="contentContainer">
			...
			<div class="bottomSect top" style="height:250px">
				<button type="button" class="button type2 fullSizer2 folded"><img src="/common/images/ico_full.png" alt="Full Size"></button>
				<div class="tabs">
					<ul class="tab type2">
