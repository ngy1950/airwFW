...
<frameset id="topFrame" name="topFrame" rows="50px,*" noresize framespacing=0 frameborder=no border=0 >
    <frame id="header" name="header" src="/gsfresh/top.data" noresize framespacing=0 frameborder=no border=0 >
    <frameset id="middleFrame" name="middleFrame" cols="251px,*" noresize framespacing=0 frameborder=no border=0 >
        ...
        <frame id="left" name="left" src="/gsfresh/left.data" name="lnb" noresize framespacing=0 frameborder=no border=0>
        <frameset id="rightFrame" name="rightFrame" rows="25px,*,0,0,0,0,0" noresize framespacing=0 frameborder=no border=0 >
			<frame id="nav" name="nav" src="/gsfresh/wintab.page" noresize framespacing=0 frameborder=no border=0 >
			<frame id="main" name="main" src="/gsfresh/dash.page" noresize framespacing=0 frameborder=no border=0>
