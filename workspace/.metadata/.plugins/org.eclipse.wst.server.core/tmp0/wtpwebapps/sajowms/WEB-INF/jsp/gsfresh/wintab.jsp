...
<link rel="stylesheet" type="text/css" href="/common/theme/gsfresh/css/wintab.css">
...
<div class="tab type1" id="windowTabs">
	...
	<div class="menu-info" id="pathTitle">
		<div class="all_close" id="allClose">
			<img src="/common<%=theme%>/images/btn_closeAll-black.png" alt="close" onClick="closeAll()" /> 		
		</div>
		 <div class="tab_list" id="tabList">
			<img src="/common/theme/gsfresh/images/login/list_left.png" alt="left"  id="winTabLeft" onClick="tabLeft()"  />
			<img src="/common/theme/gsfresh/images/login/list_right.png" alt="right" id="winTabRight" onClick="tabRight()" />
		</div>
	</div>
	<ul id="multiList">
