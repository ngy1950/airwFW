...
<link rel="stylesheet" type="text/css" href="/common/theme/joongwon/css/login.css">
...
function loginEnd(json, param){
	if(json && json.data){
		if(json.data == "F"){
			...
			this.location.href = "/joongwon/main.page";
		}
	}
}
...
<body style="display:none">
	<div class="bg">
		<!-- <img src="/common/theme/joongwon/images/login/loginbg.jpg">
		<img src="/common/theme/joongwon/images/login/loginbg2.jpg"> -->
		
	</div>
		<div class="GSRetail"><img src="/common/theme/joongwon/image/logo.png" /></div>
		<div class="loginWrap">
			<h3>창고관리 시스템<span>생활을 더하다, 가치를 채우다.</span></h3>
			<div class="innerWrap" id="searchArea">
				...
				<input type="hidden" id="WAREKY" name="WAREKY" value="WH1"/>
				<input type="hidden" id="LANGKY" name="LANGKY" value="KO"/>
	...
	<div class="contact">
		<p class="copywrite">COPYRIGHT ⓒ2020 <span>JOONGWON.</span> ALL RIGHTS RESERVED.</p>
