...
<link rel="stylesheet" type="text/css" href="/common/theme/joongwon/css/left.css">
...
<div class="lnb">
	<div class="icons">
		...
		<button type="button" class="favorite" onclick="fmenuInsert()"><img src="/common/theme/joongwon/image/favourite.png" alt="favorite" /></button>
		<button type="button" class="reload" onclick="window.top.refreshPage()"><img src="/common/theme/joongwon/image/reload.png" alt="favorite" /></button>
		<div class="rightArea">
