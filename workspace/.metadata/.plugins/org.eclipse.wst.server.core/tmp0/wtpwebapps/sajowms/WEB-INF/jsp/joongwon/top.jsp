...
<link rel="stylesheet" type="text/css" href="/common/theme/joongwon/css/top.css">
	...
	<div class="innerContainer">
		<span class="logo" id="effect">
			<a href="#" onClick="window.top.reloadPage()">
				<img src="/common/theme/joongwon/image/logo.png" alt="" />
			</a>
		</span><!--//logo-->
		...
		<div class="rightArea" id="searchArea">
			...
			<div class="util">
				<p class="user"><span>안녕하세요,<%=username%>님</span></p>
