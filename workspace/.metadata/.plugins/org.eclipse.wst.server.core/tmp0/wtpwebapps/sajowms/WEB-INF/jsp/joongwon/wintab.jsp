...
<link rel="stylesheet" type="text/css" href="/common/theme/joongwon/css/wintab.css">
...
<button type="button" class="checkList" onclick="sizeToggle(this)"><img src="/common/theme/hwls/images/wintab/checkList.png" alt="checkList" /></button>
<button type="button" class="allClose"><img src="/common/theme/joongwon/image/allclose.png" alt="close" onClick="closeAll()" /></button>
...
<div class="tab type1" id="windowTabs">
	<div class="menu-info" id="pathTitle">
		...
		<div class="tab_list" id="tabList">
			<img src="/common/theme/joongwon/image/ico_lnb_closer.png" alt="left"  id="winTabLeft" onClick="tabLeft()" style="display:none" />
			<img src="/common/theme/joongwon/image/ico_lnb_closel.png" alt="right" id="winTabRight" onClick="tabRight()" style="display:none;" />
		</div>
	</div>
	<ul id="multiList">
