...
<script>
	...
	function sendData(){
		...
		if($obj.val() == ""){
			...
			location.href="/mobile/MGR01_list.page?SEBELN="+$obj.val();
		}
	}
...
/* 	function linkPopCloseEvent(data){
	...
	function linkPopupOpen(){
		var $obj = $("#SEBELN");
		mobile.linkPopOpen('/mobile/MGR01_search.page',$obj.val());
	} */
			...
			<div class="search">
				<table>
					...
					<tbody>
						...
						<!-- 	<td>
								<input type="button" value="SearchHelp" class="bt" onclick="linkPopupOpen()"/>
							</td> -->
							<td>
