<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String SEBELN = (String)request.getParameter("SEBELN");
	String SEBELP = (String)request.getParameter("SEBELP");
...
$(document).ready(function(){
	...
	param.put("SEBELN", data.get("SEBELN"));
	param.put("SEBELP", data.get("SEBELP"));
	...
	function saveData() {
		...
		param.put("list",list); 
		param.put("SEBELN",  $("[name=SEBELN]").val());
		param.put("SEBELP",  $("[name=SEBELP]").val());
		
		var json = netUtil.sendData({
	        url:"/mobile/Mobile/json/SaveMGR06_whyfail.data",
			param : param
		});  
...
<body>
		...
		<div class="w_table_wrap">
			...
			<table>
					...
					<tbody >
						<tr><input type="hidden" name="TMPNUM" /><input type="hidden" name="SEBELN" /><input type="hidden" name="SEBELP" /></tr>
						<tr>
							<th>품번</th>
