...
<script>
	...
	function sendData(){
		...
		if($obj.val() == ""){
			...
			location.href="/mobile/MPT02_list.page?TASKKY="+$obj.val();
		}
	}
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="text" class="text" id="TASKKY"  onfocus="clearText(this)" onkeypress="commonUtil.enterKeyCheck(event, 'sendData()')"/>
							</td>
							<td>
