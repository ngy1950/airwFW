...
.dT{
	...
	font-weight: bold;
	font-size: 15px;
	background: url(/common/images/ico-right-arrow.png) no-repeat;
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		mobileSearchHelp.setSearchHelp({
			...
			returnCol	: "COL1",
			bindId		: "scanArea",
			title 		: "Mobile PopUp Type2",
			inputType	: "scanNumber",
			searchType	: "in", 
			search 		:	[
								{"type":"select", "label":"DEMO_COMBO", "name":"COMBO1", "combo":"Mobile,DEMO_POP_COMBO", "codeView":false, "colspan":2},
		...
		mobileSearchHelp.setSearchHelp({
			...
			searchType	: "out", 
			search 		:	[
								{"type":"select", "label":"DEMO_COMBO", "name":"COMBO2", "combo":"Mobile,DEMO_POP_COMBO", "codeView":false},
	...
	function comboEventDataBindeBefore(comboAtt,paramName){
		var param = new DataMap();
		if(comboAtt == "Mobile,DEMO_COMBO"){
			param.put("TYPE","type1");
			return param;
		}else if(comboAtt == "Mobile,DEMO_POP_COMBO"){
			...
			<div class="scan_area">
				<table id="scanArea">
					...
					<tbody>
						...
						<tr>
							<td class="dC">
								<select name="DEV_COMBO" Combo="Mobile,DEMO_COMBO" UISave="false" ComboCodeView=false></select>
							</td>
						</tr>
						<tr>
