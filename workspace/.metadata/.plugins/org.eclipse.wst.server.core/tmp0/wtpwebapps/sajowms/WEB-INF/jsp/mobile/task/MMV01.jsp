...
<script type="text/javascript">
	...
	function getSkuInfData(){
		//mobileCommon.initBindArea("scanArea",["LOCAKY","DESC01"]);
	...
	function saveData(){
		if(gridList.validationCheck("gridList", "select")){
			...
			data.put("LOCATG",g_locatg);
			data.put("LOTA_STATUS","02");
