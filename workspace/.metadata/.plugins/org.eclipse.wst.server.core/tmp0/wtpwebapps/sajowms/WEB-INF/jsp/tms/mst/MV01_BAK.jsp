							...
							<div class="table type2">
								<div class="tableBody">
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												<td GH="100 STD_ROWNUM" GCol="rownum">1</td> 
												<td GH="100 STD_ROWNUM" GCol="input,VHCTYP,SHCMCDV" validate="required" ></td>												
												<td GH="100 STD_ROWNUM" GCol="text,VHCSTX" validate="required" >차량유형명</td>
												<td GH="100 STD_ROWNUM" GCol="input,VHCWHD" validate="required maxlength(10)" GF="N 10,3">폭(m)</td>
												<td GH="100 STD_ROWNUM" GCol="input,VHCHIG" validate="required maxlength(10)" GF="N 10,3">높이(m)</td>												    
									    		<td GH="100 STD_ROWNUM" GCol="input,VHCLNG" validate="required maxlength(10)" GF="N 10,3">길이(m)</td>          
												<td GH="100 STD_ROWNUM" GCol="input,RESUNT2" validate="required maxlength(10)" GF="N 10,3" >제한단위2(KG)</td>
												<td GH="100 STD_ROWNUM" GCol="text,RESUNT3" GF="N 10,3">제한단위3(M2)</td>
												<td GH="100 STD_ROWNUM" GCol="text,RESUNT4" GF="N 10,3">제한단위4(M3)</td>											
											</tr>									
										</tbody>
									</table>
								</div>
