...
// 		}
	...
	function comboEventDataBindeBefore(comboAtt,paramName){
		...
		if( comboAtt == "WmsInventory,RSNADJCOMBO" ){
									...
									<table>
										<tbody id="gridHeadList">
											<tr CGRow="true">
												...
												<td GH="100 STD_ADJDAT"    GCol="text,DOCDAT"  GF="D"></td>
									...
									<table>
										<tbody id="gridItemList">
											<tr CGRow="true">
												...
												<td GH="100 STD_PRCQTY"    GCol="text,SJ03PRCQTY"  GF="N"></td>
												<td GH="100 STD_UOMKEY"    GCol="text,PRCUOM"></td>
												<td GH="100 STD_TOTALQ"    GCol="text,SJ03QTADJU"  GF="N"></td>
