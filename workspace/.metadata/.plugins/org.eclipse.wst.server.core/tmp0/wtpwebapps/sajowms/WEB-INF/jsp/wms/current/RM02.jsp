...
<style type="text/css">
	...
	.colInfo ul li{padding: 9px 0 0 40px;}
</style>
...
<script type="text/javascript">
	...
	function comboEventDataBindeBefore(comboAtt,paramName){
		...
		if( comboAtt == "WmsCommon,ROLCTWAREKY" ){
			...
			if( name == "ASKL01" || id == "ASKL01" ){
				param.put("CODE","ASKL01");
			}
	...
	function print(){
		...
		var json = netUtil.sendData({
			url : "/wms/admin/json/printRM02.data",
			param : param
		});
		
		if ( json && json.data ){
				var url = "<%=systype%>" + "/rm02_list.ezg";
...
<div class="contentHeader">
	<div class="util">
		...
		<button CB="Pinrt PRINT BTN_CIRSKU"></button>
	</div>
</div>
								...
								<table class="table type1">
									...
									<tbody>
										<tr>
											...
											<td>
												<input type="text" name="LM.ZONEKY" UIInput="SR,SHZONMA" UIFormat="U"/>
											</td>
										</tr>
										<tr>
											<th CL="STD_ASKL01">대분류</th>
											<td>
												<select id="ASKL01" name="SM.ASKL01" Combo="Common,COMCOMBO" comboType="MS" UISave="false" ComboCodeView=false style="width:160px"></select>
											</td>
											<th CL="STD_SKWT01">최종출하일</th>
											<td>
												<input type="text" name="SW.SKWT01" UIInput="R" UIFormat="C" />
											</td>
										</tr>
									</tbody>
								</table>
				...
				<div class="tabs">
					...
					<div id="tabs1-1"> 
						<div class="section type1">
							<div class="colInfo">
								<ul>
									<li>*저회전상품 : 센터 보유 재고 중 30일 이상 무판매 상품</li>
								</ul>
							</div>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="220 STD_DESC01"   GCol="text,DESC01"></td>
												<td GH="80 STD_QTSIWH"   GCol="text,QTSIWH" GF="N"></td>
												<td GH="80 STD_DAYDIF"   GCol="text,DAYDIF" GF="N"></td>
												<td GH="90 STD_SKWT01"   GCol="text,SKWT01" GF="D"></td>
												...
												<td GH="140 STD_PTNRNM"   GCol="text,PRNRNM"></td>
											</tr>
										</tbody>
									</table>
								</div>
