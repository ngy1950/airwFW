									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 고객연락처(주문자)"    GCol="text,OTELN1"></td>
												<td GH="100 고객명(수취인)"    GCol="text,CRYPTO_SUSRNM"></td>
												<td GH="100 (신주소)우편번호(수취인)"    GCol="text,SNPOST"></td>
												<td GH="100 (신주소)상세 주소(수취인)"    GCol="text,SNADR1"></td>
												<td GH="100 (구주소)우편번호(수취인)"    GCol="text,SOPOST"></td>
												<td GH="100 (구주소)상세 주소(수취인)"    GCol="text,SOADR1"></td>
												<td GH="100 (구주소)상세 주소2(수취인)"    GCol="text,SOADR2"></td>
												<td GH="100 고객연락처(수취인)"    GCol="text,STELN1"></td>
												...
												<td GH="100 수거불필요"    GCol="text,NOTRCV"></td>
												<td GH="100 대체여부"    GCol="text,REPMAK"></td>
												<td GH="100 생성일시"    GCol="text,FST_REG_DTTM"></td>
												<td GH="100 생성자ID"    GCol="text,FST_REG_USER_ID" GF="T"></td>
												...
												<td GH="100 EAI전송일시"    GCol="text,EAI_TRNS_DTTM" GF="D"></td>
