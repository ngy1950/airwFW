									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 배송차수"           GCol="text,SHPDGR"></td>
												<td GH="100 수불코드"           GCol="text,LOTA01"></td>
												<td GH="100 출하유형"           GCol="text,SHPMTY"></td>
												<td GH="100 예약시작시간"        GCol="text,RVSTIM"></td>
												<td GH="100 예약종료시간"        GCol="text,RVETIM"></td>
												<td GH="100 예약마감시간"        GCol="text,RVLTIM"></td>
												<td GH="100 주문마감건수"        GCol="text,ENDCNT" GF="N"></td>
												...
												<td GH="100 EAI입력ID"         GCol="text,EAI_INPUT_ID"></td>
												<td GH="100 EAI입력일시"        GCol="text,EAI_INPUT_DTTM"></td>
												<td GH="100 EAI전송상태코드"     GCol="text,EAI_PROC_CD"></td>
