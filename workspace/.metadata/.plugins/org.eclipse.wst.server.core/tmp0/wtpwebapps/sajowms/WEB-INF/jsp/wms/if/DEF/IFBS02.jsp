								...
								<table class="table type1">
									...
									<tbody>
										...
										<tr>
											<th CL="STD_SNDKEY"></th>
											<td>
												<input type="test" name="SNDKEY" UIInput="SR"/>
											</td>
											<th CL="STD_SKUKEY"></th>
											<td>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 재고수량(정상)"  GCol="text,USEQ00"></td>
												<td GH="100 재고수량(임박)"  GCol="text,USEQ10"></td>
												<td GH="100 송신시스템"      GCol="text,SYSCOD"></td>
