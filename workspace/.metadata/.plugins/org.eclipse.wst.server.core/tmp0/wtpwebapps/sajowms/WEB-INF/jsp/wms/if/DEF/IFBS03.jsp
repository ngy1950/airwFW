									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="130 상품번호"    GCol="text,SKUKEY"></td>
												<td GH="230 상품명"    GCol="text,DESC01"></td>
												<td GH="100 주문수량"    GCol="text,ORDQTY" GF="N"></td>
												<td GH="100 결품수량"    GCol="text,QTSHPC" GF="N"></td>
												<td GH="170 생성일자"    GCol="text,FST_REG_DTTM" ></td>
												...
												<td GH="170 EAI전송일시"    GCol="text,EAI_TRNS_DTTM" ></td>
											</tr>
										</tbody>
									</table>
								</div>
