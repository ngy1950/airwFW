								...
								<table class="table type1">
									...
									<tbody>
										<tr>
											...
											<th CL="STD_SEBWARE"></th>
											<td>
												<input type="test" name="PTNRKY" UIInput="SR"/>
											</td>
										</tr>
										<tr>
											<th CL="STD_SEBWANM"></th>
											<td>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 수불센터코드"    GCol="text,PTNRKY"></td>
												<td GH="100 사업부구분"     GCol="text,PTNRTY"></td>
												<td GH="100 수불센터명"     GCol="text,NAME01"></td>
												...
												<td GH="100 센터장명"      GCol="text,MNGUSR"></td>
												<td GH="100 전화번호"      GCol="text,TELN01" validate="tel"></td>
												<td GH="100 팩스번호"      GCol="text,FAXTL1" validate="tel"></td>
												<td GH="100 업태명"       GCol="text,PTNG01"></td>
												<td GH="100 업종명"       GCol="text,PTNG02"></td>
												<td GH="100 WMS사용여부"  GCol="text,WMSUSE"></td>
												<td GH="100 사용여부"      GCol="text,USEMAK"></td>
												<td GH="100 상태적용일자"   GCol="text,APPDAT" GF="D"></td>
												<td GH="100 상태구분코드"   GCol="text,APPCOD"></td>
