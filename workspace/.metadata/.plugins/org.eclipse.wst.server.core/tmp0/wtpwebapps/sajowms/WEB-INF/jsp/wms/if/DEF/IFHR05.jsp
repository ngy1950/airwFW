									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 공휴일"           GCol="text,HOLDAT" GF="D"></td>
												<td GH="100 휴무내역"          GCol="text,HOLTXT"></td>
												<td GH="100 상태코드(C/U/D)"   GCol="text,HOLSTS"></td>
												...
												<td GH="100 EAI처리일련번호"   GCol="text,EAI_PROC_SEQNO"></td>
