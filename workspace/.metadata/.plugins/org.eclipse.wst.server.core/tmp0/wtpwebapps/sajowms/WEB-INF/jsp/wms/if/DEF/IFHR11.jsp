								...
								<table class="table type1">
									...
									<tbody>
										<tr>
											...
											<th CL="STD_ORGNCD"></th>
											<td>
												<input type="text" name="ORGNCD" UIInput="SR" />
											</td>
										</tr>
										<tr>
											<th CL="STD_USERNO"></th>
											<td>
												<input type="text" name="USERID" UIInput="SR" />
											</td>
											<th CL="STD_NAME01"></th>
											<td>
												<input type="text" name="NMLAST" UIInput="SR" />
											</td>
										</tr>
									</tbody>
								</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 사번"       GCol="text,USERID"></td>
												<td GH="100 이름"       GCol="text,NMLAST"></td>
												<td GH="100 전화번호"    GCol="text,TELN01"></td>
												<td GH="100 휴대폰번호"   GCol="text,TELN02"></td>
												<td GH="100 메일주소"    GCol="text,EMAIL1"></td>
												<td GH="100 부서코드"    GCol="text,ORGNCD"></td>
												<td GH="100 부서명"      GCol="text,ORGNNM"></td>
												<td GH="100 직무코드"    GCol="text,JOBDCD"></td>
												<td GH="100 직무명"      GCol="text,JOBDNM"></td>
												<td GH="100 상태코드"     GCol="text,USEMAK"></td>
