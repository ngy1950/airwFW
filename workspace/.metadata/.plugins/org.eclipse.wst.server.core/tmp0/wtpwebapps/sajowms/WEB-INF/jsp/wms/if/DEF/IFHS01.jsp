									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 입고순번"       GCol="text,SEBELP"></td>
												<td GH="100 상품코드"       GCol="text,SKUKEY"></td>
												<td GH="100 상품그룹"       GCol="text,SKUGRP"></td>
												<td GH="100 구분코드"       GCol="text,BTNTYP"></td>
												...
												<td GH="100 매입일시"       GCol="text,BUYDTTM"></td>
												<td GH="100 취소여부"       GCol="text,CNCLYN"></td>
												<td GH="100 프로세스구분"    GCol="text,PRCTYP"></td>
												<td GH="100 센터검수자ID"    GCol="text,WH_CHKQTYPSN_ID"></td>
												<td GH="100 센터검수자명"    GCol="text,WH_CHKQTYPSN_NM"></td>
