								...
								<table class="table type1">
									...
									<tbody>
										...
										<tr>
											<th CL="STD_SADJKY"></th>
											<td>
												<input type="test" name="A.SADJKY" UIInput="SR"/>
											</td>
											<th CL="STD_SKUKEY"></th>
											<td>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 재고조정키"     GCol="text,SADJKY"></td>
												<td GH="100 수불센터코드"    GCol="text,LOTA01"></td>
												<td GH="100 일련번호"       GCol="text,ATTL08"></td>
												<td GH="100 상품코드 "       GCol="text,SKUKEY"></td>
												<td GH="100 상품그룹"       GCol="text,SKUGRP"></td>
												<td GH="100 반품단위"       GCol="text,DUOMKY"></td>
												<td GH="100 반품수량"       GCol="text,RTNQTY" GF="N"></td>
												<td GH="100 반품구분"       GCol="text,ADJUTY"></td>
												<td GH="100 협력사코드 "     GCol="text,PTNRKY"></td>
												<td GH="100 반품일자 "       GCol="text,DOCDAT" GF="D"></td>
												<td GH="100 프로세스구분"    GCol="text,PRCTYP"></td>
												<td GH="100 반품사유 "       GCol="text,RSNADJ"></td>
												...
												<td GH="100 실처리키"       GCol="text,SNDKEY"></td>
											</tr>
										</tbody>
									</table>
								</div>
