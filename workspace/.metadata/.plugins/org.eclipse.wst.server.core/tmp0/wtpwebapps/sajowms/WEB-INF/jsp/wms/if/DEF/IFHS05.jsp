								...
								<table class="table type1">
									...
									<tbody>
										...
										<tr>
											<th CL="STD_SNDKEY"></th>
											<td>
												<input type="test" name="A.SNDKEY" UIInput="SR"/>
											</td>
											<th CL="STD_SKUKEY"></th>
											<td>
							...
							<div class="table type2">
								<div class="tableBody">
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												<td GH="100 전송번호"       GCol="text,SNDKEY"></td>
												<td GH="100 물류센터"       GCol="text,WAREKY"></td>
												<td GH="100 마감일자"       GCol="text,CLSDAT" GF="D"></td>
												<td GH="100 수불센터코드"    GCol="text,LOTA01"></td>
												<td GH="100 상품코드"       GCol="text,SKUKEY"></td>
												<td GH="100 정상수량"       GCol="text,SQTY00" GF="N"></td>
												<td GH="100 임박수량"       GCol="text,SQTY10" GF="N"></td>
												<td GH="100 반품수량"       GCol="text,SQTY40" GF="N"></td>
												<td GH="100 폐기수량"       GCol="text,SQTY30" GF="N"></td>
												<td GH="100 보류수량"       GCol="text,SQTY20" GF="N"></td>
												<td GH="100 총재고수량"      GCol="text,TOTQTY" GF="N"></td>
