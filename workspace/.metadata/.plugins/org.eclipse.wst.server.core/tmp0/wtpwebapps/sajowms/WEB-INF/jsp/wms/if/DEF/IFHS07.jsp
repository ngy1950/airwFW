									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 재고작업순번"    GCol="text,SADJIT"></td>
												<td GH="100 수불센터코드"    GCol="text,LOTA01"></td>
												<td GH="100 상품코드"       GCol="text,SKUKEY"></td>
												<td GH="100 상품그룹"       GCol="text,SKUGRP"></td>
												<td GH="100 발생유형"       GCol="text,ADJTYP"></td>
												<td GH="100 사유코드"       GCol="text,RSNADJ"></td>
												<td GH="100 기본단위"       GCol="text,DUOMKY"></td>
												<td GH="100 조정수량"       GCol="text,QTADJU" GF="N"></td>
												<td GH="100 조정일자"       GCol="text,DOCDAT" GF="D"></td>
												<td GH="100 프로세스구분"    GCol="text,PROCCD"></td>
