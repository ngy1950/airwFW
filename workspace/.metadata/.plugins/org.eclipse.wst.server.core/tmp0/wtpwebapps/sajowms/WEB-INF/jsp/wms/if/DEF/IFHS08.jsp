							...
							<div class="table type2">
								<div class="tableBody">
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												<td GH="100 전송번호"       GCol="text,SNDCOD"></td>
												<td GH="100 물류센터"       GCol="text,WAREKY"></td>
												<td GH="100 수불센터코드"    GCol="text,LOTA01"></td>
												<td GH="100 조사유형"       GCol="text,SNDTYP"></td>
												<td GH="100 상품코드"       GCol="text,SKUKEY"></td>
												<td GH="100 조사일자"       GCol="text,DOCDAT" GF="D"></td>
												<td GH="100 기본단위"       GCol="text,DUOMKY"></td>
												<td GH="100 재고수량"       GCol="text,QTSIWH" GF="N"></td>
