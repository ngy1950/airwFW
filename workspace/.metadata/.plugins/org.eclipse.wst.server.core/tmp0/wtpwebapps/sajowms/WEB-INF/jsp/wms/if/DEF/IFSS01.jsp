								...
								<table class="table type1">
									...
									<tbody>
										...
										<tr>
											...
											<th CL="STD_LOCAKY"></th>
											<td>
												<input type="text" name="LOCAKY" UIInput="SR" />
											</td>
										</tr>
									</tbody>
								</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 피킹 로케이션(정상)"     GCol="text,LOCAKY"></td>
												...
												<td GH="130 EAI작업구분(I/U/D)"   GCol="text,EAI_JOB_SP"></td>
												<td GH="130 EAI처리일련번호"       GCol="text,EAI_PROC_SEQNO"></td>
