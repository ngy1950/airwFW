...
//주문배차
	$(document).ready(function(){
		...
		searchShpdgr(val);
		$("#searchArea [name=IFDATE]").on("change",function(){
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 배송/회수유형"    GCol="text,TRANTP"></td>
												<td GH="100 수불센터코드"     GCol="text,LOTA01"></td>
												<td GH="100 배송일자"        GCol="text,RQSHPD"></td>
												<td GH="100 차수"           GCol="text,SHPDGR"></td>
												<td GH="100 차량번호"        GCol="text,VEHINO"></td>
												<td GH="100 차주명"          GCol="text,VEHINM"></td>
												<td GH="100 차량약어"        GCol="text,CARNUM"></td>
												<td GH="100 회전"           GCol="text,CARCNT"></td>
												<td GH="100 루트"            GCol="text,ROOTID"></td>
												<td GH="100 배송기사명"        GCol="text,DRIVER"></td>
												<td GH="100 배송기사 전화번호"   GCol="text,DRITEL"></td>
												<td GH="100 도크"            GCol="text,DOCKNO"></td>
												<td GH="100 배송순번"         GCol="text,SHPDSQ"></td>
												<td GH="100 권역코드"         GCol="text,REGION"></td>
												<td GH="100 권역명"           GCol="text,REGINM"></td>
												<td GH="100 EAI작업구분"      GCol="text,EAI_JOB_SP"></td>
												<td GH="100 생성일시"          GCol="text,EAI_INPUT_DTTM"></td>
												<td GH="100 생성자ID"         GCol="text,EAI_INPUT_ID"></td>
												<td GH="100 EAI전송ID"       GCol="text,EAI_TRNS_ID"></td>
												<td GH="100 EAI전송일시"       GCol="text,EAI_TRNS_DTTM"></td>
												<td GH="100 처리상태"          GCol="text,EAI_TRNS_STAT_CD"></td>
												<td GH="100 EAI전송일련번호"    GCol="text,EAI_TRNS_SEQNO"></td>
												<td GH="100 최종수정자ID"       GCol="text,LAST_MOD_USER_ID"></td>
												<td GH="100 최종수정일시"       GCol="text,LAST_MOD_DTTM"></td>
