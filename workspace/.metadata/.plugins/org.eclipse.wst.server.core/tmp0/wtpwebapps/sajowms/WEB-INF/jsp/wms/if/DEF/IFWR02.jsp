									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 박스ID"    GCol="text,SBOXID"></td>
												<td GH="100 상품코드"    GCol="text,SKUKEY"></td>
												<td GH="100 로케이션"    GCol="text,LOCAKY"></td>
												<td GH="100 피킹수량"    GCol="text,QTJCMP" GF="N"></td>
												<td GH="100 결품수량"    GCol="text,QTAPPO" GF="N"></td>
												<td GH="100 피킹일자"    GCol="text,PKCDAT" GF="D"></td>
												<td GH="100 피킹시간"    GCol="text,PKCTIM" GF="T"></td>
