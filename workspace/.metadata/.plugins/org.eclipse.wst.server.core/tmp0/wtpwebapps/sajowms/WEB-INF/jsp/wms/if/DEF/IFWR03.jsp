									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 박스작업ID(신규)"    GCol="text,SBOXSQ"></td>
												<td GH="100 박스작업일련번호"    GCol="text,WCSJNO"></td>
												<td GH="100 박스작업ID(원박스)"    GCol="text,OBOXSQ"></td>
												<td GH="100 상품코드"    GCol="text,SKUKEY"></td>
												<td GH="100 상품명"    GCol="text,DESC01"></td>
												<td GH="100 분할수량"    GCol="text,QTYDIV" GF="N"></td>
												<td GH="100 분할일자"    GCol="text,DIVDAT" GF="D"></td>
												<td GH="100 분할시간"    GCol="text,DIVTIM" GF="T"></td>
