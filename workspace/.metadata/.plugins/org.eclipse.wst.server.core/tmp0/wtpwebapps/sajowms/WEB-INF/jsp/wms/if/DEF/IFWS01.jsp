									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 박스작업일련번호"    GCol="text,WCSJNO"></td>
												...
												<td GH="100 차량명"    GCol="text,VEHINM"></td>
												<td GH="100 도크번호"    GCol="text,DOCKNO"></td>
												<td GH="100 회전수"    GCol="text,CARCNT"></td>
												<td GH="100 수취인"    GCol="text,SUSRNM"></td>
												<td GH="100 상품코드"    GCol="text,SKUKEY"></td>
												<td GH="100 상품명"    GCol="text,DESC01"></td>
												<td GH="100 상품바코드"    GCol="text,EANCOD"></td>
												<td GH="100 로케이션"    GCol="text,LOCAKY"></td>
												<td GH="100 상품상태"    GCol="text,LOTA06"></td>
												<td GH="100 오더수량"    GCol="text,QTYORG" GF="N"></td>
												<td GH="100 작업순서"    GCol="text,SHPSEQ"></td>
