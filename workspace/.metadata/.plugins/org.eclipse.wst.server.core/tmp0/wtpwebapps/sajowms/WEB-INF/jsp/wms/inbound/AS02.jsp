		...
		if( chkHeadLen == 0 ){
			...
			if(!commonUtil.msgConfirm(configData.MSG_MASTER_DELETE_CONFIRM)){
				...
				var json = netUtil.sendData({
					url : "/wms/inbound/json/AS02Delete.data",
					param : param
				});
				
				if(json && json.data){
					searchList();
					commonUtil.msgBox("삭제되었습니다.")
				}
			}
		}
		gridList.resetGrid("gridListSub");
			...
			<table class="table type1">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" name="AH.STATDO" value="NEW" readonly="readonly"/>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						...
						<td >
							<input type="text" name="AI.SEBELN" UIInput="R" />
						</td>
					</tr>
					<tr>
						<th CL="STD_LIFNR">업체코드</th>
						<td>
...
<!-- 												<th Cl='STD_LOTA02'></th>   재고유형 -->
												...
												<th Cl='STD_SZMBLNO'>B/L NO</th>
												   
												<th Cl='STD_SZMIPNO'>B/L Item NO</th>
												<th Cl='STD_STRAID'></th>
												<th Cl='STD_SVBELN'></th>
												<th Cl='STD_SPOSNR'></th>
												<th Cl='STD_STKNUM'></th>
