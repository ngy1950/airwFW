...
<script type="text/javascript">
	...
	function saveData(){
		...
		if(gridList.validationCheck("gridListSub", "modify")){
			...
			var itemModCnt = gridList.getSelectRowNumList("gridListSub").length;
...
<!-- 					</tr> -->
<!-- 					<tr> -->
<!-- 						<th CL="STD_EBELN">Shipment order no.</th> -->
<!-- 						<td> -->
...
<!-- 					</tr> -->
					<tr>
						...
						<td>
							<input type="text" name="EINDT" UIInput="R" />
						</td>
					</tr>
					<tr>
...
<!-- 						<td> -->
<!-- 							<input type="text" name="PO.VGBEL" UIInput="R,SHBZPTN2" /> -->
<!-- 						</td> -->
<!-- 					</tr> -->
					<tr>
...
<!-- 												<td GCol="text,SALCOM"></td> -->
<!-- 												<td GCol="text,SALCOMNM"></td> -->
<!-- 												<td GCol="text,SALPLT"></td> -->
<!-- 												<td GCol="text,SALPLTNM"></td> -->
												<td GCol="text,DOCUTY"></td>
												<td GCol="text,DOCTNM"></td>
												<td GCol="text,STATDO"></td>
												<td GCol="text,STATDONM"></td>
												<td GCol="input,DOCTXT"></td>
												<td GCol="text,BOX_CNT" GF="N"></td>
											</tr>							
										</tbody>
									</table>
								</div>
...
<!-- 												<th CL='STD_DESC02'></th> -->
												...
												<th CL='STD_QTYORD'></th>
												<th CL='STD_UOMKEY'></th>
												<th CL='STD_MENGE_B'></th>
												<th CL='STD_QTSTOK1'></th>
												<th CL='STD_QTYRCV'></th>
<!-- 												<th CL='STD_LOTA01'></th> -->
...
<!-- 												<td GCol="text,DESC02"></td> -->
												...
												<td GCol="text,MENGER" GF="N"></td>
												<td GCol="text,QTYRCV1" GF="N"></td>
