...
<script type="text/javascript">
	...
	function searchList(){
		if(validate.check("searchArea")){
			...
			gridList.gridList({
		    	id : "gridList",
		    	param : param,
		    	url : "/wms/inbound/json/ebelnGR02.data"
		    });
		}
	}
	...
	function saveData(){
		...
		if(mCount > 0 && gridList.validationCheck("gridListSub", "modify") && gridList.validationCheck("gridList", "modify")){
	...
	function gridListEventColValueChange(gridId, rowNum, colName, colValue){
		if (gridId == "gridList") {
			if (colName == "DOCDAT") {
				...
				var asndat = rowData.get("ASNDAT");
				var docdat = rowData.get("DOCDAT");
				var asndate = asndat-1;
				var now = new Date();
				now.setDate(now.getDate());
				var tmpValue = uiList.dateFormat(now, site.COMMON_DATE_TYPE);
				
				if(docdat < asndate){
					//alert("과거일자로 입고하실 수 없습니다.");
					commonUtil.msgBox("IN_M0131")
					gridList.setColValue(gridId, rowNum, "DOCDAT", tmpValue);
				}
			}
		}
	}
	...
	function reportPrint(){
		...
		var where =   "AND EBELN IN (" ;
		for(var i=0 ; i<listcnt ; i++){
			ebeln = gridList.getColData("gridList", i, "EBELN");		
			if(i>0){
				where += ", "
			}
			where += "'" + ebeln +"'";
...
<div class="contentHeader">
	<div class="util">
		...
		<button CB="Print PRINT BTN_SHNBPRINT">
		</button>
	</div>
	<div class="util2">
			...
			<table class="table type1">
				...
				<tbody>
					...
					<!-- <tr>
						<th CL="STD_LOTA07"></th>
						<td>
							<input type="text" name="PO.USRID3" UIInput="R"/>
						</td>
					</tr> -->
					<tr>
									...
									<table>
										...
										<thead>
											<tr>
												...
												<th CL='STD_AREAKY'></th>
												<th CL='STD_AREANM'></th>
												<th CL='STD_DPTNKY1,2'></th>
												<th CL='STD_DPTNNM1,2'></th>
									...
									<table>
										...
										<tbody id='gridListSub'>
											<tr CGRow="true">
												...
												<td GCol="input,LOCAKY,SHLOCMA" validate="required"></td>
