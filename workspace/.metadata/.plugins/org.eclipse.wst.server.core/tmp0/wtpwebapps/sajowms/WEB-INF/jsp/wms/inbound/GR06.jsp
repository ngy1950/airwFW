...
// HEAD 체크시, ITEM 전체체크, ITEM 체크시, HEAD 체크
...
<body>
	...
	<div class="searchPop" id="searchArea">
		...
		<div class="searchInnerContainer">
     	...
     	<div class="searchInnerContainer">
			<div class="searchInBox">
				<h2 class="tit" value="ERP검색조건">ERP검색조건</h2>
				<table class="table type1">
					<colgroup>
						<col width="100" />
						<col />
					...
					<tbody>
						...
						<tr>
						<th CL="STD_DPTNKY">임가공업체코드 </th>
						<td>
							<input type="text" name="AH.DPTNKY" UIInput="R" />
						</td>
					</tr>
					<tr>
						<th CL="STD_BDPTNKYNM">임가공업체명 </th>
						<td>
											...
											<tbody id='gridListSub'>
												<tr CGRow="true">
													...
													<td GCol="select,LOTA02"><select
														Combo="WmsInbound,LOTA02COMBO"></select> <!-- 재고유형 --></td>
													<td GCol="text,LOTA03"></td>
													<td GCol="text,LOTA04"></td>
													<td GCol="select,LOTA05"><select
														Combo="WmsInbound,LOTA05COMBO"></select> <!-- 재고분류 --></td>
