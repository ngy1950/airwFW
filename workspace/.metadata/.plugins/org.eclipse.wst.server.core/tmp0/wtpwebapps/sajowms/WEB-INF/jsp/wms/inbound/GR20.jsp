	...
	function saveData(){
		if(gridList.validationCheck("gridListSub", "modify")) {
			...
			var json = netUtil.sendData({
				url : "/wms/inbound/json/saveGr20.data",
				param : param
			});
			...
			if (colName == "INPUTSKU") {
				if(colValue != ""){
					...
					if(json.data["CNT"] >= 1) {
						...
						if(json && json.data){
							gridList.setColValue("gridListSub", rowNum, "SKUKEY", json.data["SKUKEY"]);
							gridList.setColValue("gridListSub", rowNum, "MATNR", json.data["MATNR"]);
						...
						gridList.setColValue("gridListSub", rowNum, "INPUTSKU", "");
			...
			<table class="table type1">
				...
				<tbody>
					...
					<tr>
						<th CL="STD_DOCUTY"></th>
						<td>
							<select Combo="WmsInbound,DOCUTYETCCOMBO" validate="required" name="DOCUTY">
							</select>
						</td>
					</tr>
				</tbody>
							...
							<div class="table type2">
								...
								<div class="tableBody">
									<table>
										...
										<tr CGRow="true">
												<td GCol="rownum"></td>
												<td GCol="input,INPUTSKU,SHSKUMA" validate="required" GF="S 20"></td>
