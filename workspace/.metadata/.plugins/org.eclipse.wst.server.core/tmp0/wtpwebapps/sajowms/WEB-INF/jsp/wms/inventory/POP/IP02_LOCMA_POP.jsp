...
<script type="text/javascript">
	...
	function comboEventDataBindeBefore(comboAtt,paramName){
		var wareky = "<%=wareky%>";
		var param = new DataMap();
		if(comboAtt == "WmsTask,MV01_AREACOMBO"){
							...
							<table class="table type1">
								...
								<tbody>
									<tr>
										...
										<th CL="STD_AREAKY"></th>
										<td>
											<select id="AREAKY" name="A.AREAKY" Combo="WmsTask,MV01_AREACOMBO" comboType="MS" UISave="false" ComboCodeView=false style="width:160px"></select>
										</td>
									</tr>
									<tr>
										<th CL="STD_ZONEKY"></th>
