...
<script type="text/javascript">
	...
	function searchHelpEventOpenBefore(searchCode, gridType){
		...
		if(searchCode == "SHCOSTCT"){
			param.put("CMCDKY", "COSTCT");
			return param;
		}
	}
		...
		<div class="searchInBox" id="searchArea">
			...
			<table class="table type1">
				...
				<tbody>
					...
					<th CL="STD_LOTA02"></th>
						<td>
							<input type="text" name="SI.LOTA02" UIInput="R,SHCOSTCT"/>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<div class="bottomSect type1">
				<div class="tabs">
					<ul class="tab type2">
						...
						<li><a href="#tabs1-4" id="tab04" onclick="tabChg(4);"><span CL='STD_BYLOTA02'></span></a></li>
						<li><a href="#tabs1-5" id="tab05" onclick="tabChg(5);"><span CL='STD_BYCREUSR'></span></a></li>
					</ul>
					<div id="tabs1-1">
