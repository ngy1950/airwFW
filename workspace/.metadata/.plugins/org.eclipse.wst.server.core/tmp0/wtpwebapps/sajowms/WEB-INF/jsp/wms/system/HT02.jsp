							...
							<table class="table type1">
								...
								<tbody>
									<tr>
										<th CL="STD_CREDAT"></th>
										<td>
											<input type="text" name="PRH.CREDAT" UIInput="B"  UIFormat="C N" validate="required" MaxDiff="M1" />
										</td>
										<th CL="STD_PROGID"></th>
										<td>
											<input type="text" name="PRH.PROGID" UIInput="SR,SHPROGD" />
										</td>
									</tr>
									<tr>
										<th CL="STD_USERID"></th>
										<td>
											<input type="text" name="PRH.USERID" UIInput="SR,SHUSRMA" />
										</td>
										<th CL="STD_NMLAST"></th>
										<td>
											<input type="text" name="PRH.NMLAST" UIInput="SR" />
										</td>
									</tr>
								</tbody>
							</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="100 STD_PROGID"     GCol="text,PROGID,center"></td>
												<td GH="100 STD_PROGRAMS,3" GCol="text,PROGNM"></td>
