...
<script type="text/javascript">
	$(document).ready(function(){
		...
		mangeMap = new DataMap();
		mangeMap.put("OPER", "E");
		mangeMap.put("DATA", "360");		
		rangeList.push(mangeMap);
		
		mangeMap = new DataMap();
		mangeMap.put("OPER", "E");
		mangeMap.put("DATA", "361");		
		rangeList.push(mangeMap);
...
// 		inputList.setRangeData("TASDI.LOTA02", configData.INPUT_RANGE_TYPE_SINGLE, [rdata]);
		...
		gridList.setReadOnly("gridList_Item", true, ['LOTA06']);
	});
			...
			<table class="table type1">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" name="TASDI.LOCASR" UIInput="R,SHLOCMA"/>
						</td>
					</tr>
					<tr>
