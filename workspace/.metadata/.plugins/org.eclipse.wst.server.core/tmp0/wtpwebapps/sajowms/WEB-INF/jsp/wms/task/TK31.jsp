...
<script type="text/javascript">
	...
	function searchList(){
		if(validate.check("searchArea")){
			...
			var areatg = param.get("AREATG");
			
			if(areatg == areaky && searchFlg == 0){
				//alert("From 창고/To 창고가 동일합니다.");
				commonUtil.msgBox("TASK_M0336",areaky+" / "+areatg);
				return;
			}
		...
		<div class="searchInBox" id="searchArea">
			...
			<table class="table type1">
				...
				<tbody>
					...
					<tr>
						<th CL="STD_AREASR">From 창고</th>
						<td><select Combo="WmsAdmin,AREACOMBO" name="AREAKY" id="USERAREA" validate="required"></select>
						</td>
					</tr>
					<tr>
						<th CL="STD_AREATG">To 창고</th>
						<td><select Combo="WmsAdmin,AREACOMBO" name="AREATG" validate="required"></select>
						</td>
					</tr>
					<tr>
						<th CL="STD_TASOTY">작업타입</th>
						<td GCol="select,TASOTY">
							<select Combo="WmsTask,TK31DOCUTYCOMBO" name="TASOTY">
							</select>
						</td>
					</tr>
					<tr>
						...
						<div class="section type1">
							<table class="util">
								<tr>
									<th CL="STD_RSNCOD"></th>
									<td>
										<select ReasonCombo="311" id="rsncodCombo" validate="required,INV_M0054">
										</select>
									</td>
									<td>
