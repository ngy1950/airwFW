...
<script type="text/javascript">
	...
	function setTasrsn(){
		...
		if(tasrsn){
			for(var i=0;i<selectNumList.length;i++){
				var rowNum = selectNumList[i];
				gridList.setColValue("gridItemList", rowNum, "TASRSN", tasrsn);
			}
			gridList.setColFocus("gridItemList", rowNum, "TASRSN");
		}
	}
				...
				<tbody>
					...
					<tr>
						...
						<td GCol="select,TASOTY">
							<select Combo="WmsTask,TK32DOCUTYCOMBO" name="TASOTY">
							</select>
						</td>
					</tr>
					<tr>
						...
						<div class="section type1">
							<table class="util">
								<tr>
									<th CL="STD_RSNCOD"></th>
									<td>
										<select ReasonCombo="380" id="rsncodCombo" validate="required,INV_M0054">
										</select>
									</td>
									<td>
									...
									<th CL="STD_TASRSN"></th>
									<td>
										<input type="text" name="tasrsn" id="tasrsn">
									</td>
									<td>
										<button CB="Reflect1 REFLECT BTN_REFLECT">
										</button>
									</td>
								</tr>
							</table>
										...
										<tbody id="gridItemList">
											<tr CGRow="true">
												...
												<td GCol="select,RSNCOD" validate="required,VALID_M0413">
													<select ReasonCombo="380">
														<option value=""> </option>
													</select>
												</td>
												<td GCol="input,TASRSN" GF="S 255"></td>
												<td GCol="select,COSTCT">
													<select Combo="WmsOrder,COSTCTCOMBO">
														<option value=""> </option>
													</select>
												</td>
											</tr>
