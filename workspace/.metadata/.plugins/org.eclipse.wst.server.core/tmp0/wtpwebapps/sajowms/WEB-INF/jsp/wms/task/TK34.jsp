...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		mangeMap.put("OPER", "E");
		mangeMap.put("DATA", "RTNLOC");		
		rangeList.push(mangeMap);
		
		inputList.setRangeData("ST.LOCAKY", configData.INPUT_RANGE_TYPE_SINGLE,  rangeList);
	});
	...
	function saveData(){
		if(gridList.validationCheck("gridItemList", "select") && gridList.validationCheck("gridHeadList", "modify")){
	...
	function gridListEventColValueChange(gridId, rowNum, colName, colValue){
		if(gridId=="gridHeadList" && colName=="PTNRKY"){
			if(colValue != ""){
				var param = new DataMap();
				...
				if(json && json.data){
					gridList.setColValue("gridHeadList", rowNum, "DPTNNM", json.data["NAME01"]); 
				}else{
					commonUtil.msgBox("VALID_M1233");  //공급사를 확인해주세요.
					gridList.setColFocus(gridId, rowNum, "DPTNNM");
				...
				<tbody>
					...
					<tr>
						...
						<td GCol="select,TASOTY">
							<select Combo="WmsTask,TK34DOCUTYCOMBO" name="TASOTY">
							</select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="text" name="ST.LOCAKY" UIInput="R,SHLOCMA" readonly="readonly"/>
						</td>
					</tr>
					<tr>
...
<!-- 												<th CL='STD_AREANM'></th> -->
												...
												<th CL='STD_DOCTXT'></th>
												<th CL='STD_PTNRKY0'></th>
												<th CL='STD_PTNRKY0NM'></th>
											</tr>
										</thead>
									</table>
								</div>
...
<!-- 												<td GCol="text,AREANM"></td> -->
												...
												<td GCol="input,PTNRKY,SHBZPTN" validate="required,VALID_M1234"></td>
						...
						<div class="section type1">
							<table class="util">
								<tr>
									<th CL="STD_RSNCOD"></th>
									<td>
										<select ReasonCombo="360" id="rsncodCombo" validate="required,INV_M0054">
										</select>
									</td>
									<td>
