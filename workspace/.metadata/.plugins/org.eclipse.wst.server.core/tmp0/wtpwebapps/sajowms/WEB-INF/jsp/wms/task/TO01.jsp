...
<script type="text/javascript">
	...
	function createCombo(){
		...
		var comboDataMap = new DataMap();
		$comboList = jQuery("body").find("select["+configData.INPUT_TASOTY_COMBO+"]");
		for(var i=0;i<$comboList.length;i++){
			var tasotyCode = $comboList.eq(i).attr(configData.INPUT_TASOTY_COMBO);
			var optionHtml;
					
			var param = new DataMap();
			param.put("TASOTY", menuId);
			...
			optionHtml = inputList.selectHtml(json.data, true);
			comboMap.put(tasotyCode, optionHtml);
			comboDataMap.put(tasotyCode, json.data);
	...
	function comboEventDataBindeBefore(comboAtt){
		if(comboAtt == "WmsTask,TASOTYCD"){
			var param = new DataMap();
			param.put("TASOTY", configData.MENU_ID);
			return param;
		}
	}
				...
				<tbody>
					...
					<tr>
						...
						<td GCol="select,AREAKY" validate="required,INV_M0054">
							<select Combo="WmsTask,TASOTYCD" name="TASOTY">
							</select>
						</td>
					</tr>
				</tbody>
				...
				<tbody>
					<tr>
						...
						<td GCol="select,AREAKY">
							<select Combo="WmsTask,WHERCOMBO" name="AREAKY">
							</select>
						</td>
					</tr>
					<tr id="to02combo">
						<th CL="STD_WARETG">To 거점</th>
						<td GCol="select,AREAKY">
							<select Combo="WmsTask,WARETGCOMBO" name="WARETG">
							</select>
						</td>
					</tr>
					<tr>
