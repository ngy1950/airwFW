...
<%-- 		filename!="ico_lnb_closer"?self.find("img").attr("src","/common<%=theme%>/images/ico_lnb_closer.png"):self.find("img").attr("src","/common<%=theme%>/images/ico_lnb_closel.png"); --%>
	...
	*/
	...
	function checkTabListSize(){
		...
		//info.jsp, topS.jsp 자동조회 컨트롤
		parent.$mainFrame[0].contentWindow.roopChk(); //info.jsp
		parent.parent.parent.$headFrame[0].contentWindow.topRoopChk(); // topS.jsp
...
<%-- 			<span style="margin-right: 1px"></span><img src="/common<%=theme%>/images/btn_closeAll.png" alt="close"  onClick="closeAll()" /> --%>
<!-- 		</div> -->
<!-- 		<div class="tab_list" id="tabList"> -->
<%-- 			<span style="margin-right: 1px"></span><!-- img src="/common<%=theme%>/images/ico_btn5.png" alt="tab" style="width:20px;margin-bottom: 5px;margin-left: 3px;margin-right: 3px" onClick="tabList()" /--> --%>
