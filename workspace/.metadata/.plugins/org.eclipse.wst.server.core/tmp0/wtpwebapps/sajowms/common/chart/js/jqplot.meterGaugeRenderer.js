...
(function($) {
    ...
    $.jqplot.MeterGaugeRenderer.prototype.init = function(options) {
        ...
        this.ringColor = "#26323a";
        // needle color not implemented yet.
        this.needleColor = "#26323a";
        // prop: tickColor
        // color of the tick marks around the gauge.
        this.tickColor = "#26323a";
        // prop: ringWidth
...
//                    console.log(this.ringWidth);
//                    console.log(this.needleThickness );
...
//        console.log(r);    
        if (this.semiCircular) {
            ...
            // draw the outer ring.
            var grd = ctx.createLinearGradient(0, 70, r, 0);
            grd.addColorStop(0.0, "#e23131");
            grd.addColorStop(0.5, "#fbe500");
            grd.addColorStop(1.0, "#25cd6b");
            
            ctx.save();
            ctx.beginPath();  
            ctx.strokeStyle = grd;//this.ringColor;
            ...
            ctx.save();
            ctx.beginPath();  
            ctx.fillStyle = "#555969"//this.ringColor;
            //ctx.arc(0 ,0, this.hubRadius,hubsa, hubea, false);
            ctx.arc(0 ,0, this.hubRadius-3,0, Math.PI * 2, true);
            ctx.closePath();
            ctx.fill();
            ctx.restore();
            ...
            if (this.showTickLabels) {
                ...
                for (i=0; i<this.ticks.length; i++) {
                    elem = $('<div class="jqplot-meterGauge-tick" style="position:absolute;font-weight:bold;">'+this.ticks[i][1]+'</div>');
            ...
            ctx.beginPath();
            ctx.fillStyle = "#555969";//this.ringColor;
            ctx.strokeStyle = "#555969";//this.ringColor;
    ...
    $.jqplot.jqplotMasterGaugeGetRadius = function(){
