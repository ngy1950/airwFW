ConfigData = function() {
	...
	this.MENU_ID;
	this.IF_MAX_ROW_COUNT = 20000;//SK01,BZ01,MS01 조회수 제한
	this.IF_MAX_ROW_COUNT2 = 50000;//DL03,DL06,DL07,MV08,SD10 조회수 제한
	...
	this.GRID_COLOR_TEXT_BLACK_CLASS = "gridColorTextBlack";
	...
	this.MSG_MASTER_ROWEMPTY = "MASTER_M0014";
	this.MSG_MASTER_DELETE_CONFIRM = "MASTER_M0020";
	this.MSG_MASTER_ROW_SELECT = "MASTER_M0060";
	this.MSG_MASTER_SAVE_CONFIRM = "COMMON_M0100";  //저장하시겠습니까?
	...
	this.MSG_EXECUTE_APPLY = "EXECUTE_APPLY"; //실패하였습니다.
	
	this.MSG_MOUSEWHEEL_EVENT_STOP = "SYSTEM_MWHEELC"; //마우스 휠 클릭은 사용할 수 없습니다.
	this.MSG_SELECTDATA = "SYSTEM_SELECTDATA"; //선택하세요.
	
	this.MSG_MASTER_PICKDEL_CONFIRM = "TASK_M0038"; //피킹취소하시겠습니까?
	this.MSG_MASTER_DOCUDEL_CONFIRM = "TASK_M0040"; //문서취소하시겠습니까?
	
	this.MSG_SYSTEM_WAREKY_CHANGE = "SYSTEM_M0128"; //센터 변경시 저장하지 않은 데이터는 사라집니다. 계속 진행하시겠습니까?
	...
	*/
	...
	this.VALIDATION_DATE_MAX_DIFF = "MaxDiff";		//2020.10.14 khc : 일자 차이 설정
	this.VALIDATION_DATE_MAX_DIFF_M1  = "31";		//1달설정 : M1
	this.VALIDATION_DATE_MAX_DIFF_M2  = "60";		//2달설정 : M2
	this.VALIDATION_DATE_MAX_DIFF_M3  = "90";		//3달설정 : M3
	this.VALIDATION_DATE_MAX_DIFF_M4  = "120";		//3달설정 : M4
	this.VALIDATION_DATE_MAX_DIFF_M6  = "180";		//6달설정 : M6
	this.VALIDATION_DATE_MAX_DIFF_Y1 = "365";		//1년설정 : Y1
