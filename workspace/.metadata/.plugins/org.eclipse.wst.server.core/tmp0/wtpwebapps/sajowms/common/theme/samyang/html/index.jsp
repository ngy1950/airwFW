...
<title>WMS</title>
<link rel="stylesheet" href="/common/theme/samyang/css/red.css">
<link rel="stylesheet" href="/common/theme/samyang/css/samyang.css">
...
<body style="display:none">
	<div class="show">
		<h1>
			<img src="/common/theme/samyang/images/logo-2.png">		
		</h1>
		<div class="signin" id="searchArea">			    
		    <input type="text" id="USERID" name="USERID" validate="required" value="DEV" />
		    <input type="password" id="PASSWD" name="PASSWD" validate="required" value="1" onkeypress="commonUtil.enterKeyCheck(event, 'login()')"/>
