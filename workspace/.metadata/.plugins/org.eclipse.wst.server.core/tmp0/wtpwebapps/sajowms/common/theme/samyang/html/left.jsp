...
<link rel="stylesheet" type="text/css" href="/common/theme/samyang/css/left.css">
...
<div class="lnb">
	<div class="icons">
		<input type="text" id="menuSearch" size="14" onkeypress="commonUtil.enterKeyCheck(event,'menuSearch()')"/>
		<div class="rightArea">
			<!-- button class="button type1 first" type="button"><img src="/common<%=theme%>/images/ico_left1.png" alt=""></button-->
			<button class="button type1" type="button" onclick="window.top.refreshPage()"><img src="/common<%=theme%>/images/ico_left33.png" alt=""></button>		
			<button class="button type1 second" type="button" onclick="fmenuInsert()"><img src="/common<%=theme%>/images/ico_left22.png" alt=""></button>
		</div>
	</div>
