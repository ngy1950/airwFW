...
<title>기본적인 이미지 파일의 정보를 가져오는 예제입니다.</title>
</head>

<body> 
	<div class="content_title_area">
	<div class="content_title">샘플 설명</div>
	<div class="content_desc">기본적인 이미지 파일의 정보를 가져오는 예제입니다.</div>
	<div class="content_title">샘플 경로</div>
	<div class="content_desc">NamoCrossUploaderJaSamples/ImageProcessing/BasicImageInformation</div>
	</div><br />
