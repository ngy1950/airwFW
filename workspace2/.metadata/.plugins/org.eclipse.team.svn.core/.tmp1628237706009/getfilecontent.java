...
//		System.out.println(map.getString("CHKMAK"));
	...
	public List displayDL99(DataMap map) throws Exception {
		...
		List keyList7 = new ArrayList<>();
		keyList7.add("S.ASKU02");
		map.put("ASKU02", sqlUtil.getRangeSqlFromList((DataMap) map.get(CommonConfig.RNAGE_DATA_MAP), keyList7));
	...
	public List displayDL88(DataMap map) throws Exception {
		...
		List keyList6 = new ArrayList<>();
		keyList6.add("S.ASKU02");
		map.put("ASKU02", sqlUtil.getRangeSqlFromList((DataMap) map.get(CommonConfig.RNAGE_DATA_MAP), keyList6));
	...
	// [DL88] 저장
	public List allocateSODL88(DataMap map) throws Exception {
		List<DataMap> rsList = new ArrayList();
		DataMap clsMap = new DataMap();
		...
		try {
			...
			for(DataMap svbelnData : svbelnList){
				...
				//svbelnData.setModuleCommand("OutBoundReport", "P_IFWMS113_CREATE_SHIPMENT");
				//commonDao.update(svbelnData);
				this.allocatePROCDL88(svbelnData);
	...
	// [DL88] 저장
	@Transactional(rollbackFor = Exception.class)
	public void allocatePROCDL88(DataMap map) throws Exception {

        TransactionDefinition transactionDefinition = new DefaultTransactionDefinition();
        TransactionStatus transactionStatus = transactionManager.getTransaction(transactionDefinition);

		try{
			map.setModuleCommand("OutBoundReport", "P_IFWMS113_CREATE_SHIPMENT");
