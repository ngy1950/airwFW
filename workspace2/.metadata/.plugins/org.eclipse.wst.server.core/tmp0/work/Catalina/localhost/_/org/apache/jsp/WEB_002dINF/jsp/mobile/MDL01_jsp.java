 ...
 * Generated at: 2021-06-28 01:22:41 UTC
...
public final class MDL01_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\t$(\"#QTSIWH\").val(\"\");\r\n");
      out.write("\t\t\t\r\n");
      out.write(" \t\t\tif(param.map.TASKKY != null && param.map.SKUKEY == null){\r\n");
      out.write(" \t\t\t\t$(\"#TASKKY\").select();\r\n");
      out.write(" \t\t\t}else if(param.map.SKUKEY != null){\r\n");
      ...
      out.write("/* \r\n");
      out.write("    //생성\r\n");
      out.write("    function popOpen(){\r\n");
      out.write("//      if(gridList.getSelectData(\"gridList1\"))\r\n");
      out.write("       // var data = getfocusGridDataList(\"gridList\");\r\n");
      out.write("        \r\n");
      out.write("        page.linkPopOpen(\"/mobile/MDL02POP.page\", null, \"height=500,width=600,resizeble=yes\");\r\n");
      out.write("    } \r\n");
      out.write("*/    \r\n");
      out.write("/* \r\n");
      out.write("\t//합계 계산\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>재고보충완료확인</span></div>\r\n");
      ...
      out.write("<!-- \t\t\t\t\t\t\t\t<td> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"CARDAT\"  name=\"CARDAT\" class=\"input input-width\" UIFormat=\"C N\" > -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"input1 btn_Search\" value=\"검색\" onclick=\"searchList();\" style=\"background-color:#fff;\"/> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t</td> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t</tr> -->\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_SKUKEY\">제품코드<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"SKUKEY\" name=\"SKUKEY\" class=\"input input-width\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_CARDAT\">배송일자<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"CARDAT\" name=\"CARDAT\" class=\"input input-width\" UIFormat=\"C\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_DESC01\">품목명<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"DESC01\" name=\"DESC01\" class=\"input input-width\" readonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_LOTA13\">유통기한<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"LOTA13\" name=\"LOTA13\" class=\"input input-width\" readonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_QTSIWH\">보충수량<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"QTSIWH\" name=\"QTSIWH\" class=\"input input-width\" readonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"100\" GCol=\"text,LOTA13\" GF=\"D 14\"></td>  <!--유통기한   -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,SKUKEY\" GF=\"S 20\"></td>  <!--품목    -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- <td GH=\"40\" GCol=\"text,QTALOC\" GF=\"N 13,1\"></td>  할당수량    -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- <td GH=\"40\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  보충수량   -->\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<!-- 버튼 1개 시에는 id=\"long\" 2개일떄는 half -->\r\n");
