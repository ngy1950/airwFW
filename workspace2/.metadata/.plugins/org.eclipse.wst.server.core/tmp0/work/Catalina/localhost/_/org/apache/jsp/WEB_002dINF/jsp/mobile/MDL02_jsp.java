 ...
 * Generated at: 2021-06-23 06:16:09 UTC
...
public final class MDL02_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("/* 출고문서번호  */\r\n");
      out.write("var shpoky;\r\n");
      out.write("var shpoit;\r\n");
      out.write("var skukey;\r\n");
      out.write("var taskit;\r\n");
      out.write("var qtable;\r\n");
      out.write("\r\n");
      out.write("var input = '';\r\n");
      out.write("var mode = '';\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("/* 모바일 할당조회완료 화면 */\r\n");
      out.write("\r\n");
      out.write("\t$(document).ready(function(){\r\n");
      out.write("\t\tgridList.setGrid({\r\n");
      out.write("\t    \tid : \"gridList\",\r\n");
      out.write("\t\t\tmodule : \"MobileOutbound\",\r\n");
      out.write("\t\t\tcommand : \"MDL02\",\r\n");
      ...
      out.write("\t\t\tmodule : \"MobileOutbound\",\r\n");
      out.write("\t\t\tcommand : \"MDL02POP_CHECK\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#SHPOKY\").keyup(function(e){if(e.keyCode == 13)searchList();});\r\n");
      out.write("\t\t$(\"#SHPOKY\").focus();\r\n");
      out.write("// \t\t//검색값 클릭시 초기화\r\n");
      out.write("\t\t$(\"#SHPOKY\").click(function(){$(this).select()}); \r\n");
      out.write("\t\t$(\"#POP_BARCODE\").click(function(){$(this).select()}); \r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 팝업 */\r\n");
      out.write("\t\t$(\"#POP_DESC01\").keyup(function(e){if(e.keyCode == 13)pop_searchList();});\r\n");
      out.write("\t\t$(\"#POP_SHPOKY\").keyup(function(e){if(e.keyCode == 13)pop_searchList();});\r\n");
      out.write("\t\t$(\"#POP_LOCAKY\").keyup(function(e){if(e.keyCode == 13)searchBarcode();});\r\n");
      out.write("\t\t$(\"#POP_BARCODE\").keyup(function(e){if(e.keyCode == 13)searchBarcode();});\r\n");
      out.write("\r\n");
      out.write("\t\t//총 건수 위치 고정\r\n");
      out.write("\t\t$(function(){\t\r\n");
      out.write("\t\t\t$('.mobile-data-box').scroll(function() {\r\n");
      out.write("\t\t\t    $(this).find('.tableUtil').css('right', -($(this).scrollLeft()));\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t})\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t$('.content_layout_wrap input').focus(function(){\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$('.content_layout_wrap input').blur(function(){\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t/* 팝업 바코드 조회 */\r\n");
      out.write("\tfunction searchBarcode(){\r\n");
      out.write("\t\tif(validate.check(\"searchArea2\")){\r\n");
      out.write("\t\t\tvar param = inputList.setRangeParam(\"searchArea2\");\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\tvar pop_trnuid = $(\"#POP_BARCODE\").val();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t/* PT바코드 입력 필수 */\r\n");
      out.write("\t\t\tif(pop_trnuid == \"\"){\r\n");
      out.write("\t\t\t\tcommonUtil.msgBox(\"PT바코드를 입력해주세요.\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t/* 바코드 스캔시 stkky 조회 */\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t    \t\tmodule : \"MobileOutbound\",\r\n");
      out.write("\t\t\t\tcommand : \"MDL02POP\",\r\n");
      out.write("\t\t\t\tbindType : \"grid\",\r\n");
      out.write("\t\t\t\tsendType : \"list\",\r\n");
      out.write("\t\t\t\tbindId : \"LayerGridList\",\r\n");
      out.write("\t\t    \tparam : param\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t// 검색조건 선택후 블러처리\r\n");
      out.write("\t\t\t$(\"#POP_BARCODE\").select();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"SHPOIT\",shpoit);\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t/* 할당이 있는지 phydh 조회 */\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t\t$(\"#PTNRKYNM\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#POP_DESC01\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#POP_SHPOKY\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#POP_LOCAKY\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#POP_BARCODE\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#SHPOKY\").select();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\tif(gridId == \"LayerGridList\" && dataCount > 0){\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\tif(gridId == \"LayerGridList\"){\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t//전체 체크박스 이벤트 후 \r\n");
      ...
      out.write("\t\t if(colName == \"QTYWRK\"){ //수량변경시연결된 수량 변경\r\n");
      out.write("\t\t\tvar boxqty = 0;\r\n");
      out.write("\t\t\tvar bxiqty = Number(gridList.getColData(gridId, rowNum, \"QTDUOM\"));\r\n");
      out.write("\t\t\tvar qtywrk = Number(gridList.getColData(gridId, rowNum, \"QTYWRK\"));\r\n");
      out.write("\t\t\tboxqty = floatingFloor((Number)(qtywrk)/(Number)(bxiqty), 0);\r\n");
      out.write("\t\t  \tgridList.setColValue(gridId, rowNum, \"BOXQTY\", boxqty);\r\n");
      out.write("\r\n");
      out.write("\t\t  \t//수량 CHECK\r\n");
      out.write("\t\t  \tif(Number(colValue) > Number(gridList.getColData(gridId, rowNum, \"QTALOC\"))){\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\tqtywrk += (Number)(gridList.getColData(\"LayerGridList\", data[i].get(\"GRowNum\"), \"QTYWRK\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t$(\"#POP_QTTAOR\").val(qtywrk);\r\n");
      out.write("\t} \r\n");
      out.write("\t\r\n");
      out.write("\t//팝업창 저장\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t/* 작업수량이 할당가능수량보다 많을경우 */\r\n");
      out.write("\t\t\tif((Number)($(\"#POP_QTABLE\").val()) < (Number)($(\"#POP_QTTAOR\").val())){\r\n");
      out.write("\t\t\t\tcommonUtil.msgBox(\"작업 수량이 할당가능수량을 초과하였습니다.\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t\t//유효성검사\r\n");
      ...
      out.write("\t\t\t\tvar gridMap = data[i].map;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tif((Number)(gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"QTYWRK\")) < 1){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"VALID_M0952\");\r\n");
      out.write("\t\t\t\t\tgridList.setColFocus(\"gridList\", data[i].get(\"GRowNum\"), \"QTYWRK\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t        \r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"TRNUTG\", $(\"#TRNUTG\").val());\r\n");
      out.write("\t\t\tparam.put(\"JOBTYP\", \"210\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t/* MDL02 할당조회/완료 화면에서 넘어온 SHPOKY, SHPOIT, TASKIT 셋팅 */\r\n");
      out.write("\t\t\tparam.put(\"SHPOKY\", shpoky);\r\n");
      out.write("\t\t\tparam.put(\"SHPOIT\", shpoit);\r\n");
      out.write("\t\t\tparam.put(\"TASKIT\", taskit);\r\n");
      out.write("\t\t\tparam.put(\"SKUKEY\", skukey);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/mobileOutbound/json/MDL02POP.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t//팝업창 삭제\r\n");
      out.write("\tfunction POP_deleteData(){\r\n");
      out.write("\t\tif(gridList.validationCheck(\"gridList\", \"all\")){\r\n");
      out.write("\r\n");
      out.write("\t\t    var param = new DataMap();\r\n");
      out.write("\t        var data = gridList.getSelectData(\"LayerGridList\");\r\n");
      ...
      out.write("\t\t\t\tvar gridMap = data[i].map;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tif(gridMap.TASKKY.trim() == \"\"){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"작업오더가 존재하지 않습니다.\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tif((Number)(gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"QTYWRK\")) < 1){\r\n");
      ...
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"TRNUTG\", $(\"#TRNUTG\").val());\r\n");
      out.write("\t\t\tparam.put(\"JOBTYP\", \"210D\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t/* MDL02 할당조회/완료 화면에서 넘어온 SHPOKY, SHPOIT, TASKIT 셋팅 */\r\n");
      out.write("\t\t\tparam.put(\"SHPOKY\", shpoky);\r\n");
      out.write("\t\t\tparam.put(\"SHPOIT\", shpoit);\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/mobileOutbound/json/MDL02POP_Delete.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      out.write("\t\t\t\tsuccessFunction : \"successSaveCallBack\"\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t  var desc01 = gridList.getColData(\"gridList\", hrowNum, \"DESC01\");\r\n");
      out.write("\t\t  skukey = gridList.getColData(\"gridList\", hrowNum, \"SKUKEY\");\r\n");
      out.write("\t\t  shpoky = gridList.getColData(\"gridList\", hrowNum, \"SHPOKY\");\r\n");
      out.write("\t\t  shpoit = gridList.getColData(\"gridList\", hrowNum, \"SHPOIT\");\r\n");
      out.write("\t  \t  taskit = gridList.getColData(\"gridList\", hrowNum, \"TASKIT\");\r\n");
      out.write("\t      qtable = gridList.getColData(\"gridList\", hrowNum, \"QTABLE\");\t// 할당 가능수량 \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t      $(\"#POP_DESC01\").val(desc01);\r\n");
      out.write("\t\t  $(\"#POP_SHPOKY\").val(shpoky);\r\n");
      out.write("\t\t  $(\"#POP_QTABLE\").val(qtable);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t      $(\".layer_popup .label-btn\").show();\r\n");
      out.write("\t      $(\".layer_popup\").animate({height:\"100%\"},400);\r\n");
      out.write("\t      \r\n");
      out.write("\t      pop_searchList();\r\n");
      out.write("\t      $(\"#POP_BARCODE\").focus();\r\n");
      out.write("\t }\r\n");
      out.write("\t\r\n");
      out.write("\t//레이어 팝업 닫기\r\n");
      out.write("\tfunction LayerPopClose() {      \r\n");
      out.write("\t     $(\".layer_popup\").animate({height:\"0%\"},400,function(){$(\".layer_popup .label-btn\").hide()});\r\n");
      out.write("\t}\r\n");
      out.write("/* \t\r\n");
      out.write("\t//레이어 팝업 열기\r\n");
      out.write("\tfunction LayerPop() {\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>할당조회/완료</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>출하문서<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"SHPOKY\" name=\"SHPOKY\" class=\"input input-width\" validate=\"required(STD_SHPOKY_NO)\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>출고처<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"PTNRKYNM\" name=\"PTNRKYNM\" class=\"input input-width\" value=\"\" readonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"300\" GCol=\"text,DESC01\"></td>  <!--제품명   -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTSHPO\" GF=\"N 13,1\"></td>  <!--재고    -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTALOC\" GF=\"N 13,1\"></td>  <!--입수    -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"input,QTJCMP\" GF=\"N 13,1\"></td>  <!--박스    -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTABLE\" GF=\"N 13,1\"></td>  <!--박스    -->\r\n");
      ...
      out.write("\t\t\t\t<label id=\"threeP\" onClick=\"LayerPop()\">품목선택</label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t<div class=\"mobile_order\">\r\n");
      out.write("\t\t<div class=\"layer_title\"><span>할당조회/완료 팝업</span></div>\r\n");
      out.write("\t\t<div class=\"mobile-data-top\">\r\n");
      out.write("\t\t\t<div class=\"mobile-data-box\">\r\n");
      out.write("\t\t\t\t<div class=\"content_layout_wrap\" id=\"searchArea2\">\r\n");
      out.write("\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>제품코드/PT바코드<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"POP_BARCODE\" name=\"BARCODE\" class=\"input input-width\" validate=\"required(제품코드/PT바코드)\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>제품명<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"POP_DESC01\" name=\"DESC01\" class=\"input input-width\" value=\"\" readonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>출고문서<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"POP_SHPOKY\" name=\"SHPOKY\" class=\"input input-width\" value=\"\" readonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>할당 가능수량/작업수량<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"POP_QTABLE\" name=\"QTABLE\" class=\"input1 input-width\" readonly/> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"POP_QTTAOR\" name=\"QTTAOR\" class=\"input1 input-width\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("<!-- \t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>제품코드<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"POP_SKUKEY\" name=\"SKUKEY\" class=\"input input-width\" value=\"\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>PT바코드<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"POP_BARCODE\" name=\"BARCODE\" class=\"input input-width\" value=\"\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr> -->\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,LOCAKY\"></td>  <!--로케이션  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,TRNUID\"></td>  <!--팔렛트ID-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"50\" GCol=\"text,QTALOC\" GF=\"N 13,1\"></td>  <!--할당수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"50\" GCol=\"input,QTYWRK\" GF=\"N 13,1\"></td>  <!--작업수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"50\" GCol=\"text,QTDUOM\" GF=\"N 13,1\"></td>  <!--입수-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"50\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!--박스수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"50\" GCol=\"text,REMQTY\" GF=\"N 13,1\"></td>  <!--잔량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"input,LOTA13\" GF=\"C\"></td>  <!--유통기한-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"110\" GCol=\"text,KEY\"></td>  <!-- KEY-->\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- <td GH=\"40\" check=\"ALOCHK\"></td>       -->\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t<div class=\"label-btn\">\r\n");
      out.write("\t\t\t\t<!-- 버튼 1개 시에는 id=\"long\" 2개일떄는 half 3개일떄 threeP 4개일때 quarter -->\r\n");
      out.write("\t\t\t\t<label id=\"quarter\" onClick=\"pop_searchList()\">검색</label>\r\n");
      out.write("\t\t\t\t<label id=\"quarter\" onClick=\"POP_saveData()\">저장</label>\r\n");
      out.write("\t\t\t\t<label id=\"quarter\" onClick=\"POP_deleteData()\">삭제</label>\r\n");
      out.write("\t\t\t\t<label id=\"quarter\" onClick=\"LayerPopClose()\">닫기</label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
