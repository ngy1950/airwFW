 ...
 * Generated at: 2021-06-23 06:53:36 UTC
...
public final class MDL07_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\tmodule : \"MobileOutbound\",\r\n");
      out.write("\t\t\tcommand : \"MDL07POP\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t    });\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#STKNUM\").keyup(function(e){if(e.keyCode == 13)searchList();});\r\n");
      out.write("\t\t$(\"#STKNUM\").focus();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//팝업창 거래처명 검색\r\n");
      out.write("\t\t$(\"#PTNRKYNM\").keyup(function(e){if(e.keyCode == 13)pop_searchList();});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//검색값 클릭시 초기화\r\n");
      out.write("\t\t$(\"#STKNUM\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t$(\"#PTNRKYNM\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t$(\"#TRNUTG\").click(function(){$(this).select()}) \r\n");
      out.write("\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      out.write("\t\t$('input').attr(\"inputmode\",\"none\");\r\n");
      out.write("\t\tinput = \"#STKNUM\";\r\n");
      out.write("\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"STKNUM\",$(\"#STKNUM\").val());\r\n");
      out.write("\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"PTNRKYNM\",$(\"#PTNRKYNM\").val());\r\n");
      out.write("\r\n");
      out.write("\t\t\tgridList.gridList({\r\n");
      out.write("\t\t    \tid : \"LayerGridList\",\r\n");
      out.write("\t\t    \tparam : param\r\n");
      ...
      out.write("\t\t\tvar svbeln = gridList.getColData(\"gridList\", hrowNum, \"SVBELN\");\r\n");
      out.write("\t\t\t$(\"#SVBELN\").val(svbeln);\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\tparam.put(\"JOBTYP\", \"207\");\r\n");
      out.write("\t\t\t/* MDL07 토탈피킹검수 화면에서 넘어온 SVBELN 셋팅 */\r\n");
      out.write("\t\t\tparam.put(\"SVBELN\", svbeln); \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/mobileOutbound/json/MDL07POP.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>토탈피킹검수</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_STKNUMTX\">총괄문서<span class=\"make\">*</span></th> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"STKNUM\" name=\"STKNUM\" class=\"input input-width\" validate=\"required(STD_STKNUMTX)\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,LOCADK\" GF=\"S 20\"></td>  <!--Dock 로케이션 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"200\" GCol=\"text,PTNRKYNM\"></td>  <!-- 거래처명-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"100\" GCol=\"text,SVBELN\"></td>  <!--S/O번호 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,QTSHPO\" GF=\"N 13,1\"></td>  <!--지시수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,QTJCMP\" GF=\"N 13,1\"></td>  <!--완료수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,QTSHPD\" GF=\"N 13,1\"></td>  <!--출고수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<label id=\"threeP\" onClick=\"LayerPop()\">주문선택</label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t<div class=\"mobile_order\">\r\n");
      out.write("\t\t\t<div class=\"layer_title\"><span>토탈피킹검수  팝업</span></div>\r\n");
      out.write("\t\t\t<div class=\"mobile-data-top\">\r\n");
      out.write("\t\t\t\t<div class=\"mobile-data-box\">\r\n");
      out.write("\t\t\t\t\t<div class=\"content_layout_wrap\" id=\"searchArea\">\r\n");
      out.write("\t\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>거래처명<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"PTNRKYNM\" name=\"PTNRKYNM\" class=\"input input-width\" value=\"\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>분배위치<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"TRNUTG\" name=\"TRNUTG\" class=\"input input-width\" value=\"\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,CONFRM\" GF=\"S 20\"></td>  <!-- 검  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,SKUKEY\" GF=\"S 20\"></td>  <!--제품코드 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"300\" GCol=\"text,DESC01\" GF=\"S 20\"></td>  <!--제품명 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,QTSHPO\" GF=\"N 13,1\"></td>  <!--지시수량  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,QTJCMP\" GF=\"N 13,1\"></td>  <!--완료수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"input,QTYWRK\" GF=\"N 13,1\"></td>  <!--작업수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTDUOM\" GF=\"N 13,1\"></td>  <!--입수 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!--박스수량 -->\r\n");
