 ...
 * Generated at: 2021-06-23 07:06:05 UTC
...
public final class MDL09_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\tcommand : \"MDL09\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t    });\r\n");
      out.write("\t\t$(\"#DOCSEQ\").focus();\r\n");
      out.write("\t\t$(\"#DOCSEQ\").keyup(function(e){if(e.keyCode == 13)searchList();});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//검색값 클릭시 초기화\r\n");
      out.write("\t\t$(\"#DOCSEQ\").click(function(){$(this).select()}); \r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      out.write("\t\t$('input').attr(\"inputmode\",\"none\");\r\n");
      out.write("\t\tinput = \"#DOCSEQ\";\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t\t$(\"#PTNRNM\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#DOCDAT\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#RECOYN\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#RECODT\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#WORKSUM1\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#WORKSUM2\").val(\"\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"#DOCSEQ\").select();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tallSave = false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write(" \t\t\tif($(\"#RECOYN\").val() == 'Y' && allSave == false){\r\n");
      out.write("\t\t\t\tcommonUtil.msgBox(\"이미 회수 완료된 제품입니다.\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t} \r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\tparam.put(\"JOBTYP\", \"290\");\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/mobileOutbound/json/saveMDL09.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfor(var i=0; i<GList.length; i++){\r\n");
      out.write("\t\t\t\tif( GList[i].get(\"RECOYN\") == \"N\" ){\r\n");
      out.write("\t\t\t\t\tgridList.checkAll(gridId,true);\r\n");
      out.write("\t\t\t\t\tallSave = true;\r\n");
      out.write("\t\t\t\t\tsaveData();\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t$(\"#DOCDAT\").val(GList[0].get(\"DOCDAT\"));\r\n");
      out.write("\t\t\t$(\"#RECOYN\").val(GList[0].get(\"RECOYN\"));\r\n");
      out.write("\t\t\t$(\"#RECODT\").val(GList[0].get(\"RECODT\"));\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//클릭시 클릭한 로우 데이터 검색조건에 출력\r\n");
      ...
      out.write("\t\t\tvar GList = gridList.getGridBox('gridList').getDataAll();\r\n");
      out.write("\t\t\t$(\"#PTNRNM\").val(GList[rowNum].get(\"PTNRNM\"));\r\n");
      out.write("\t\t\t$(\"#DOCDAT\").val(GList[rowNum].get(\"DOCDAT\"));\r\n");
      out.write("\t\t\t$(\"#RECOYN\").val(GList[rowNum].get(\"RECOYN\"));\r\n");
      out.write("\t\t\t$(\"#RECODT\").val(GList[rowNum].get(\"RECODT\"));\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\t\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\tworksum1 = worksum1+(Number)(gridList.getColData(\"gridList\", list[i].get(\"GRowNum\"), \"QTSHPD\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//총 합계\r\n");
      out.write("\t\tfor(var i=0; i<list2.length; i++){\r\n");
      out.write("\t\t\tvar gridMap = list2[i].map;\r\n");
      out.write("\t\t\tworksum2 = worksum2+(Number)(gridList.getColData(\"gridList\", list2[i].get(\"GRowNum\"), \"QTSHPD\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>화수단입력</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_DOC_NO\">문서번호<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"DOCSEQ\" name=\"DOCSEQ\" class=\"input input-width\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_ORDDAT\">출고일자<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"DOCDAT\"  name=\"DOCDAT\" class=\"input input-width\" UIFormat=\"D\" readonly></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_RECOYN\">회수여부<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"RECOYN\"  name=\"RECOYN\" class=\"input input-width\" readonly style=\"width:30%;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"RECODT\"  name=\"RECODT\" class=\"input input-width\" UIFormat=\"D\" readonly style=\"width:70%; float:right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_QTSHPD\" GCol=\"text,QTSHPD\" GF=\"N 13,1\" </td>  <!-- 출고수량 -->  \r\n");
