 ...
 * Generated at: 2021-06-23 07:06:31 UTC
...
public final class MDL11_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\tcommand : \"MDL11\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t    });\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#SSORNU\").keyup(function(e){if(e.keyCode == 13)scanSsornu();});\r\n");
      out.write("\t\t$(\"#SSORNU\").focus();\r\n");
      out.write("\r\n");
      out.write("\t\t$(\"#LOCAKY\").keyup(function(e){if(e.keyCode == 13)searchList();});\r\n");
      out.write("\t\t//검색값 클릭시 초기화\r\n");
      out.write("\t\t$(\"#TASKKY\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t$(\"#LOCAKY\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      out.write("\t\t$('input').attr(\"inputmode\",\"none\");\r\n");
      out.write("\t\tinput = \"#SSORNU\";\r\n");
      out.write("\r\n");
      ...
      out.write("\t\r\n");
      out.write("\r\n");
      out.write("\tfunction scanSsornu(){\r\n");
      out.write("\t\t$(\"#LOCAKY\").focus();\r\n");
      out.write("\t\t$(\"#LOCAKY\").select();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t    });\r\n");
      out.write("\t\t\t\r\n");
      out.write("// \t\t\t$(\"#SSORNU\").val(\"\");\r\n");
      out.write("\t\t\t//$(\"#LOCAKY\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#WORKSUM1\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#WORKSUM2\").val(\"\");\r\n");
      out.write("// \t\t\t$(\"#LOCAKY\").focus();\r\n");
      out.write("\r\n");
      out.write("\t\t\t$(\"#SSORNU\").select();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\turl : \"/mobile/mobileOutbound/json/saveMDL11.data\", \r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      ...
      out.write("\t\r\n");
      out.write("// \t//합계 계산\r\n");
      out.write("// \tfunction calTotal(gridId, rowNum){\r\n");
      ...
      out.write("// \t\tvar data = headGridBox.getRowData(rowNum).map;\r\n");
      out.write("\r\n");
      out.write("// \t\tworksum1 = worksum1+(Number)(gridList.getColData(\"gridList\", data.GRowNum, \"BOXWRK\"));\r\n");
      out.write("// \t\tworksum2 = worksum2+(Number)(gridList.getColData(\"gridList\", data.GRowNum, \"BOXQTY\"));\r\n");
      out.write("\t\t\r\n");
      out.write("// \t\t$(\"#WORKSUM1\").val(worksum1);\r\n");
      out.write("// \t\t$(\"#WORKSUM1\").attr(\"GIRDROW\", rowNum);\r\n");
      ...
      out.write("\t\t\tworksum1 = worksum1+(Number)(gridList.getColData(\"gridList\", list[i].get(\"GRowNum\"), \"BOXWRK\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//총 합계\r\n");
      out.write("\t\tfor(var i=0; i<list2.length; i++){\r\n");
      out.write("\t\t\tvar gridMap = list2[i].map;\r\n");
      out.write("\t\t\tworksum2 = worksum2+(Number)(gridList.getColData(\"gridList\", list2[i].get(\"GRowNum\"), \"BOXQTY\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#WORKSUM1\").val(worksum1);\r\n");
      out.write("\t\t$(\"#WORKSUM2\").val(worksum2);\r\n");
      ...
      out.write("        var param = new DataMap();   \r\n");
      out.write("        //로케이션\r\n");
      out.write("        if(searchCode == \"SHLOCMA\" && $inputObj.name == \"LOCATG\"){\r\n");
      ...
      out.write("    }\r\n");
      out.write("\t\r\n");
      out.write("\tfunction scanLoc(){\r\n");
      out.write("\t\t//완료수량이 모두 찍히면  피킹완료 프로시저를 직동한다 gridListEventColValueChange에서\r\n");
      out.write("\t\tvar gridId = 'gridList';\r\n");
      out.write("\t\tvar barcode = $(\"#LOCAKY\").val();\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\tvar gridDataBox = gridList.getGridBox(gridId);\r\n");
      out.write("\t\tvar gridListData = gridDataBox.getDataAll();\r\n");
      out.write("\t      \r\n");
      out.write("\t\tfor(var i=0; i<gridListData.length; i++){\r\n");
      out.write("\t\t\tvar rowNum = gridListData[i].get(\"GRowNum\");\r\n");
      out.write("\t\t\tgridList.setRowCheck(gridId, rowNum, true);\r\n");
      out.write("\t\t\tgridListEventRowCheck(gridId, rowNum, true);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tif(colName == \"QTYWRK\"){ //완료수량 변경시\r\n");
      out.write("\r\n");
      out.write("\t\t\tvar qttaor = Number(gridList.getColData(gridId, rowNum, \"QTCOMP\"));\r\n");
      out.write("\t\t\tif(colValue > qttaor){\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\tgridList.setColValue(gridId, rowNum, \"QTCOMP\", colValue);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//calTotal();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else if(colName == \"BOXWRK\"){ //박스수량 변경시\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\tfunction gridListEventRowClick(gridId, rowNum, btnName){\r\n");
      out.write("\r\n");
      out.write("\t\tcalTotal(gridId, rowNum);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\tvar rowNum = $(\"#WORKSUM1\").attr(\"GIRDROW\");\r\n");
      out.write("\t\tvar boxqty = $(\"#WORKSUM1\").val();\t\r\n");
      out.write("\t\tvar boxqty2 = $(\"#WORKSUM2\").val();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif(boxqty > boxqty2){\r\n");
      out.write("\t\t\tcommonUtil.msgBox(\"작업수량은 원주문수량보다 클 수 없습니다.\");\r\n");
      out.write("\t\t\t$(\"#WORKSUM1\").val(boxqty2);\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t  \tgridList.setColValue(\"gridList\", rowNum, \"BOXWRK\", boxqty);\r\n");
      out.write("\t\tgridListEventColValueChange(\"gridList\", rowNum, \"BOXWRK\", boxqty);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tvar boxwrk =  Number(gridList.getColData(gridId, rowNum, \"BOXWRK\"));\r\n");
      out.write("\t\tvar qtcomp =  Number(gridList.getColData(gridId, rowNum, \"QTCOMP\"));\r\n");
      ...
      out.write("\t\tvar pliqty =  Number(gridList.getColData(gridId, rowNum, \"PLIQTY\"));\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif(colName == \"BOXWRK\"){\r\n");
      out.write("\t\t\t//박스수량 + 잔량으로 재게산\r\n");
      out.write("\t\t\tvar totQty = boxwrk*bxiqty+remqty; \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t  \tremqty = (Number)(totQty)%(Number)(bxiqty);\r\n");
      out.write("\t\t  \tpltqty = floatingFloor((Number)(totQty)/(Number)(pliqty), 0);\r\n");
      out.write("\t\t  \tgridList.setColValue(gridId, rowNum, \"BOXWRK\", boxwrk);\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"REMQTY\", remqty);\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"PLTQTY\", pltqty);\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"QTYWRK\", totQty);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else if(colName == \"REMQTY\"){\r\n");
      out.write("\t\t\t//잔량은 1box이상 입력할 수 있으니 더해서 다시 계산한다\r\n");
      out.write("\t\t\tvar totQty = remqty+qtywrk; \r\n");
      out.write("\r\n");
      out.write("\t\t\tboxwrk = floatingFloor((Number)(totQty)/(Number)(bxiqty), 0);\r\n");
      out.write("\t\t  \tremqty = (Number)(totQty)%(Number)(bxiqty);\r\n");
      out.write("\t\t  \tpltqty = floatingFloor((Number)(totQty)/(Number)(pliqty), 0);\r\n");
      out.write("\t\t  \tgridList.setColValue(gridId, rowNum, \"BOXWRK\", boxwrk);\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"REMQTY\", remqty);\r\n");
      ...
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"QTYWRK\", totQty);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else if(colName == \"QTYWRK\"){\r\n");
      out.write("\r\n");
      out.write("\t\t\tboxwrk = floatingFloor((Number)(qtywrk)/(Number)(bxiqty), 0);\r\n");
      out.write("\t\t  \tremqty = (Number)(qtywrk)%(Number)(bxiqty);\r\n");
      out.write("\t\t  \tpltqty = floatingFloor((Number)(qtywrk)/(Number)(pliqty), 0);\r\n");
      out.write("\t\t  \tgridList.setColValue(gridId, rowNum, \"BOXWRK\", boxwrk);\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"REMQTY\", remqty);\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"PLTQTY\", pltqty);\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"QTYWRK\", qtywrk);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tqtywrk =  Number(gridList.getColData(gridId, rowNum, \"QTYWRK\"));\t\r\n");
      out.write("\t\t//validation\r\n");
      out.write("\t\tif(qtcomp < qtywrk){\r\n");
      out.write("\t\t\tcommonUtil.msgBox(\"작업수량은 원주문수량보다 클 수 없습니다.\");\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"QTYWRK\", 0);\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"REMQTY\", 0);\r\n");
      out.write("\t\t\tgridList.setColValue(gridId, rowNum, \"BOXWRK\", 0);\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>피킹완료</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_SSORNU\">적치지시번호<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"SSORNU\" name=\"SSORNU\" class=\"input input-width\" validate=\"required(STD_SSORNU)\" onclick=\"$(this).select();\"> </td>\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"TASKKY\" name=\"TASKKY\" class=\"input input-width\" validate=\"required(STD_TASNUM)\"></td> -->\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_LOCAKY\">로케이션<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"LOCAKY\" name=\"LOCAKY\" class=\"input input-width\" validate=\"required(STD_LOCAKY)\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr> \r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_WRKSUMBOX\">선택/총작업<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"WORKSUM1\" name=\"WORKSUM1\" class=\"input1 input-width\" onchange=\"setValue()\"/>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</tr> -->\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_TOLOC\">From지번<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"LOCASR\" name=\"LOCASR\" class=\"input input-width\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr> -->\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,TASSTATDO\"></td>  <!--작업여부-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,GUBUN\"></td>  <!--구분-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,LOCAKY\"></td>  <!--FROM로케이션-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,SKUKEY\" GF=\"S 20\"></td>  <!--제품코드 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"300\" GCol=\"text,DESC01\"></td>  <!--제품명 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"input,BOXWRK\" GF=\"N 13,1\" validate=\"required\"></td>  <!--작업수량(박스)-->\r\n");
      out.write("\t\t\t    \t\t\t\t\t<td GH=\"60\" GCol=\"input,REMQTY\" GF=\"N 17,0\">잔량</td>\t<!--잔량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,QTCOMP\" GF=\"N 13,1\" validate=\"required\"></td>  <!--완료수량(EA)-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"input,QTYWRK\" GF=\"N 13,1\" validate=\"required\"></td>  <!--작업수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"90\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!--팔레트수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,PLTQTY\" GF=\"N 13,1\"></td>  <!--박스수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,BXIQTY\" GF=\"N 13,1\" ></td>  <!-- 박스입수-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"90\" GCol=\"text,PLIQTY\" GF=\"N 13,1\" ></td>  <!-- 팔레트입수-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"100\" GCol=\"text,DTREMRAT\" GF=\"S\"></td>  <!--유통기한 잔여(%)-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 구코드\" GCol=\"text,DESC03\" GF=\"S\"></td>  <!--구코드-->\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
