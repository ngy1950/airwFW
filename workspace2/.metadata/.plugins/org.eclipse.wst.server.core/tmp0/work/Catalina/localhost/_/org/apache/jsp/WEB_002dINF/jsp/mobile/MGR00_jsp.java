 ...
 * Generated at: 2021-08-03 05:56:46 UTC
...
public final class MGR00_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\tcommand : \"MGR00\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t    });\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#TRNUID\").keyup(function(e){if(e.keyCode == 13)searchList();});\r\n");
      out.write("\t\t$(\"#TRNUID\").focus();\r\n");
      out.write("\t\t\r\n");
      out.write("// \t\t//검색값 클릭시 초기화\r\n");
      out.write("\t\t$(\"#TRNUID\").click(function(){$(this).select();}) \r\n");
      out.write("// \t\t//지번 클릭시 초기화\r\n");
      out.write("\t\t$(\"#LOCATG\").click(function(){$(this).select();}) \r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      out.write("\t\t$('input').attr(\"inputmode\",\"none\");\r\n");
      out.write("\t\tinput = \"#TRNUID\";\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t    });\r\n");
      out.write("\r\n");
      out.write("\t\t\t$(\"#TRNUID\").select();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"#DOCDAT\").val(dateParser(null, \"SD\", 0, 0, 0));\r\n");
      ...
      out.write("\t\t\tparam.put(\"JOBTYP\", \"151\");\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/MobileInbound/json/saveMGR00.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      ...
      out.write("\t\t\t$(\"#DESC01\").val(GList[0].get(\"DESC01\"));\r\n");
      out.write("\t\t\t$(\"#SKUKEY\").val(GList[0].get(\"SKUKEY\"));\t\t\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>생산입고(IPT)</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"TRNUID\" name=\"TRNUID\" class=\"input input-width\" validate=\"required(STD_BACODE)\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"SKUKEY\" name=\"SKUKEY\" class=\"input input-width\" readonly/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_DAT_LOC\">입고일자/To지번<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"DOCDAT\"  name=\"DOCDAT\" class=\"input1 input-width\" UIFormat=\"C N\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"LOCATG\"  name=\"LOCATG\" class=\"input1 input-width\" value = \"RCVLOC\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"120 STD_LOTA11\" GCol=\"text,LOTA11\" GF=\"D\"></td> <!-- 제조일자 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"120 STD_LOTA13\" GCol=\"text,LOTA13\" GF=\"D\"></td> <!-- 유통기한 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_QTSIWH\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  <!--  재고수량? QTSIWH--> \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_WAREKY\" GCol=\"text,WAREKY\" GF=\"S 20\"></td>  <!-- 거점 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_LOCAKY\" GCol=\"input,LOCAKY\" GF=\"S 20\"></td>  <!-- 로케이션 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_SKUKEY\" GCol=\"text,SKUKEY\" GF=\"S 20\"></td>  <!-- 제품코드 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"120 STD_PLBRCD\" GCol=\"text,TRNUID\" GF=\"S 20\"></td>  <!-- 팔렛트바코드 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
