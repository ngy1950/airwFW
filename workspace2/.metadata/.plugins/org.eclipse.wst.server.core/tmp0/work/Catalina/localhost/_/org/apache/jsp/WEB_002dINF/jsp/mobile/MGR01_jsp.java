 ...
 * Generated at: 2021-06-23 06:14:55 UTC
...
public final class MGR01_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\tcommand : \"MGR01MAIN\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t    });\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#ASNDKY\").keyup(function(e){if(e.keyCode == 13)searchList();});\r\n");
      out.write("\t\t$(\"#ASNDKY\").focus();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#TOTRUNG\").keyup(function(e){if(e.keyCode == 13)$(\"#LOCATG\").focus();});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//검색값 클릭시 \r\n");
      out.write("\t\t$(\"#ASNDKY\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t$(\"#TOTRUNG\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t$(\"#LOCATG\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      out.write("\t\t$('input').attr(\"inputmode\",\"none\");\r\n");
      out.write("\t\tinput = \"#ASNDKY\";\r\n");
      out.write("\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"SVBELN\",$(\"#SVBELN\").val());\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t    });\r\n");
      out.write("\t\t\t \r\n");
      out.write("\t\t\t$(\"#LOCATG\").val(\"RCVLOC\");\r\n");
      out.write("\t\t\t$(\"#TRNUTG\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#TOTRUNG\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#WORKSUM1\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#WORKSUM2\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#ASNDKY\").select(); \r\n");
      out.write("\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t        var proddt = $(\"#DOCDAT\").val();\r\n");
      out.write("\t        proddt = proddt.replace(/\\./g,\"\");\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}else if((Number)(gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"QTYWRK\")) > (Number)(gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"QTYASN\"))){\r\n");
      ...
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}else if(gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"STATIT\").trim() == \"V\"){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"입고완료된 문서입니다.\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t} \r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif($(\"#LOCATG\").val().trim() == \"\"){\r\n");
      out.write("\t\t\t\tcommonUtil.msgBox(\"To지번을 입력해주세요.\");\r\n");
      ...
      out.write("\t\t\tparam.put(\"PRODDT\", proddt);\r\n");
      out.write("\t\t\tparam.put(\"JOBTYP\", \"101\");\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/MobileInbound/json/saveMGR01.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// To바코드 필수 입력\r\n");
      out.write("\t\tif($(\"#TOTRUNG\").val().trim() == \"\"){\r\n");
      out.write("\t\t\tcommonUtil.msgBox(\"To바코드를 입력해주세요.\");\r\n");
      out.write("\t\t\t$(\"#TOTRUNG\").focus();\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tparam.put(\"OWNRKY\", \"");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\tparam.put(\"TRNUID\",$(\"#TOTRUNG\").val());\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\tif(gridId == \"gridList\"){\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t\t//$(\"#LOCATG\").val(gridList.getColData(gridId, rowNum, \"LOCAKY\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\tworksum2 = worksum2+(Number)(gridList.getColData(\"gridList\", list2[i].get(\"GRowNum\"), \"QTYASN\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>ASN입고</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_ASNDKY\">ASN입고번호<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"ASNDKY\" name=\"ASNDKY\" class=\"input input-width\" validate=\"required(STD_ASNDKY)\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_PTNRNM\">거래처명<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"TRNUTG\" name=\"TRNUTG\" class=\"input input-width\" readonly=\"readonly\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_LOTA12\">입고일자<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"DOCDAT\" name=\"DOCDAT\" class=\"input input-width\" UIFormat=\"C N\" validate=\"required(STD_LOTA12)\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_TOTRUNG\">To바코드<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"TOTRUNG\" name=\"TOTRUNG\" class=\"input input-width\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"input,SKUKEY\" GF=\"S 20\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,STATIT\" GF=\"S 20\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"250\" GCol=\"text,DESC01\" GF=\"S 20\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,QTYASN\" GF=\"N 13,1\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"90\" GCol=\"input,QTYWRK\" GF=\"N 13,1\"></td>  <!--제조일자-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"90\" GCol=\"input,QTDUOM\" GF=\"N 13,1\"></td>  <!--제조일자-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"input,QTYSTD\" GF=\"N 13,1\"></td>  <!--박스수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"input,PLTQTY\" GF=\"N 13,1\"></td>  <!--박스수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"input,BOXQTY\" GF=\"N 13,1\"></td>  <!--박스수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"input,REMQTY\" GF=\"N 13,1\"></td>  <!--박스수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"90\" GCol=\"text,LOTA11\" GF=\"C\"></td>  \t   <!--제조일자-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"90\" GCol=\"text,LOTA13\" GF=\"C\"></td>  \t   <!--박스수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
