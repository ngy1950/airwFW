 ...
 * Generated at: 2021-07-12 04:25:11 UTC
...
public final class MGR05_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\tmodule : \"MobileInbound\",\r\n");
      out.write("\t\t\tcommand : \"MGR05\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t    });\r\n");
      out.write("\t\t//레이어 팝업\r\n");
      out.write("\t\tgridList.setGrid({\r\n");
      out.write("\t    \tid : \"LayerGridList\",\r\n");
      out.write("\t\t\tmodule : \"MobileInbound\",\r\n");
      out.write("\t\t\tcommand : \"MGR05_POP\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t    });\r\n");
      out.write("\r\n");
      out.write("\t\t$(\"#RECVKY\").focus();\r\n");
      out.write("\t\t$(\"#RECVKY\").keyup(function(e){if(e.keyCode == 13)searchList();});\r\n");
      out.write("\t\t//팝업창 타스키 검색\r\n");
      out.write("\t\t$(\"#BARCODE_POP\").keyup(function(e){if(e.keyCode == 13)POP_searchList();});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//검색값 클릭시 초기화\r\n");
      out.write(" \t\t$(\"#RECVKY\").click(function(){$(this).select()}) \r\n");
      out.write(" \t\t$(\"#BARCODE_POP\").click(function(){$(this).select()}) \r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      out.write("\t\t$('input').attr(\"inputmode\",\"none\");\r\n");
      out.write("\t\tinput = \"#RECVKY\";\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\tvar recvky = $(\"#RECVKY\").val();\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"RECVKY\",recvky);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif (recvky.trim() == \"\"){\r\n");
      out.write("\t\t\t\tcommonUtil.msgBox(\" 문서번호를 입력해주세요.\"); \r\n");
      out.write("\t\t\t\t$(\"#RECVKY\").val(\"\");\r\n");
      out.write("\t\t\t\t$(\"#RECVKY\").focus();\r\n");
      out.write("\t\t\t\treturn \r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t$(\"#RECVKY\").focus();\r\n");
      out.write("\t\t\t$(\"#RECVKY\").select();\r\n");
      out.write("\t\t\t\r\n");
      out.write("// \t\t\t$(\"#RECVKY\").val(\"\");\r\n");
      out.write("// \t\t\t$(\"#LOCATG\").val(\"\");\r\n");
      out.write("// \t\t\t$(\"#TRNUTG\").val(\"\");\r\n");
      out.write("// \t\t\t$(\"#RECVKY\").focus();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//팝업창 서치리스트 조회 \r\n");
      out.write("\tfunction POP_searchList(){ \r\n");
      out.write("\t\tif(validate.check(\"searchArea\")){ \r\n");
      out.write("\t\t\tvar param = inputList.setRangeParam(\"searchArea\"); \r\n");
      out.write("\t\t\tvar data = gridList. getGridData(\"LayerGridList\");\r\n");
      out.write("\t\t\tvar grid = gridList.getRowData(\"gridList\", gridList.getFocusRowNum(\"gridList\")); \r\n");
      out.write("\t\t\tparam.put(\"OWNRKY\", \"");
      out.print(ownrky);
      out.write("\"); \r\n");
      out.write("\t\t\tparam.put(\"WAREKY\", \"");
      out.print(wareky);
      out.write("\"); \r\n");
      out.write("\t\t\tparam.put(\"BARCODE\",$(\"#BARCODE_POP\").val()); \r\n");
      out.write("\t\t\tparam.put(\"SKUKEY\",grid.map.SKUKEY);\r\n");
      out.write("\t\t\tparam.put(\"Data\",data); \r\n");
      out.write("\t\t\t \r\n");
      out.write("\t\t\tvar trnuidStr = \"AND B.BARCOD IN (\"; \r\n");
      out.write("\t\t\tfor(var i = 0; i < data.length; i++ ){ \r\n");
      out.write("\t\t\t\tvar trnuid = gridList.getColData(\"LayerGridList\", data[i].get(\"GRowNum\"), \"TRNUID\"); \r\n");
      out.write("\t\t\t\tif(trnuid == $(\"#BARCODE_POP\").val()){ \r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\" 동일한 바코드가 존재합니다.\"); \r\n");
      out.write("\t\t\t\t\t$(\"#BARCODE_POP\").select();\r\n");
      out.write("\t\t\t\t\treturn \r\n");
      out.write("\t\t\t\t} \r\n");
      out.write("\t\t\t\tif(i==0){ \r\n");
      out.write("\t\t\t\t\ttrnuidStr+=\"'\"+trnuid+\"'\"; \r\n");
      out.write("\t\t\t\t}else{ \r\n");
      out.write("\t\t\t\t\ttrnuidStr+=\",'\"+trnuid+\"'\"; \r\n");
      out.write("\t\t\t\t} \r\n");
      out.write("\t\t\t} \r\n");
      ...
      out.write("\t\t\t\ttrnuidStr+=\"'\"+$(\"#BARCODE_POP\").val()+\"'\"; \r\n");
      out.write("\t\t\t}else{ \r\n");
      out.write("\t\t\t\ttrnuidStr+=\",'\"+$(\"#BARCODE_POP\").val()+\"'\"; \r\n");
      out.write("\t\t\t} \r\n");
      out.write("\t\t\t \r\n");
      out.write("\t\t\ttrnuidStr += \")\"; \r\n");
      out.write("\t\t\t \r\n");
      out.write("\t\t\tparam.put(\"TRNUIDS\",trnuidStr); \r\n");
      out.write("\t\t\tgridList.resetGrid(\"LayerGridList\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({ \r\n");
      out.write("\t\t\t\turl : \"/mobile/MobileInbound/json/searchMGR05_POP.data\", \r\n");
      out.write("\t\t\t\tparam : param, \r\n");
      out.write("\t\t\t\tsendType : \"list\", \r\n");
      out.write("\t\t\t\tbindType : \"grid\",  //bindType grid 고정 \r\n");
      out.write("\t\t\t\tbindId : \"LayerGridList\" //그리드ID \r\n");
      out.write("\t\t\t}); \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 검색조건 선택후 블러처리\r\n");
      out.write("\t\t\t$(\"#BARCODE_POP\").focus();\r\n");
      out.write("\t\t\t$(\"#BARCODE_POP\").select();\r\n");
      out.write("\t\t} \r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\t//To지번 추천\r\n");
      out.write("\tfunction recommend(){\r\n");
      out.write("\t\tvar param = new DataMap();\r\n");
      out.write("\t\tvar data = gridList.getSelectData(\"gridList\");\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar focusData = gridList.getRowData(\"gridList\", gridList.getFocusRowNum(\"gridList\")); \r\n");
      out.write("\t\t\r\n");
      out.write("\t\tparam.put(\"OWNRKY\", \"");
      out.print(ownrky);
      out.write("\");\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\tparam.put(\"SKUKEY\",focusData.map.SKUKEY);\r\n");
      out.write("\t\tparam.put(\"LOCAKY\",\"\");\r\n");
      out.write("\r\n");
      out.write("\t\tvar json = netUtil.sendData({\r\n");
      out.write("\t\t\tmodule : \"MobileInbound\",\r\n");
      out.write("\t\t\tcommand : \"MGR06_LOKA\",\r\n");
      out.write("\t\t\tsendType : \"map\",\r\n");
      out.write("\t\t\tparam : param\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//조회한 쿼리에서 LOCAKY 가져오기\r\n");
      out.write(" \t\tif(json.data.LOCAKY != \"\"){\r\n");
      out.write("\t\t\t$('#LOCATG_POP').val(json.data.LOCAKY);\r\n");
      out.write("\t\t\t//return;\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tvar locaky = gridList.getColData(\"gridList\", data[0].get(\"GRowNum\"), \"LOCAKY\");\r\n");
      out.write("\t\t\t$('#LOCATG_POP').val(locaky);\r\n");
      out.write("\t\t}\r\n");
      out.write(" \t\t\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t//팝업창 저장\r\n");
      out.write("\tfunction POP_saveData(){\r\n");
      out.write("\t\tif(gridList.validationCheck(\"LayerGridList\", \"all\")){\r\n");
      out.write("\r\n");
      out.write("\t\t    var param = new DataMap();\r\n");
      out.write("\t\t    var search = inputList.setRangeDataParam(\"searchArea\");\r\n");
      out.write("\t        var data = gridList.getGridData(\"LayerGridList\");\r\n");
      out.write("\t        \r\n");
      out.write("\t        \r\n");
      out.write("\t        var locatrg = $(\"#LOCATG_POP\").val();\r\n");
      out.write("\t        // 선택된 원 그리드\r\n");
      out.write("\t        var grid = gridList.getSelectData(\"gridList\");\r\n");
      out.write("/* \t\t\tif(data.length == 0){\r\n");
      out.write("\t\t\t\tcommonUtil.msgBox(\"SYSTEM_ROWSEMPTY\");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t} */\r\n");
      ...
      out.write("\t\t\t//유효성검사\r\n");
      out.write("\t\t\tfor(var i=0; i<data.length; i++){\r\n");
      out.write("\t\t\t\tvar gridMap = data[i].map;\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tif((Number)(gridList.getColData(\"LayerGridList\", data[i].get(\"GRowNum\"), \"QTYWRK\")) < 1){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"VALID_M0952\");\r\n");
      out.write("\t\t\t\t\tgridList.setColFocus(\"LayerGridList\", data[i].get(\"GRowNum\"), \"QTYWRK\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}else if((Number)(gridList.getColData(\"LayerGridList\", data[i].get(\"GRowNum\"), \"QTYWRK\")) > (Number)(grid[0].map.QTSIWH)){\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA01\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA01\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA02\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA02\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA03\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA03\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA04\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA04\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA05\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA05\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA06\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA06\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA07\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA07\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA08\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA08\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA09\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA09\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA10\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA10\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA12\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA12\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA14\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA14\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA15\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA15\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA16\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA16\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA17\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA17\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA18\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA18\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA19\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA19\"));\r\n");
      out.write("\t\t\t\tparam.put(\"LOTA20\", gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"LOTA20\"));\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(locatrg.trim() == \"\"){\r\n");
      out.write("\t\t\t\tcommonUtil.msgBox(\"VALID_M0404\");\r\n");
      out.write("\t\t\t\t$(\"#LOCATG_POP\").focus();\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//저장하시겠습니까?\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"LOCAKYPOP\", locatrg);\r\n");
      out.write("\t\t\tparam.put(\"JOBTYP\", \"310\");\r\n");
      out.write("\t\t\tparam.put(\"gridId\",\"LayerGridList\");\r\n");
      out.write("\t\t\tparam.put(\"grid\",grid);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/MobileInbound/json/saveMGR05_POP.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      ...
      out.write("\t\t\t\tgridList.resetGrid(\"LayerGridList\");\r\n");
      out.write("\t\t\t\t$(\"#BARCODE_POP\").val(\"\")\r\n");
      out.write("\t\t\t\t$(\"#LOCATG_POP\").val(\"\");\r\n");
      out.write("\t\t\t\t$(\"#WORKSUM4\").val(\"\");\r\n");
      out.write("\t\t\t\t$(\"#PLTQTY_POP\").val(\"\");\r\n");
      out.write("\t\t\t\t$(\"#BOXQTY_POP\").val(\"\");\r\n");
      out.write("\t\t\t\t$(\"#REMQTY_POP\").val(\"\");\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tLayerPopClose();\r\n");
      ...
      out.write("\t\t\tgridList.resetGrid(\"LayerGridList\");\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t}else if(gridId == \"LayerGridList\" && dataCount > 0){\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t\t$(\"#BARCODE_POP\").val(\"\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\tworksum1 = worksum1+(Number)(gridList.getColData(\"gridList\", list[i].get(\"GRowNum\"), \"QTYSTD\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//총 합계\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t//팝업창 합계 계산\r\n");
      out.write("\t\tvar pop_list2 = gridList.getGridData(\"LayerGridList\");\r\n");
      out.write("\t\tvar grid = gridList.getSelectData(\"gridList\");\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// 값이 없는 경우\r\n");
      out.write("\t\tif(grid == \"\"){\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar qtywrk = 0;\r\n");
      out.write("\t\tvar boxqty = 0;\r\n");
      out.write("\t\tvar remqty = 0;\r\n");
      out.write("\t\tvar pltqty = 0;\r\n");
      out.write(" \t\tvar bxiqty = gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"QTDUOM\"); // 박스 입수\r\n");
      out.write("\t\tvar ptystd = gridList.getColData(\"gridList\", grid[0].get(\"GRowNum\"), \"QTYSTD\"); // 팔레트 적재수량\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//총 작업 합계\r\n");
      out.write("\t\tfor(var i=0; i<pop_list2.length; i++){\r\n");
      out.write("\t\t\tvar gridMap = pop_list2[i].map;\r\n");
      out.write("// \t\t\tqtsiwh = qtsiwh+(Number)(gridList.getColData(\"LayerGridList\", pop_list2[i].get(\"GRowNum\"), \"QTSIWH\"));\r\n");
      out.write("// \t\t\tboxqty = boxqty+(Number)(gridList.getColData(\"LayerGridList\", pop_list2[i].get(\"GRowNum\"), \"BOXQTY\"));\r\n");
      out.write("// \t\t\tremqty = remqty+(Number)(gridList.getColData(\"LayerGridList\", pop_list2[i].get(\"GRowNum\"), \"REMQTY\"));\r\n");
      out.write("// \t\t\tqtywrk = gridList.getColData(\"LayerGridList\", pop_list2[i].get(\"GRowNum\"), \"QTYWRK\");\r\n");
      out.write("// \t\t\tpltqty = pltqty + parseInt((Number)(ptystd)/(Number)(qtywrk));\r\n");
      out.write("\t\t\tqtywrk = qtywrk+(Number)(gridList.getColData(\"LayerGridList\", pop_list2[i].get(\"GRowNum\"), \"QTYWRK\")); //작업수량 \r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tboxqty = parseInt((Number)(qtywrk)/(Number)(bxiqty));\r\n");
      out.write("\t\tremqty = (Number)(qtywrk)%(Number)(bxiqty);\r\n");
      out.write("\t\tif(remqty > 0){\r\n");
      out.write("\t\t\tboxqty++;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tpltqty = parseInt((Number)(qtywrk)/(Number)(ptystd));\r\n");
      out.write("\t\tvar pltqty_less = (Number)(qtywrk)%(Number)(ptystd);\r\n");
      out.write("\t\tif(pltqty_less > 0){\r\n");
      out.write("\t\t\tpltqty++;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("// \t\tgridList.getColData(\"LayerGridList\", pop_list2[i].get(\"GRowNum\"), \"QTYWRK\");\r\n");
      out.write("// \t\tpltqty = pltqty + parseInt((Number)(ptystd)/(Number)(qtywrk));\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#WORKSUM4\").val(qtywrk);\r\n");
      out.write("\t\t$(\"#PLTQTY_POP\").val(pltqty);\r\n");
      out.write("\t\t$(\"#BOXQTY_POP\").val(boxqty);\r\n");
      out.write("\t\t$(\"#REMQTY_POP\").val(remqty);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//그리드 컬럼 변경 이벤트            \r\n");
      out.write("\t// QTSIWH 재고수량 , QTYWRK 작업수량 , QTDUOM 입수, BOXQTY 박스수량, REMQTY 잔량\r\n");
      out.write("\tfunction gridListEventColValueChange(gridId, rowNum, colName, colValue){\r\n");
      out.write("\t\tif(colName == \"QTYWRK\"){ //수량변경시연결된 작업수량 변경 \r\n");
      out.write("\t\t\tvar boxqty = 0;\r\n");
      out.write("\t\t\tvar remqty = 0;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tvar bxiqty = Number(gridList.getColData(gridId, rowNum, \"QTDUOM\")); //입수\r\n");
      out.write("\t\t\tvar qtywrk = Number(gridList.getColData(gridId, rowNum, \"QTYWRK\")); //작업수량\r\n");
      out.write("\t\t\tboxqty = parseInt((Number)(qtywrk)/(Number)(bxiqty)); // 박스 = 작업수량 / 입수 \r\n");
      out.write("\t\t\tremqty = (Number)(qtywrk)%(Number)(bxiqty);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(remqty > 0){\r\n");
      out.write("\t\t\t\tboxqty++;\r\n");
      ...
      out.write("\t\t\t\t \t\r\n");
      out.write("\t\t//수량 CHECK\r\n");
      out.write("\t\t \tif(Number(colValue) > Number(gridList.getColData(gridId, rowNum, \"QTSIWH\"))){\r\n");
      out.write("\t\t\t \tcommonUtil.msgBox(\"VALID_M0923\");\r\n");
      out.write("\t\t\t\tgridList.setColValue(gridId, rowNum, \"QTYWRK\", 0);\r\n");
      out.write("\t\t\t\tgridList.setColFocus(gridId, rowNum, \"QTYWRK\");\r\n");
      out.write("\t\t \t}\r\n");
      out.write("\t\t \tcalTotal();\r\n");
      out.write("\t\t \t\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t//레이어 팝업 열기\r\n");
      out.write("\tfunction LayerPop() {\r\n");
      out.write("\t\tvar data = gridList.getSelectData(\"gridList\");\r\n");
      out.write("\t\tif(data.length == 0){\r\n");
      out.write("\t\t\tcommonUtil.msgBox(\"SYSTEM_ROWSEMPTY\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}else if(data.length == 1) {\r\n");
      out.write("\t\t\t//그리드에서 정보 가져오기\r\n");
      out.write("\t\t\tvar skukey = gridList.getColData(\"gridList\", data[0].get(\"GRowNum\"), \"SKUKEY\");\r\n");
      out.write("\t\t\tvar desc01 = gridList.getColData(\"gridList\", data[0].get(\"GRowNum\"), \"DESC01\");\r\n");
      out.write("\t\t\tvar qtsiwh = gridList.getColData(\"gridList\", data[0].get(\"GRowNum\"), \"QTSIWH\");\r\n");
      out.write("\t\t\tvar pltqty = gridList.getColData(\"gridList\", data[0].get(\"GRowNum\"), \"PLTQTY\");\r\n");
      out.write("\t\t\tvar boxqty = gridList.getColData(\"gridList\", data[0].get(\"GRowNum\"), \"BOXQTY\");\r\n");
      out.write("\t\t\tvar remqty = gridList.getColData(\"gridList\", data[0].get(\"GRowNum\"), \"REMQTY\");\r\n");
      out.write("\t\t\tvar trnuid = gridList.getColData(\"gridList\", data[0].get(\"GRowNum\"), \"TRNUID\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"#BARCODE_POP\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#SKUKEY_POP\").val(skukey);\r\n");
      out.write("\t\t\t$(\"#DESC01_POP\").val(desc01);\r\n");
      out.write("\t\t\t$(\"#QTSIWH_POP\").val(qtsiwh);\r\n");
      out.write("\t\t\t$(\"#PLTQTY_POP\").val(pltqty);\r\n");
      out.write("\t\t\t$(\"#BOXQTY_POP\").val(boxqty);\r\n");
      out.write("\t\t\t$(\"#REMQTY_POP\").val(remqty);\r\n");
      out.write("\t\t\t$(\"#LOCATG_POP\").val(\"RCVLOC\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\".layer_popup .label-btn\").show();\r\n");
      out.write("\t\t\t$(\".layer_popup\").animate({height:\"100%\"},500);\r\n");
      out.write("\r\n");
      out.write("\t\t\t$(\"#BARCODE_POP\").focus();\r\n");
      out.write("\t\t\t$(\"#BARCODE_POP\").select();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else if(data.length > 1){\r\n");
      out.write("\t\t\tcommonUtil.msgBox(\"* 1개의 데이터만 선택해주세요. *\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t//레이어 팝업 닫기\r\n");
      out.write("\tfunction LayerPopClose() {\r\n");
      out.write("\t\t$(\".layer_popup\").animate({height:\"0%\"},500,function(){$(\".layer_popup .label-btn\").hide()});\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>팔렛타이징</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_DOCKEY\">문서번호<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"RECVKY\" name=\"RECVKY\" class=\"input input-width\" validate=\"required(STD_DOCKEY)\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_PREQTY\" GCol=\"text,PREQTY\" </td>  <!-- 선입고  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"300 STD_DESC01\" GCol=\"text,DESC01\" </td>  <!-- 제품명 -->  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_QTSIWH\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  <!-- 재고수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40 STD_QTDUOM\" GCol=\"text,QTDUOM\" GF=\"N 13,1\"></td>  <!-- 입수 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"90 STD_QTYSTD\" GCol=\"text,QTYSTD\" GF=\"N 13,1\"></td>  <!-- 팔렛트 적재수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_PLTQTY\" GCol=\"text,PLTQTY\" GF=\"N 13,1\"></td>  <!-- 팔레트수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_BOXQTY\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!-- 박스수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40 STD_REMQTY\" GCol=\"text,REMQTY\" GF=\"N 13,1\"></td>  <!-- 잔량 -->                   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"100 STD_LOTA11\" GCol=\"text,LOTA11\" GF=\"D\"></td> <!-- 제조일자 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"100 STD_LOTA13\" GCol=\"text,LOTA13\" GF=\"D\"></td> <!-- 유통기한 -->\r\n");
      out.write("<!--  \t\t\t\t\t\t\t\t\t<td GH=\"80 STD_KEY\" GCol=\"text,KEY\" GF=\"S 20\"></td>  KEY  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<label id=\"threeP\" onClick=\"searchList()\">검색</label>\r\n");
      out.write("\t\t\t\t<label id=\"threeP\" onClick=\"window.location.reload()\">초기화</label>\r\n");
      out.write("\t\t\t\t<label id=\"threeP\" onClick=\"LayerPop()\">상세</label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div id=\"keyboardBtn\">키보드열기</div>\r\n");
      out.write("\t<!-- LayerPop popup -->\r\n");
      out.write("\t<div class=\"layer_popup\" id=\"LayerPop\" >\r\n");
      out.write("\t\t<div class=\"mobile_order\">\r\n");
      out.write("\t\t\t<div class=\"layer_title\"><span>상세</span></div>\r\n");
      out.write("\t\t\t<div class=\"mobile-data-top\">\r\n");
      out.write("\t\t\t\t<div class=\"mobile-data-box\">\r\n");
      out.write("\t\t\t\t\t<div class=\"content_layout_wrap\" id=\"searchArea\">\r\n");
      out.write("\t\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th CL=\"STD_BACODE\">바코드<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"BARCODE_POP\" name=\"BARCODE\" class=\"input input-width\" validate=\"required(STD_BACODE)\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th CL=\"STD_PLBXRQ\">팔렛/박스/잔량<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"PLTQTY_POP\" name=\"PLTQTY\" class=\"input input-width\" style=\"width:33.3333%;float:left;\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"BOXQTY_POP\" name=\"BOXQTY\" class=\"input input-width\" style=\"width:33.3333%;float:left;\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"REMQTY_POP\" name=\"REMQTY\" class=\"input input-width\" style=\"width:33.3333%;float:left;\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th CL=\"STD_QTSWRK\">재고/작업수량<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"QTSIWH_POP\" name=\"QTSIWH_POP\" class=\"input1 input-width\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"WORKSUM4\" name=\"WORKSUM4\" class=\"input1 input-width\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th CL=\"STD_TOLOC\">To지번<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"input1 btn_Search\" value=\"추천\" onClick=\"recommend()\" style=\"background-color:#fff;\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"LOCATG_POP\" name=\"LOCATG\" class=\"input1 input-width\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th CL=\"STD_SKUKEY\">제품코드<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"SKUKEY_POP\" name=\"SKUKEY\" class=\"input input-width\" readonly></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th CL=\"STD_DESC01\">제품명<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"DESC01_POP\" name=\"DESC01\" class=\"input input-width\" readonly></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"scroll\" style=\"width:100%;height: calc(100% - 30px);overflow:auto;white-space: nowrap;\">\r\n");
      out.write("\t\t\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tbody id=\"LayerGridList\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr CGRow=\"true\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"rownum\">1</td>     \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_PTBACODE\" GCol=\"text,TRNUID\" GF=\"S 20\"></td> <!-- PT바코드 -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t\t<td GH=\"50 STD_QTSIWH\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  재고수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_QTYWRK\" GCol=\"input,QTYWRK\" GF=\"N 13,1\"></td>  <!-- 작업수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40 STD_QTDUOM\" GCol=\"text,QTDUOM\" GF=\"N 13,1\"></td>  <!-- 입수 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_BOXQTY\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!-- 박스수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40 STD_REMQTY\" GCol=\"text,REMQTY\" GF=\"N 13,1\"></td>  <!-- 잔량 -->                  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"100 STD_LOTA11\" GCol=\"input,LOTA11\" GF=\"D\"></td> <!-- 제조일자 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"100 STD_LOTA13\" GCol=\"input,LOTA13\" GF=\"D\"></td> <!-- 유통기한 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<div class=\"label-btn\">\r\n");
      out.write("\t\t\t\t\t<!-- 버튼 1개 시에는 id=\"long\" 2개일떄는 half 3개일떄 threeP 4개일때 quarter -->\r\n");
      out.write("\t\t\t\t\t<label id=\"threeP\" onClick=\"POP_searchList()\">검색</label>\r\n");
      out.write("\t\t\t\t\t<label id=\"threeP\" onClick=\"POP_saveData()\">저장</label>\r\n");
      out.write("\t\t\t\t\t<label id=\"threeP\" onClick=\"LayerPopClose()\">닫기</label>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<!-- searchinput popup -->\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
