 ...
 * Generated at: 2021-07-01 00:39:41 UTC
...
public final class MGR06_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("var input = '';\r\n");
      out.write("var mode = '';\r\n");
      out.write("var recvkyList = new Array();\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#LOCATG\").keyup(function(e){if(e.keyCode == 13)$(\"#TRNUTG\").select();});\r\n");
      out.write("\t\t\r\n");
      out.write("// \t\t//검색값 클릭시 초기화\r\n");
      out.write("\t\t$(\"#RECVKY\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t//$(\"#LOCATG\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t$(\"#TRNUTG\").click(function(){$(this).select()}) \r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      ...
      out.write("\t\t\tvar data = gridList.getGridData(gridId);\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfor(var i=0; i<recvkyList.length; i++){\r\n");
      out.write("\t\t\t\tif(recvky == recvkyList[i]){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"이미 조회된 바코드입니다.\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\trecvkyList.push(recvky);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(gridList.getGridDataCount(gridId) == 0){\r\n");
      out.write("\t\t\t\tgridList.gridList({\r\n");
      out.write("\t\t\t\t\turl : \"/mobile/MobileInbound/json/displayMGR06.data\",\r\n");
      out.write("\t\t\t    \tid : gridId,\r\n");
      ...
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tfor(var i=0;i<json.data.length;i++){\r\n");
      out.write("\t\t\t\t\tvar keys = Object.keys(json.data[i]);\r\n");
      out.write("\t\t\t\t\tvar row = new DataMap();\r\n");
      out.write("\t\t\t\t\tfor(var j=0; j<keys.length; j++){\r\n");
      out.write("\t\t\t\t\t\trow.put(keys[j],json.data[i][keys[j]]);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tgridList.getGridBox(\"gridList\").addRow(row, false);\r\n");
      out.write("\t\t\t\t\t//gridList.addNewRow(\"gridList\", row);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\turl : \"/mobile/MobileInbound/json/saveMGR06.data\",\r\n");
      out.write("\t\t\tparam : param,\r\n");
      out.write("\t\t\tsuccessFunction : \"successSaveCallBack\"\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction movingCheck(){\r\n");
      out.write("\t\tif(gridList.validationCheck(\"gridList\", \"all\")){\r\n");
      out.write("\r\n");
      out.write("\t\t    param = new DataMap();\r\n");
      out.write("\t\t    data = gridList.getSelectData(\"gridList\");\r\n");
      ...
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}else if((Number)(gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"QTYWRK\")) > (Number)(gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"QTSIWH\"))){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"VALID_M0923\");\r\n");
      out.write("\t\t\t\t\tgridList.setColFocus(\"gridList\", data[i].get(\"GRowNum\"), \"QTYWRK\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}else if (gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"LOTA11\").trim() == \"\" || gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"LOTA11\").trim() == null){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"* 제조일자를 입력해주세요 *\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}else if (gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"LOTA13\").trim() == \"\" || gridList.getColData(\"gridList\", data[i].get(\"GRowNum\"), \"LOTA13\").trim() == null){\r\n");
      ...
      out.write("\t\t\tparam.put(\"TRNUID\",data[0].map.TRNUID);\r\n");
      out.write("\t\t\tparam.put(\"JOBTYP\", \"310\");\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/MobileInbound/json/movingCheck.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      out.write("\t\t\t\tsuccessFunction : \"successSaveCallBack\"\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\trecvkyList = new Array();\r\n");
      ...
      out.write("\t\t\t\t$(\"#RECVKY\").focus();\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}else if(json.data[\"RESULT\"] == \"moving_Sucess\"){\r\n");
      out.write("\t\t\t\tsaveData();\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t//$(\"#RECVKY\").val(GList[0].get(\"RECVKY\"));\r\n");
      out.write("\t\t\t//$(\"#LOCATG\").val(GList[0].get(\"LOCATG\")); \r\n");
      out.write("\t\t\t$(\"#RECVKY\").select();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\tif(gridId == \"gridList\" && isCheck){\r\n");
      out.write("\t\t\tcheck();\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t\t$(\"#RECVKY\").select();\r\n");
      out.write("\t\t\t//$(\"#LOCATG\").val(gridList.getColData(gridId, rowNum, \"LOCATG\"))\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t$(\"#RECVKY\").select();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tif(colName != \"LOTA11\" && colName != \"LOTA12\" && colName != \"LOTA13\" && colName != \"QTYWRK\"){\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t\t$(\"#LOCATG\").select();\r\n");
      out.write("\t\t\t//$(\"#LOCATG\").val(gridList.getColData(gridId, rowNum, \"LOCATG\"))\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write(" \t\t\t//commonUtil.msgBox(\"* 추천 로케이션이 없습니다. *\");\t2021/06/24 - 추천을 눌렀을때만 팝업창 나오게 요청 (인형교)\r\n");
      out.write(" \t\t\treturn;\r\n");
      out.write(" \t\t}else{\r\n");
      out.write(" \t\t\t$('#LOCATG').val(json.data.LOCAKY);\r\n");
      out.write(" \t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("</script>\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>적치</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_REASPT\">입고/ASN/PT<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"RECVKY\" name=\"RECVKY\" class=\"input input-width\"></td>\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"RECVKY\" name=\"RECVKY\" class=\"input input-width\" validate=\"required(STD_REASPT)\"></td> -->\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"button\" class=\"input1 btn_Search\" value=\"추천\" onClick=\"check()\" style=\"background-color:#fff;\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"LOCATG\" name=\"LOCATG\" class=\"input1 input-width\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_TOTRUNG\">To바코드<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"TRNUTG\" name=\"TRNUTG\" class=\"input input-width\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,DPUTZO\"></td>  <!-- 적치구역  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,SKUKEY\"></td>  <!-- 품목 -->\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"300\" GCol=\"text,DESC01\"></td>  <!-- 제품명 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!-- 박스수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"input,QTYWRK\" GF=\"N 13,1\" validate=\"required\"></td>  <!-- 작업수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  <!-- 재고수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- <td GH=\"80\" GCol=\"text,LOCATG\"></td>  --> <!--로케이션 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"100\" GCol=\"input,LOTA11\" GF=\"C\"></td> <!-- 제조일자 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"100\" GCol=\"input,LOTA13\" GF=\"C\"></td> <!-- 유통기한 -->\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<label id=\"threeP\" onClick=\"movingCheck()\">저장</label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
