 ...
 * Generated at: 2021-06-23 07:11:06 UTC
...
public final class MSD03_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>위치별 재고현황</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("<!-- \t\t\t\t\t\t\t<tr> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<th CL=\"STD_QTSDIF\">가용재고<span class=\"make\"></span></th> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"WORKSUM2\" name=\"WORKSUM2\" class=\"input input-width\" readonly/></td> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t</tr> -->\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_AVISTC\">가용재고<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"WORKSUM2\" name=\"WORKSUM2\" class=\"input input-width\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_STATIT\" GCol=\"text,LOTA06\" </td>  <!-- 상태 -->  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_QTYIN\" GCol=\"text,QTYIN\" GF=\"N 13,1\"></td>  <!-- 재고 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_QTAVAL\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  <!-- 가용 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40 STD_QTDUOM\" GCol=\"text,QTDUOM\" GF=\"N 13,1\"></td>  <!-- 입수 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_PLTQTY\" GCol=\"text,PLTQTY\" GF=\"N 13,1\"></td>  <!-- 팔렛트수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_BOXQTY\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!-- 박스수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_REMQTY\" GCol=\"text,REMQTY\" GF=\"N 13,1\"></td>  <!-- 잔량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80 STD_QTSALO\" GCol=\"text,QTSALO\" GF=\"N 13,1\"></td>  <!-- 할당 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_STSPMI\" GCol=\"text,STSPMI\" GF=\"N 13,1\"></td>  <!-- 입고중 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_STSPMO\" GCol=\"text,STSPMO\" GF=\"N 13,1\"></td>  <!-- 출고중 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60 STD_HOLD\" GCol=\"text,QTSBLK\" GF=\"N 13,1\"></td>  <!-- 보류 -->\r\n");
