 ...
 * Generated at: 2021-07-12 01:43:36 UTC
...
public final class MSD05_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\tvar desc01 = list[0].map.DESC01;\r\n");
      out.write("\t\t\tvar pltbox = list[0].map.PLTBOX;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 검색조건 품목명, 팔렛당박스 수 셋팅\r\n");
      out.write("\t\t\t$(\"#DESC01\").val(desc01);\r\n");
      out.write("\t\t\t$(\"#PLTBOX\").val(pltbox);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\tworksum2 = worksum2+(Number)(gridList.getColData(\"gridList\", list[i].get(\"GRowNum\"), \"QTYIN\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>품목별 재고현황</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"SKUKEY\" name=\"SKUKEY\" class=\"input input-width\" validate=\"required(STD_GOODS_CD)\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>품목명<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"DESC01\" name=\"DESC01\" class=\"input input-width\" readonly=\"readonly\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>팔렛당박스 수<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"PLTBOX\" name=\"PLTBOX\" class=\"input input-width\" readonly=\"readonly\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("<!-- \t\t\t\t\t\t\t<tr> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<th>피킹지번<span class=\"make\"></span></th> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"PLOCAKY\" name=\"PLOCAKY\" class=\"input input-width\" readonly=\"readonly\" ></td> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t</tr> -->\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>가용재고<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"WORKSUM2\" name=\"WORKSUM2\" class=\"input input-width\" readonly=\"readonly\" ></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"90\" GCol=\"text,LOCAKY\" GF=\"S 20\"></td>  <!-- 지번-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"90\" GCol=\"text,LOTA13\" GF=\"C\"></td>  <!--유통기한-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"text,LOTA06\"></td>  <!--상태-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,QTYIN\" GF=\"N 13,1\"></td>  <!--재고-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  <!--가용-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,PLTQTY\" GF=\"N 13,1\"></td>  <!--팔렛-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!--박스-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,REMQTY\" GF=\"N 13,1\"></td>  <!--잔량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,QTSALO\" GF=\"N 13,1\"></td>  <!--할당-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,STSPMI\" GF=\"N 13,1\"></td>  <!--입고중-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,STSPMO\" GF=\"N 13,1\"></td>  <!--출고중-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"60\" GCol=\"text,QTSBLK\" GF=\"N 13,1\"></td>  <!--보류-->\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("<!-- \t\t\t\t\t\t\t\t<div class=\"workBox\">가용재고<input type=\"text\" id=\"WORKSUM2\" name=\"WORKSUM2\"></div> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t</li> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t</ul> -->\r\n");
      out.write("<!-- \t\t\t\t\t</div> -->\r\n");
      out.write("<!-- \t\t\t\t</div> -->\r\n");
