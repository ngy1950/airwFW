 ...
 * Generated at: 2021-07-09 02:44:36 UTC
...
public final class MSD06_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\tcommand : \"MSD06\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t    });\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#PHYIKY\").keyup(function(e){if(e.keyCode == 13)searchList();});\r\n");
      out.write("\t\t$(\"#BARCODE\").keyup(function(e){if(e.keyCode == 13)barcodeChk();});\r\n");
      out.write("\t\t$(\"#PHYIKY\").focus();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//검색값 클릭시 초기화\r\n");
      out.write("\t\t$(\"#PHYIKY\").click(function(){$(this).select()}); \r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"TRNUTG\", $(\"#BARCODE\").val());\r\n");
      out.write("\t\t\tparam.put(\"JOBTYP\", \"520\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/mobileInventory/json/saveMSD06.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      ...
      out.write("        \r\n");
      out.write("\t\tvar qtsiwh = gridList.getColData(\"gridList\", rowNum, \"QTSIWH\");\r\n");
      out.write("     \tvar qtypda = gridList.getColData(\"gridList\", rowNum, \"QTYPDA\");\r\n");
      out.write("     \t \r\n");
      out.write("\t\tif((Number)(qtsiwh) - (Number)(qtypda) == 0){\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//바코드 검색시 체크박스\r\n");
      out.write("\tfunction barcodeChk(){\r\n");
      out.write("\t\tvar grid = gridList.getGridData(\"gridList\");\r\n");
      ...
      out.write("\t\t\tvar gridMap = grid[i].map;\r\n");
      out.write("\t\t\tvar gtincd = (gridList.getColData(\"gridList\", grid[i].get(\"GRowNum\"), \"GTINCD\"))\r\n");
      out.write("\t\t\tvar eancod = (gridList.getColData(\"gridList\", grid[i].get(\"GRowNum\"), \"EANCOD\"))\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif($(\"#BARCODE\").val() == gtincd || $(\"#BARCODE\").val() == eancod){\r\n");
      out.write("\t\t\t\tif(gridList.getGridBox(\"gridList\").selectRow.get(i) == 'true'){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"* 이미 실사하였습니다. *\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\tgridList.setRowCheck(\"gridList\", grid[i].get(\"GRowNum\"), true);\r\n");
      out.write("\t\t\t\t\tgridList.setColFocus(\"gridList\", grid[i].get(\"GRowNum\"));\r\n");
      out.write("\t\t\t\t\tcount++;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\tcommonUtil.msgBox(\"* 바코드 재고가 없습니다. *\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//합계 계산\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>오프라인재고실사</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>실사번호<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"PHYIKY\" name=\"PHYIKY\" class=\"input input-width\" validate=\"required(STD_RELNUM)\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>바코드<span class=\"make\"></span></th>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,LOCAKY\" GF=\"S 20\"></td>  <!--로케이션-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"300\" GCol=\"text,DESC01\"></td>  \t\t\t<!--제품명 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td><!--재고-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"text,QTYWRK\" GF=\"N 13,1\"></td><!--작업-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"text,QTYPDA\" GF=\"N 13,1\"></td><!-- PDA실사수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"text,QTDUOM\" GF=\"N 13,1\"></td> <!--입수-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td> <!--박스-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"text,REMQTY\" GF=\"N 13,1\"></td>  <!--잔량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,SKUKEY\"></td>  \t\t\t<!--제품코드 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"100\" GCol=\"text,OLDSKU\"></td>  \t\t\t<!--품목-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,TRNUID\"></td>  \t\t\t<!--바코드 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"160\" GCol=\"text,KEY\" GF=\"S 20\"></td>    <!--KEY-->\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<!-- <label id=\"threeP\" onClick=\"\">다운로드</label> -->\r\n");
      out.write("\t\t\t\t<!-- <label id=\"threeP\" onClick=\"LayerPopClose()\">닫기</label> -->\r\n");
      out.write("\t\t\t\t<!-- <label id=\"threeP\" onClick=\"\">전송</label> -->\r\n");
