 ...
 * Generated at: 2021-06-23 07:07:22 UTC
...
public final class MTO03_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t\tcommand : \"MTO03\",\r\n");
      out.write("\t\t\tgridMobileType : true\r\n");
      out.write("\t    });\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#PACKID\").keyup(function(e){if(e.keyCode == 13)searchList();});\r\n");
      out.write("\t\t$(\"#PACKID\").focus();\r\n");
      out.write("\t\t\r\n");
      out.write("// \t\t//검색값 클릭시 초기화\r\n");
      out.write("\t\t$(\"#PACKID\").click(function(){$(this).select()});\r\n");
      out.write("\t\t$(\"#BOX\").click(function(){$(this).select()}); \r\n");
      out.write("\t\t$(\"#REQ\").click(function(){$(this).select()}); \r\n");
      out.write("\t\t$(\"#LOCATG\").click(function(){$(this).select()});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      out.write("\t\t$('input').attr(\"inputmode\",\"none\");\r\n");
      out.write("\t\tinput = \"#PACKID\";\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t$(\"#LOTA11\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#LOTA13\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#LOCATG\").val(\"SETLOC\");\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\t$(\"#LOCATG\").focus();\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// #QTY 총 갯수 (작업수량)0을 입력할수 없습니다.\r\n");
      out.write("\t\t\tif(qtyTotal.trim() == 0){\r\n");
      out.write("\t\t\t\tcommonUtil.msgBox(\"작업수량에 0을 입력할 수 없습니다.\");\r\n");
      out.write("\t\t\t\t$(\"#LOCATG\").focus();\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("      \t\t\r\n");
      ...
      out.write("\t\t\t$(\"#LOTA11\").val(dateParser(GList[0].get(\"LOTA11\"),'SD'));\r\n");
      out.write("\t\t\t$(\"#LOTA13\").val(dateParser(GList[0].get(\"LOTA13\"),'SD'));\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t} \r\n");
      out.write("\t\r\n");
      out.write("\t// 박스 입력 , 총 QTY 박스 BOX 낱 REQ\r\n");
      out.write("\tfunction boxTotal(){\r\n");
      out.write("\t\t//실행할 내용\r\n");
      out.write("\t\tvar item = gridList.getSelectData(\"gridList\");\r\n");
      out.write("\t\tvar box = $(\"#BOX\").val();\r\n");
      out.write("\t\tvar req = $(\"#REQ\").val();\r\n");
      out.write("\t\tvar qty = 0;\r\n");
      out.write("\t\tvar pakqtd =0;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar uomqty = 0; //단위수량\r\n");
      out.write("\t\tvar useqty = 0; //가용수량\r\n");
      out.write("\t\tvar lakqty = 0; //부족수량  = 가용수량  - 단위수량 * 총  \r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfor(var i=0; i<item.length; i++){\r\n");
      out.write("\t\t\tvar gridMap = item[i].map;\r\n");
      out.write("\t\t\tpakqtd = (Number)(gridList.getColData(\"gridList\", item[i].get(\"GRowNum\"), \"PAKQTD\"));\r\n");
      out.write("\t\t\tqty = ((Number)(box)*(Number)(pakqtd))+(Number)(req); \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tuomqty = (Number)(gridList.getColData(\"gridList\", item[i].get(\"GRowNum\"), \"UOMQTY\"));\r\n");
      out.write("\t\t\tuseqty = (Number)(gridList.getColData(\"gridList\", item[i].get(\"GRowNum\"), \"USEQTY\"));\r\n");
      out.write("\t\t\tlakqty = (Number)(useqty) - ((Number)(uomqty)*(Number)(qty));\r\n");
      out.write("\t\t\tif(lakqty > 0 ){ //부족수량이 0보다 크면 0으로 \r\n");
      out.write("\t\t\t\tlakqty = 0;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tgridList.setColValue(\"gridList\", item[i].get(\"GRowNum\"), \"LAKQTY\", lakqty );\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\tvar uomqty = 0; //단위수량\r\n");
      out.write("\t\tvar useqty = 0; //가용수량\r\n");
      out.write("\t\tvar lakqty = 0; //부족수량\r\n");
      out.write("\t\tvar total = 0;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfor(var i=0; i<item.length; i++){\r\n");
      out.write("\t\t\tvar gridMap = item[i].map;\r\n");
      out.write("\t\t\tpakqtd = (Number)(gridList.getColData(\"gridList\", item[i].get(\"GRowNum\"), \"PAKQTD\"));\r\n");
      out.write("\t\t\tqty = ((Number)(box)*(Number)(pakqtd)); \r\n");
      out.write("\t\t\ttotal = (Number)(qty)+(Number)(req);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tuomqty = (Number)(gridList.getColData(\"gridList\", item[i].get(\"GRowNum\"), \"UOMQTY\"));\r\n");
      out.write("\t\t\tuseqty = (Number)(gridList.getColData(\"gridList\", item[i].get(\"GRowNum\"), \"USEQTY\"));\r\n");
      out.write("\t\t\tlakqty = (Number)(useqty) - ((Number)(uomqty)*(Number)(total));\r\n");
      out.write("\t\t\tif(lakqty > 0 ){\r\n");
      out.write("\t\t\t\tlakqty = 0;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tgridList.setColValue(\"gridList\", item[i].get(\"GRowNum\"), \"LAKQTY\", lakqty );\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>세트조립</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_SET_CD\">세트코드<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"PACKID\" name=\"PACKID\" class=\"input input-width\" validate=\"required(STD_SET_CD)\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_SETNAME\">세트품명<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"DESC01\" name=\"DESC01\" class=\"input input-width\" readonly/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_LOTA1113\">제조/유통<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"LOTA11\" name=\"LOTA11\" UIFormat=\"C\" class=\"input1 input-width\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"LOTA13\" name=\"LOTA13\" UIFormat=\"C\" class=\"input1 input-width\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_QTBREQ\">총/박/낱<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"QTY\" name=\"QTY\" class=\"input input-width\"style=\"width:33.3333%;float:left;\" readonly/> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"BOX\" name=\"BOX\" onchange=\"boxTotal()\" class=\"input input-width\" style=\"width:33.3333%;float:left;\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"REQ\" name=\"REQ\" onchange=\"reqTotal()\"class=\"input input-width\" style=\"width:33.3333%;float:left;\"/>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,BARCOD\"></td> <!--바코드   -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"300\" GCol=\"text,DESC01\" GF=\"S 20\"></td>  <!--제품명-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,UOMQTY\" GF=\"N 13,1\"></td>  <!--단위수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  <!--재고수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,USEQTY\" GF=\"N 13,1\"></td>  <!--가용수량--> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"50\" GCol=\"text,LAKQTY\" GF=\"S 20\"></td>  <!-- 부족 -->\r\n");
      ...
      out.write("\t\t\t\t<label id=\"threeP\" onClick=\"saveData()\">저장</label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
