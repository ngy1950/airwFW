 ...
 * Generated at: 2021-06-23 07:09:32 UTC
...
public final class MTO04_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String warekynm = (String)request.getSession().getAttribute(CommonConfig.SES_USER_WHAREHOUSE_NM_KEY);
      ...
      out.write("\t\t//팝업창 거래처명 검색\r\n");
      out.write("\t\t$(\"#PACKID\").keyup(function(e){if(e.keyCode == 13)pop_searchList();});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#BARCODE\").click(function(){$(this).select()}); \r\n");
      out.write("\t\t$(\"#PACKID\").click(function(){$(this).select()}); \r\n");
      out.write("\t\t$(\"#BARCODE\").click(function(){$(this).select()});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//가상키보드 제어\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"BARCODE\",$(\"#BARCODE\").val());\r\n");
      out.write("\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"PACKID\",$(\"#PACKID\").val());\r\n");
      out.write("\t\t\tparam.put(\"STOKKY\",$(\"#STOKKY\").val());\r\n");
      out.write("\r\n");
      out.write("\t\t\tgridList.gridList({\r\n");
      out.write("\t\t    \tid : \"LayerGridList\",\r\n");
      out.write("\t\t    \tparam : param\r\n");
      ...
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t\tvar GList = gridList.getGridBox('gridList').getDataAll();\r\n");
      out.write("\t\t\t//$(\"#BARCODE\").val(GList[0].get(\"BARCODE\"));\r\n");
      out.write("\t\t//팝업레이어\r\n");
      out.write("\t\t}else if(gridId == \"LayerGridList\" && dataCount > 0){\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t\tvar GList = gridList.getGridBox('LayerGridList').getDataAll();\r\n");
      out.write("\t\t\t$(\"#PACKID\").val(GList[0].get(\"PACKID\"));\r\n");
      out.write("\t\t\t$(\"#DESC01\").val(GList[0].get(\"PACKNM\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//체크박스 이벤트 후 \r\n");
      out.write("\tfunction gridListEventRowCheck(gridId, rowNum, isCheck){\t\r\n");
      out.write("\t\tif(gridId == \"gridList\" && isCheck == true){\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t}else if(gridId == \"LayerGridList\"){\r\n");
      out.write("\t\t\tcalTotal();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("    \r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t//팝업창 합계 계산\r\n");
      out.write("\t\tvar worksum3 = 0;\r\n");
      out.write("\t\tvar worksum4 = 0;\r\n");
      out.write("\t\tvar pop_list = gridList.getSelectData(\"LayerGridList\");\r\n");
      out.write("\t\tvar pop_list2 = gridList.getGridData(\"LayerGridList\");\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//선택 합계\r\n");
      out.write("\t\tfor(var i=0; i<pop_list.length; i++){\r\n");
      out.write("\t\t\tvar gridMap = pop_list[i].map;\r\n");
      out.write("\t\t\tworksum3 = worksum3+(Number)(gridList.getColData(\"LayerGridList\", pop_list[i].get(\"GRowNum\"), \"QTYWRK\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//총 합계\r\n");
      out.write("\t\tfor(var i=0; i<pop_list2.length; i++){\r\n");
      out.write("\t\t\tvar gridMap = pop_list2[i].map;\r\n");
      out.write("\t\t\tworksum4 = worksum4+(Number)(gridList.getColData(\"LayerGridList\", pop_list2[i].get(\"GRowNum\"), \"QTSIWH\"));\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t$(\"#WORKSUM3\").val(worksum3);\r\n");
      out.write("\t\t$(\"#WORKSUM4\").val(worksum4);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//레이어 팝업 열기\r\n");
      out.write("\tfunction LayerPop() {\r\n");
      out.write("\t\tvar hrowNum = gridList.getFocusRowNum(\"gridList\");\r\n");
      out.write("\t\tvar skukey = gridList.getColData(\"gridList\", hrowNum, \"SKUKEY\");\r\n");
      out.write("\t\tvar stokky = gridList.getColData(\"gridList\", hrowNum, \"STOKKY\");\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#PACKID\").val(skukey);\r\n");
      out.write("\t\t$(\"#STOKKY\").val(stokky);\r\n");
      out.write("\t\t$(\".layer_popup .label-btn\").show();\r\n");
      out.write("\t\t$(\".layer_popup\").animate({height:\"100%\"},400);\r\n");
      out.write("\t\tpop_searchList();\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//레이어 팝업 닫기\r\n");
      out.write("\tfunction LayerPopClose() {\t\t\r\n");
      out.write("\t\t$(\".layer_popup\").animate({height:\"0%\"},200,function(){$(\".layer_popup .label-btn\").hide()});\r\n");
      out.write("\t} \r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t        var data = gridList.getSelectData(\"LayerGridList\");\r\n");
      out.write("\t       \r\n");
      out.write("\t        var locatrg = $(\"#LOCATG\").val();\r\n");
      out.write("\t        var qtyTotal = $(\"#QTY\").val();\r\n");
      out.write("\t        var qtyTotal2 = $(\"#QTY\").val();\r\n");
      out.write("\t        var packid = $(\"#PACKID\").val();\r\n");
      out.write(" \t       \t\r\n");
      out.write("\t        //세트해체 화면에서 stokky 가져오기\r\n");
      out.write("\t\t\tvar hrowNum = gridList.getFocusRowNum(\"gridList\");\r\n");
      out.write("\t\t\tvar stokky = gridList.getColData(\"gridList\", hrowNum, \"STOKKY\");\r\n");
      out.write("\t\t\t$(\"#STOKKY\").val(stokky);\r\n");
      out.write("\t        \r\n");
      ...
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"* 작업수량이 0 입니다 *\");\r\n");
      out.write("\t\t\t\t\tgridList.setColFocus(\"LayerGridList\", data[i].get(\"GRowNum\"), \"QTYWRK\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t// 재고수량QTSIWH이 총수량 QTY보다 많으면 안됨\r\n");
      out.write("\t\t\t\t}else if( qtyTotal.trim()  <  (Number)(gridList.getColData(\"LayerGridList\", data[i].get(\"GRowNum\"), \"QTSIWH\")) ){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\" 재고수량이 총수량을 넘을 수 없습니다. \");\r\n");
      out.write("\t\t\t\t\t//gridList.setColFocus(\"LayerGridList\", data[i].get(\"GRowNum\"), \"QTYWRK\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t}else if (gridList.getColData(\"LayerGridList\", data[i].get(\"GRowNum\"), \"LOTA11\").trim() == \"\" || gridList.getColData(\"LayerGridList\", data[i].get(\"GRowNum\"), \"LOTA11\").trim() == null){\r\n");
      out.write("\t\t\t\t\tcommonUtil.msgBox(\"* 제조일자를 입력해주세요 *\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}else if (gridList.getColData(\"LayerGridList\", data[i].get(\"GRowNum\"), \"LOTA13\").trim() == \"\" || gridList.getColData(\"LayerGridList\", data[i].get(\"GRowNum\"), \"LOTA13\").trim() == null){\r\n");
      ...
      out.print(wareky);
      out.write("\");\r\n");
      out.write("\t\t\tparam.put(\"LOCATG\", locatrg);\r\n");
      out.write("\t\t\tparam.put(\"JOBTYP\", \"402\");\r\n");
      out.write("\t\t\tparam.put(\"PACKID\", packid);\r\n");
      out.write("\t\t\tparam.put(\"INOQTY\", qtyTotal);\r\n");
      out.write("\t\t\tparam.put(\"TRNQTY\", qtyTotal2);\r\n");
      out.write("\t\t\tparam.put(\"STOKKY\", stokky);\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tnetUtil.send({\r\n");
      out.write("\t\t\t\turl : \"/mobile/mobileOutbound/json/MTO04POP.data\",\r\n");
      out.write("\t\t\t\tparam : param,\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//onclick 박스 입력 , 총 QTY 박스 BOX 낱 REQ  세트해체  \r\n");
      out.write("\tfunction boxTotal(){\r\n");
      out.write("\t\t//실행할 내용\r\n");
      out.write("\t\tvar item = gridList.getGridData(\"LayerGridList\");\r\n");
      out.write("\t\tvar box = $(\"#BOX\").val();\r\n");
      out.write("\t\tvar req = $(\"#REQ\").val();\r\n");
      out.write("\t\tvar qty = 0; // 총수량 = 입수 * 박스 \r\n");
      out.write("\t\tvar qtduom = 0; // 검색조건 입수\r\n");
      out.write("\t\tvar qtduom2 = 0; //그리드 입수 \r\n");
      out.write("\t\tvar remqty = 0; //잔량 \r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar uomqty = 0; //단위수량\r\n");
      out.write("\t\tvar qtywrk = 0; //작업수량\r\n");
      out.write("\t\tvar boxqty = 0; //박스수량\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfor(var i=0; i<item.length; i++){\r\n");
      out.write("\t\t\tvar gridMap = item[i].map;\r\n");
      out.write("\t\t\tqtduom = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"QTDUOM\"));\r\n");
      out.write("\t\t\t//총 = 박스 * 입수 + 낱개\r\n");
      out.write("\t\t\tqty = ((Number)(box)*(Number)(qtduom))+(Number)(req); \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 작업수량 / 입수 = 박스수량     QTYWRK 작업수량   QTDUOM 입수    BOXQTY 박스수량\r\n");
      out.write("\t\t\tuomqty = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"UOMQTY\"));\r\n");
      out.write("\t\t\tqtywrk = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"QTYWRK\"));\r\n");
      out.write("\t\t\tboxqty = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"BOXQTY\"));\r\n");
      out.write("\t\t\tuomqty = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"UOMQTY\"));\r\n");
      out.write("\t\t\tqtduom2 = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"QTDUOM2\")); \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 작업수량  = 총수량 * 단위수량 \r\n");
      out.write("\t\t\tqtywrk = ((Number)(uomqty)*(Number)(qty)); \r\n");
      out.write("\t\t\tgridList.setColValue(\"LayerGridList\", item[i].get(\"GRowNum\"), \"QTYWRK\", qtywrk ); //작업수량 \r\n");
      out.write("\t\t\t// 박스수량  = 작업수량  / 입수 \r\n");
      out.write("\t\t\tboxqty = floatingFloor((Number)(qtywrk)/(Number)(qtduom2), 0);\r\n");
      out.write("\t\t\tgridList.setColValue(\"LayerGridList\", item[i].get(\"GRowNum\"), \"BOXQTY\", boxqty ); //박스수량 \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 잔량 \r\n");
      out.write("\t\t\tremqty = (Number)(qtywrk)%(Number)(qtduom2);\r\n");
      out.write("\t\t\tgridList.setColValue(\"LayerGridList\", item[i].get(\"GRowNum\"), \"REMQTY\", remqty ); //잔량\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\tvar gridMap = item[i].map;\r\n");
      out.write("\t\t\tqtduom = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"QTDUOM\"));\r\n");
      out.write("\t\t\tqty = ((Number)(box)*(Number)(qtduom)); \r\n");
      out.write("\t\t\ttotal = (Number)(qty)+(Number)(req);\r\n");
      out.write("\t\t\t\r\n");
      out.write(" \t\t\t// 작업수량 / 입수 = 박스수량     QTYWRK 작업수량   QTDUOM 입수    BOXQTY 박스수량\r\n");
      out.write("\t\t\tuomqty = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"UOMQTY\"));\r\n");
      out.write("\t\t\tqtywrk = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"QTYWRK\"));\r\n");
      ...
      out.write("\t\t\tqtduom2 = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"QTDUOM2\")); \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tremqty = (Number)(gridList.getColData(\"LayerGridList\", item[i].get(\"GRowNum\"), \"REMQTY\"));\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 작업수량  = 총수량 * 단위수량 \r\n");
      out.write("\t\t\tqtywrk = ((Number)(uomqty)*(Number)(total)); \r\n");
      out.write("\t\t\tgridList.setColValue(\"LayerGridList\", item[i].get(\"GRowNum\"), \"QTYWRK\", qtywrk ); //작업수량 \r\n");
      out.write("\t\t\t// 박스수량  = 작업수량  / 그리드 입수 \r\n");
      out.write("\t\t\tboxqty = floatingFloor((Number)(qtywrk)/(Number)(qtduom2), 0);\r\n");
      out.write("\t\t\tgridList.setColValue(\"LayerGridList\", item[i].get(\"GRowNum\"), \"BOXQTY\", boxqty ); //박스수량 \r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 잔량 \r\n");
      ...
      out.write("    ");
      out.write("\r\n");
      out.write("\t\t<div class=\"m_menutitle\"><span>세트해체</span></div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"BARCODE\" name=\"BARCODE\" class=\"input input-width\" validate=\"required(STD_BACODE)\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_WRKSUM\">선택/총작업<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"WORKSUM1\" name=\"WORKSUM1\" class=\"input1 input-width\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"WORKSUM2\" name=\"WORKSUM2\" class=\"input1 input-width\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,SKUKEY\" GF=\"S 20\"></td>  <!--품목-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"300\" GCol=\"text,DESC01\" GF=\"S 20\"></td>  <!--제품명-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,TRNUID\"></td>  <!--팔렛트ID --> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  <!-- 재고수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTYWRK\" GF=\"N 13,1\"></td>  <!-- 작업수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTDUOM\" GF=\"N 13,1\"></td>  <!-- 입수 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!-- 박스수량 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,REMQTY\" GF=\"N 13,1\"></td>  <!-- 잔량 -->                   \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"text,LOTA13\" GF=\"C\"></td> <!-- 유통기한 -->\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("<!-- \t\t\t\t<div class=\"moblie-data-infobox\"> -->\r\n");
      out.write("<!-- \t\t\t\t\t<div class= detail-info> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t<ul> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t<li class=\"left\"> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<div class=\"workBox\">작업<input type=\"text\" id=\"WORKSUM1\" name=\"WORKSUM1\">/<input type=\"text\" id=\"WORKSUM2\" name=\"WORKSUM2\"></div> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t</li> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t</ul> -->\r\n");
      out.write("<!-- \t\t\t\t\t</div> -->\r\n");
      out.write("<!-- \t\t\t\t</div> -->\r\n");
      ...
      out.write("\t\t\t\t<label id=\"threeP\" onClick=\"LayerPop()\">해체</label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t<div class=\"mobile_order\">\r\n");
      out.write("\t\t\t<div class=\"layer_title\"><span>세트해체  팝업</span></div>\r\n");
      out.write("\t\t\t<div class=\"mobile-data-top\">\r\n");
      out.write("\t\t\t\t<div class=\"mobile-data-box\">\r\n");
      out.write("\t\t\t\t\t<div class=\"content_layout_wrap\" id=\"searchArea\">\r\n");
      out.write("\t\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>세트코드<span class=\"make\">*</span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"PACKID\" name=\"PACKID\" class=\"input input-width\" value=\"\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>세트품명<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><input type=\"text\" id=\"DESC01\" name=\"DESC01\" class=\"input input-width\" value=\"\" readonly/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>제조/유통<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"LOTA11\" name=\"LOTA11\" UIFormat=\"C\" class=\"input1 input-width\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"LOTA13\" name=\"LOTA13\" UIFormat=\"C\" class=\"input1 input-width\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>총/박/낱<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"QTY\" name=\"QTY\" class=\"input2 input-width\" readonly/> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"BOX\" name=\"BOX\" onchange=\"boxTotal()\" class=\"input2 input-width\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"REQ\" name=\"REQ\" onchange=\"reqTotal()\" class=\"input2 input-width\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"BIN\" name=\"BIN\" class=\"input2 input-width\" readonly/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th CL=\"STD_WRKSUM\">선택/총작업<span class=\"make\"></span></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"WORKSUM3\" name=\"WORKSUM3\" class=\"input1 input-width\" readonly/>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"LOCATG\" name=\"LOCATG\" class=\"input input-width\" value=\"SETLOC\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"rownum\">1</td>                           \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"rowCheck\"></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"80\" GCol=\"text,SKUKEY\" GF=\"S 20\"></td>  <!--제품코드 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"300\" GCol=\"text,DESC01\" GF=\"S 20\"></td>  <!--제품명 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,UOMQTY\" GF=\"N 13,1\"></td>  <!--단위수량  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTYWRK\" GF=\"N 13,1\"></td>  <!--작업수량-->  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTDUOM2\" GF=\"N 13,1\"></td>  <!--입수 --> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,QTSIWH\" GF=\"N 13,1\"></td>  <!-- 가용수량, 재고수량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,BOXQTY\" GF=\"N 13,1\"></td>  <!--박스수량 --> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"40\" GCol=\"text,REMQTY\" GF=\"N 13,1\"></td>  <!--잔량-->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"input,LOTA11\" GF=\"C\"></td> <!-- 제조일자 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td GH=\"70\" GCol=\"input,LOTA13\" GF=\"C\"></td> <!-- 유통기한 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("<!-- \t\t\t\t\t\t\t<ul> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<li class=\"left\"> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t<div class=\"workBox\">작업<input type=\"text\" id=\"WORKSUM3\" name=\"WORKSUM3\" readonly>/<input type=\"text\" id=\"WORKSUM4\" name=\"WORKSUM4\" readonly></div> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t</li> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t<li> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t\t<div>To바코드<input type=\"text\" id=\"LOCATG\" name=\"LOCATG\" value=\"SETLOC\"></div> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t\t</li> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t\t</ul> -->\r\n");
      out.write("<!-- \t\t\t\t\t\t</div> -->\r\n");
      out.write("<!-- \t\t\t\t\t</div> -->\r\n");
