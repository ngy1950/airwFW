...
<script type="text/javascript">
	$(document).ready(function(){
		gridList.setGrid({
	    	id : "gridHeadList",
	    	module : "Master",
	    	pkcol : "KEY,OWNRKY,WAREKY,CARNUM,REGNKY",
			command : "TC06_HEAD",
...
// 			tempKey : "KEY"
		...
		gridList.setReadOnly("gridItemList", true, ["REGNKY"]);
	...
	function gridListEventItemGridSearch(gridId, rowNum, itemGridList){
		if(gridId == "gridHeadList"){
			...
			netUtil.send({
				url : "/master/json/displayTC06_ITEM.data",
				param : param,
				sendType : "list",
...
// 			var head = gridList.getSelectData("gridHeadList");
			...
			gridList.setRowReadOnly("gridItemList",rowNum, false, ["REGNKY"]);
		...
		if(gridList.validationCheck("gridHeadList", "select")){
			...
			for(var i=0;i < list.length;i++){
				...
				if(listMap.GRowState != "D"){
					if(listMap.REGNKY == null || listMap.REGNKY == ''){
						commonUtil.msgBox("COMMON_M0009",["권역코드"]);
						return;
					}
				}
			}
...
// 				param.put("tempItem",tempItem);
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "TC06");
		}else if(btnName == "Getvariant"){
		sajoUtil.openGetVariantPop("searchArea", "TC06");
		}
	}
		...
		<div class="content_serch" id="searchArea">
			...
			<div class="search_inner" id="searchArea">
				<div class="search_wrap ">
					...
					<dl>
						<dt CL="STD_REGNKY"></dt> <!-- 권역코드 -->
						<dd>
							<input type="text" class="input" name="CS.REGNKY" UIInput="SR,SHSHPMA"/>
						</dd>
					</dl>
				</div>
				<div class="btn_tab">
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									<tr CGRow="true">
									    ...
									    <td GH="75 STD_REGCNT" GCol="text,CNT" GF="S 20"></td><!----> 
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
									    ...
									    <td GH="80 STD_REGNKY" GCol="input,REGNKY,SHSHPMA" GF="S 30">권역코드</td><!--권역코드--> 
