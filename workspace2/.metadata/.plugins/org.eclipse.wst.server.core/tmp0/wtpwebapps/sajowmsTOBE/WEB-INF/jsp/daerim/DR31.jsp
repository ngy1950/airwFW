...
<script type="text/javascript">
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "DR31");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DR31");
		}
	}
	...
	function saveData(){
		...
		param.put("head",head);
	 	...
	 	netUtil.send({
			url : "/daerimOutbound/json/saveDR31.data",
			param : param,
			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>  <!--출고일자-->  
						<dt CL="IFT_ORDDAT"></dt> 
						<dd> 
							<input type="text" class="input" name="IT.ORDDAT" UIInput="B" UIFormat="C"/> 
						</dd> 
					</dl> 
					<dl>  <!--출고요청일-->  
						<dt CL="IFT_OTRQDT"></dt> 
								...
								<table class="table_c">
									<tbody id="gridItemList">
										<tr CGRow="true">
				    						...
				    						<td GH="80 IFT_ORDDAT" GCol="text,ORDDAT" GF="D 6">출고일자</td>	<!--출고일자-->
