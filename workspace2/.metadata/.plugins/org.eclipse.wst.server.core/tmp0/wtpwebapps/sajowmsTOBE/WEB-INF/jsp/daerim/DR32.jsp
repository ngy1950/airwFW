...
<script type="text/javascript">
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "DR32");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DR32");
		}
	}
	...
	function saveData(){
		...
		param.put("item",item);
	 	...
	 	netUtil.send({
			url : "/daerimOutbound/json/saveDR32.data",
			param : param,
			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>  <!--영업 -->
						<dt CL="STD_GROUP"></dt>
						<dd style="width:50px">
							<input type="radio" class="input" name="GRPRL1" checked /> 
						</dd>
					</dl>
					<dl>  <!--출고일자-->  
						<dt CL="IFT_ORDDAT"></dt> 
								...
								<table class="table_c">
									<tbody id="gridHeadList">
										<tr CGRow="true">
				    						...
				    						<td GH="100 STD_PTNG08" GCol="select,PTNG08">	<!--마감구분-->
												<select class="input" commonCombo="PTNG08"></select> 
											</td>
				    						<td GH="70 STD_PTNRCNT" GCol="text,SUMQTY" GF="N 10,0">거래처수</td>	<!--거래처수-->
				    						<td GH="70 STD_SHIPED" GCol="text,ALLOCCNT" GF="N 10,0">출고완료</td>	<!--출고완료-->
...
<!-- 							<button type='button' GBtn="excelUpload"></button> -->
				...
				<div class="content_layout tabs content_right" style="width : calc(100% - 430px);">
					<ul class="tab tab_style02">
						<li><a href="#tab2-1" onclick="moveTab($(this));"><span id="atab2-1">상세내역</span></a></li>
								...
								<table class="table_c">
									<tbody id="gridItemList">
										<tr CGRow="true">
				    						...
				    						<td GH="80 STD_ORDDAT" GCol="text,DOCDAT" GF="D 6">출고일자</td>	<!--출고일자-->
								...
								<table class="table_c">
									<tbody id="gridItemList2">
										<tr CGRow="true">
				    						...
				    						<td GH="100 STD_PTNG08" GCol="text,PTNG08" GF="S 20">마감구분</td>	<!--마감구분-->
