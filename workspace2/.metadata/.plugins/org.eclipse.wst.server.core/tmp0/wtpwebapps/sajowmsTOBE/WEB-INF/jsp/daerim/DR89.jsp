...
var count = 0;
	$(document).ready(function(){
		gridList.setGrid({
			...
			colorType : true,
		    menuId : "DR03",
		    scrollSnycChildId : "gridHeadList1-1"
	    });
	 	gridList.setGrid({
	    	id : "gridHeadList2",
	    	module : "Daerim",
		...
		gridList.setGrid({
			...
			colorType : true,
		    menuId : "DR03",
		    scrollSnycChildId : "gridHeadList"
	    });
	 	gridList.setGrid({
	    	id : "gridHeadList2-2",
	    	module : "Daerim",
	...
	function display1(bindId){
		...
		if(validate.check("searchArea")){
			...
			netUtil.send({
				...
				sendType : "list",
				bindType : "grid",  //bindType grid 고정
				bindId : "gridHeadList1-1" //그리드ID
			});
		}
	}
	function display2(bindId){
		...
		if(validate.check("searchArea")){
			...
			netUtil.send({
				...
				sendType : "list",
				bindType : "grid",  //bindType grid 고정
				bindId : "gridHeadList2-2" //그리드ID
			});

		}
	}
	function display3(bindId){
		...
		if(validate.check("searchArea")){
			...
			netUtil.send({
				...
				sendType : "list",
				bindType : "grid",  //bindType grid 고정
				bindId : bindId,  //bindType grid 고정
	...
	function gridListEventRowDblclick(gridId, rowNum, colName, colValue){
		...
		}else if(gridId == "gridHeadList1-1"){
			skukey = gridList.getColData("gridHeadList1-1", rowNum, "SKUKEY2");
			c00102 = gridList.getColData("gridHeadList1-1", rowNum, "CDESC1");
		}else if(gridId == "gridHeadList2-2"){
			skukey = gridList.getColData("gridHeadList2-2", rowNum, "SKUKEY2");
			c00102 = gridList.getColData("gridHeadList2-2", rowNum, "CDESC1");
		}
		else if(gridId == "gridHeadList3-3"){
			skukey = gridList.getColData("gridHeadList3-3", rowNum, "SKUKEY2");
			c00102 = gridList.getColData("gridHeadList3-3", rowNum, "CDESC1");
		}
    ...
    function moveTab(obj){
    	if(obj.attr('href') == '#tab1-1'){
    		...
    		display2("gridHeadList2");
    	}else if(obj.attr('href') == '#tab1-3'){
    		$("#atab2-3").trigger("click");
    		display3("gridHeadList3");
    	}/* else if(obj.attr('href') == '#tab2-1'){
    		$("#atab1-1").trigger("click");
    		display("gridHeadList1-1");
    	}else if(obj.attr('href') == '#tab2-2'){
    		$("#atab1-2").trigger("click");
    		display2("gridHeadList2-2");
    	}else if(obj.attr('href') == '#tab2-3'){
    		$("#atab1-3").trigger("click");
    		display3("gridHeadList3-3");
    	} */
	}
			...
			<div class="content_layout tabs top_layout" style="height: calc(100% - 240px);">
				<div class="content_layout tabs content_left" style="width: 500px;  ">
					<ul class="tab tab_style02">
						...
						<li><a href="#tab1-2" onclick="moveTab($(this));"><span>본주문/추가주문</span></a></li>
						<li><a href="#tab1-3" onclick="moveTab($(this));"><span>특정거래선</span></a></li>
						 <li>
						</li>
...
<!-- 			          <li><a href="#tab1-1" ><span>일반</span></a></li> -->
						<li><a href="#tab2-1" id="atab2-1" style="display:none;"><span>전체</span></a></li>
						<li><a href="#tab2-2" id="atab2-2"  style="display:none;"><span>본주문/추가주문</span></a></li>
						<li><a href="#tab2-3" id="atab2-3"  style="display:none;"><span>특정거래선</span></a></li>
						 <li>            
						</li>
			        </ul>
			...
			<div class="content_layout tabs bottom_layout" style="height: 220px;">
				<ul class="tab tab_style02">
					<li><a href="#tab3-1"><span>상세내역</span></a></li>
					<li class="btn_zoom_wrap">
						<ul>
							<li><button class="btn btn_bigger"><span>확대</span></button></li>
						</ul>
