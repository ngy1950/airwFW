...
<script type="text/javascript">
	...
	function gridListEventRowUp(gridId, rowNum, rowViewNum){
		commonUtil.debugMsg("gridListEventRowUp : ", arguments);
	}
	function gridListEventRowDown(gridId, rowNum, rowViewNum){
		commonUtil.debugMsg("gridListEventRowDown : ", arguments);
	}
</script>
</head>
<body>
