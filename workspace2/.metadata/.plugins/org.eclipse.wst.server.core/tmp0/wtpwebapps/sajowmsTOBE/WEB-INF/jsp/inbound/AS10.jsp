...
<script type="text/javascript">
	$(document).ready(function(){
		...
		gridList.setReadOnly("gridList",true,["DNAME1","LOTA05","LOTA06"])
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			searchList();
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "AS10");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "AS10");
			...
			var rowlist = gridList.getSelectRowNumList("gridList");
...
<div class="content_wrap">
	<div class="content_inner" style="padding: 5px 30px 55px;">
		...
		<div class="content_serch" id="searchArea">
			...
			<div class="search_inner"> <!-- AS10  입고예정 정보 조회 --> 
							...
							<table class="table_c">
								<tbody id="gridList">
									<tr CGRow="true"> 
										...
										<td GH=80 GCol="text,ASNTTY" GF="S 4">ASN 타입</td> <!--ASN 타입-->
										...
										<td GH="80 STD_ISSHIP"  GCol="select,DNAME1"> <!--출고여부-->
											<select class="input" CommonCombo="OUTBYN">
											</select>
										</td>
										<td GH="100 STD_WADAT" GCol="text,USRID2" GF="D 8">출고일자</td> <!--출고일자-->
										<!--<td GH="50 STD_CRETIM2" GCol="text,UNAME2" GF="T 6"></td> --><!-- CRETIM2 컬럼명에 없음 -->
										...
										<td GH="100 STD_PRCPTD" GCol="text,PRCPTD" GF="D 8">입고계획일자</td> <!--입고계획일자-->
										<td GH="80 STD_ASNDKY" GCol="text,ASNDKY" GF="S 10">ASN 문서번호</td> <!--ASN 문서번호-->
										<td GH="80 STD_ASNDIT" GCol="text,ASNDIT" GF="S 6">ASN It.</td> <!--ASN It.-->
										...
										<td GH="80 STD_POIQTY" GCol="text,POIQTY" GF="N 17,0">P/O수량</td> <!--P/O수량-->
										<td GH="80 STD_QTYASN" GCol="text,QTYASN" GF="N 17,0">ASN수량</td> <!--ASN수량-->
										<td GH="50 STD_LOTA11" GCol="text,LOTA11" GF="D 14">제조일자</td> <!--제조일자-->
										<td GH="50 STD_LOTA13" GCol="text,LOTA13" GF="D 14">유통기한</td> <!--유통기한-->
