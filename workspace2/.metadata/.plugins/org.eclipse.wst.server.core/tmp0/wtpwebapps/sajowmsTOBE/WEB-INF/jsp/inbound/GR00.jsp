	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			saveData();
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "GR00");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "GR00");
		}
	}
			...
			<div class="search_inner" id="searchArea">
				<div class="search_wrap ">
					...
					<dl>  <!--ASN 문서번호-->  
						<dt CL="STD_ASNDKY"></dt> 
						<dd> 
							<input type="text" class="input" name="AH.ASNDKY" id="AH.ASNDKY" UIInput="SR,SHASN"/> 
						</dd> 
					</dl> 
					 <%if("2100".equals(ownrky) || "2500".equals(ownrky)){ // 2019-02-28 사통합 수정 %>
					<dl>  <!--ASN 생성일-->  
						<dt CL="STD_ASNDAT"></dt> 
						<dd> 
					...
					<dl>  <!--납품요청일-->  
						<dt CL="STD_EINDT"></dt> 
						<dd> 
							<input type="text" class="input" name=AH.PRCPTD UIInput="B" UIFormat="C N"/> 
						</dd> 
					</dl>
					<% }%>
...
<!-- 										<td GH="40 STD_CHECKED" GCol="rowCheck,radio"></td> -->
			    						...
			    						<td GH="100 구매요청일" GCol="text,ARCPTD" GF="D 8">구매요청일</td>	<!--구매요청일-->
			    						<td GH="100 센터입고시간" GCol="text,DEPTID2" GF="T 6">센터입고시간</td>	<!--센터입고시간-->
			    						<td GH="100 STD_ASNDKY" GCol="text,ASNDKY" GF="S 10">ASN 문서번호</td>	<!--ASN 문서번호-->
			    						<td GH="100 STD_AUSRID1" GCol="text,USRID1" GF="S 20">차량기사명</td>	<!--차량기사명-->
			    						<td GH="100 STD_AUNAME1" GCol="text,UNAME1" GF="S 20">기사전화번호</td>	<!--기사전화번호-->
			    						<td GH="100 STD_ADEPTID1" GCol="text,DEPTID1" GF="S 20">차량번호</td>	<!--차량번호-->
			    						<td GH="100 STD_ADNAME1" GCol="text,DNAME1" GF="S 20">출고여부</td>	<!--출고여부-->
			    						<td GH="100 센터입고일자" GCol="text,USRID2" GF="D 8">센터입고일자</td>	<!--센터입고일자-->
			    						<td GH="100 STD_AUNAME2" GCol="text,UNAME2" GF="T 6">출발시간</td>	<!--출발시간-->
			    						<td GH="100 STD_ADNAME2" GCol="text,DNAME2" GF="S 20">업무 부서명</td>	<!--업무 부서명-->
			    						<td GH="100 STD_AUSRID3" GCol="input,USRID3" GF="S 20">현장담당자</td>	<!--현장담당자-->
			    						<td GH="100 STD_AUNAME3" GCol="text,UNAME3" GF="S 20">현장담당자명</td>	<!--현장담당자명-->
			    						<td GH="100 STD_ADEPTID3" GCol="text,DEPTID3" GF="S 20">현장담당 부서</td>	<!--현장담당 부서-->
			    						<td GH="100 STD_ADNAME3" GCol="text,DNAME3" GF="S 20">현장담당 부서명</td>	<!--현장담당 부서명-->
			    						<td GH="100 STD_AUSRID4" GCol="input,USRID4" GF="S 20">현장책임</td>	<!--현장책임-->
			    						<td GH="100 STD_AUNAME4" GCol="text,UNAME4" GF="S 20">현장책임명</td>	<!--현장책임명-->
			    						<td GH="100 STD_ADEPTID4" GCol="text,DEPTID4" GF="S 20">선입고정보</td>	<!--선입고정보-->
			    						<td GH="100 STD_ADNAME4" GCol="text,DNAME4" GF="S 20">현장책임 부서명</td>	<!--현장책임 부서명-->
			    						<td GH="100 STD_DOCTXT" GCol="input,DOCTXT" GF="S 100">비고</td>	<!--비고-->
			    						<td GH="100 STD_WAREKYNM" GCol="text,WAREKYNM" GF="S 100">거점명</td>	<!--거점명-->
			    						<td GH="100 STD_RCPTTYNM" GCol="text,RCPTTYNM" GF="S 100">입고유형명</td>	<!--입고유형명-->
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
										...
										<td GH="100 STD_EINDT" GCol="text,LRCPTD" GF="D 8">납품요청일</td>	<!--납품요청일-->
										<td GH="100 STD_SKUKEY" GCol="text,SKUKEY" GF="S 20">제품코드</td>	<!--제품코드-->
										<td GH="100 STD_DESC01" GCol="text,DESC01" GF="S 120">제품명</td>	<!--제품명-->
										<td GH="100 STD_UOMKEY" GCol="text,UOMKEY" GF="S 10">단위</td>	<!--단위-->
<!-- 										<td GH="100 STD_LOCAKY" GCol="input,LOCAKY" GF="S 20">로케이션</td>	로케이션 -->
										<td GH="100 STD_LOCAKY" GCol="input,LOCAKY,SHLOCMA" validate="required">로케이션</td>	<!--로케이션-->
										<td GH="100 STD_TRNUID" GCol="input,TRNUID" GF="S 30">팔렛트ID</td>	<!--팔렛트ID-->
										<td GH="100 STD_QTYASN" GCol="text,QTYASN" GF="N 17,0">지시수량</td>
										<td GH="100 STD_QTYRCV" GCol="input,QTYRCV" GF="N 17,0" >입고수량</td>	<!--입고수량-->
										<td GH="100 STD_PLIQTY" GCol="text,PLTQTYCAL" GF="S 17" style="text-align:right;" >팔렛당수량</td>	<!--팔렛당수량-->
										<td GH="100 STD_PLTQTY" GCol="text,PLTQTY" GF="N 17,2">팔레트수량</td>	<!--팔레트수량-->
										<td GH="100 STD_BXIQTY" GCol="text,BXIQTY" GF="S 17" style="text-align:right;" >박스입수</td>	<!--박스입수-->
										<td GH="100 STD_BOXQTY" GCol="input,BOXQTY" GF="N 17,1">박스수량</td>	<!--박스수량-->
										<td GH="100 STD_REMQTY" GCol="input,REMQTY" GF="N 17,0">잔량</td>	<!--잔량-->
										...
										<td GH="100 STD_OUTDMT" GCol="text,OUTDMT" GF="N 20,0">유통기한(일수)</td>	<!--유통기한(일수)-->
										<td GH="100 STD_DTREMDAT" GCol="text,DTREMDAT" GF="N 20,0">유통잔여(DAY)</td>	<!--유통잔여(DAY)-->
										<td GH="100 STD_DTREMRAT" GCol="text,DTREMRAT" GF="N 20,0">유통잔여(%)</td>	<!--유통잔여(%)-->
										<td GH="100 STD_SBKTXT" GCol="input,SBKTXT" GF="S 100">비고</td>	<!--비고-->
										...
										<td GH="100 STD_REFCAT" GCol="text,REFCAT" GF="S 4">입출고 구분자</td>	<!--입출고 구분자-->
										<td GH="100 STD_REFDAT" GCol="text,REFDAT" GF="D 8">참조문서일자</td>	<!--참조문서일자-->
										...
										<td GH="100 STD_SKUG05" GCol="text,SKUG05" GF="S 50">제품용도</td>	<!--제품용도-->
										<td GH="100 STD_GRSWGT" GCol="text,GRSWGT" GF="N 17,0">포장중량</td>	<!--포장중량-->
										<td GH="100 STD_NETWGT" GCol="text,NETWGT" GF="N 17,0">순중량</td>	<!--순중량-->
										<td GH="100 STD_WGTUNT" GCol="text,WGTUNT" GF="S 3">중량단위</td>	<!--중량단위-->
										<td GH="100 STD_LENGTH" GCol="text,LENGTH" GF="N 17,0">포장가로</td>	<!--포장가로-->
										<td GH="100 STD_WIDTHW" GCol="text,WIDTHW" GF="N 17,0">포장세로</td>	<!--포장세로-->
										<td GH="100 STD_HEIGHT" GCol="text,HEIGHT" GF="N 17,0">포장높이</td>	<!--포장높이-->
										<td GH="100 STD_CUBICM" GCol="text,CUBICM" GF="N 17,0">CBM</td>	<!--CBM-->
										<td GH="100 STD_SEBELN" GCol="text,SEBELN" GF="S 20">구매오더 No</td>	<!--구매오더 No-->
										<td GH="100 STD_SEBELP" GCol="text,SEBELP" GF="S 6">구매오더 Item</td>	<!--구매오더 Item-->
<!-- 										<td GH="100 STD_CREDAT" GCol="text,CREDAT" GF="D 8">생성일자</td>	생성일자 -->
<!-- 										<td GH="100 STD_CRETIM" GCol="text,CRETIM" GF="T 6">생성시간</td>	생성시간 -->
<!-- 										<td GH="100 STD_CREUSR" GCol="text,CREUSR" GF="S 20">생성자</td>	생성자 -->
<!-- 										<td GH="100 STD_CUSRNM" GCol="text,CUSRNM" GF="S 50">생성자명</td>	생성자명 -->
										<td GH="100 STD_PBOXQTY" GCol="text,PBOXQTY" GF="N 17,1">P박스수량</td>	<!--P박스수량-->
<!-- 										<td GH="100 STD_MAXQTY" GCol="text,MAXQTY" GF="N 17,0">최대수량</td>	최대수량 -->
<!-- 										<td GH="100 STD_MAXRAT" GCol="text,MAXRAT" GF="N 17,0">초과허용치(%)</td>	초과허용치(%)								 -->
									</tr>
								</tbody>
							</table>
						</div>
