...
var rangeparam,cmd = "",afsaveSearch = false;
	$(document).ready(function(){
		...
		$("tbody tr").click(function(){
			if($(this).hadClass("focusRow") == true){
				if($(this).chlidren("td .input") == true){
					$(this).chlidren("td").css('background-color','#fff !important')
				}
			}
		});
...
/* 	function successReturn(gridId, rowNum, itemGridList){
		if(gridId == "gridHeadList"){
			...
			netUtil.send({
				url : "/SajoInbound/json/returnGR30Item.data",
				param : param,
				sendType : "list",
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "GR30");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "GR30");
		}
	}
