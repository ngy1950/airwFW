...
var reparam = new DataMap();
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "IP07");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "IP07");
		}
	}
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true"> 
										...
										<td GH="160 STD_LOCAKY" GCol="input,LOCAKY,SHLOCMA" GF="S 20" validate="required">로케이션</td>	<!--로케이션-->
										...
										<td GH="50 STD_DESC02" GCol="text,DESC02" GF="S 60">규격</td>	<!--규격-->
			    						...
			    						<td GH="112 STD_LOTA13" GCol="input,LOTA13" GF="D 14">유통기한</td>	<!--유통기한-->
			    						<td GH="112 STD_OUTDMT" GCol="text,OUTDMT" GF="S 10"></td>	<!--유통기한 일수-->
			    						...
			    						<td GH="160 STD_LOTA03" GCol="input,LOTA03" GF="S 20">벤더</td>	<!--벤더-->
			    						...
			    						<td GH="50 STD_QTYBIZ" GCol="text,QTYBIZ" GF="N 20,0">실물재고</td>	<!--실물재고-->
