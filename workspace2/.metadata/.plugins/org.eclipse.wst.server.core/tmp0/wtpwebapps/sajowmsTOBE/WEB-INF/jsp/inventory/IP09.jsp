...
<script type="text/javascript">
   ...
   function gridListEventItemGridSearch(gridId, rowNum, itemGridList){
      if(gridId == "gridHeadList"){
         var param = inputList.setRangeDataParam("searchArea"); 
         param.put("PHYIKY",gridList.getRowData(gridId, rowNum).map.PHYIKY);
         gridList.gridList({
             id : "gridItemList",
             param : param
          });
   ...
   function commonBtnClick(btnName){
      if(btnName == "Search"){
         ...
         sajoUtil.openSaveVariantPop("searchArea", "IP09");
      }else if(btnName == "Getvariant"){
         sajoUtil.openGetVariantPop("searchArea", "IP09");
      }
   }
                        ...
                        <tbody id="gridHeadList">
                           <tr CGRow="true">
                              <td GH="40 STD_NUMBER"           GCol="rownum">1</td>   
                               ...
                               <td GH="130 STD_PHSCTY" GCol="select,PHSCTY">   <!--조사타입-->
                                  <select class="input" Combo="SajoCommon,DOCUTY_COMCOMBO">
                                    <option></option>
                                 </select>
                              </td>   
                               <td GH="100 STD_ADJUTYNM" GCol="text,DOCCATNM" GF="S 4">유형명</td>   <!--유형명-->
                               ...
                               <td GH="100 STD_TRNDAT" GCol="text,TRNDAT" GF="D 10">전송일자</td>   <!--전송일자-->
                               <td GH="100 STD_TRNTIM" GCol="text,TRNTIM" GF="T 10">전송시간</td>   <!--전송시간-->
                           </tr>
                        </tbody>
                     </table>
                  </div>
...
<!--                                <td GH="40 STD_PQTY01" GCol="input,PQTY01" GF="N 4,0">스택패턴 1</td>   스택패턴 1
                               ...
                               <td GH="100 STD_SUBSIT" GCol="text,SUBSIT" GF="S 6">다음 Item번호</td>   <!--다음 Item번호-->
                               <td GH="100 STD_SUBSFL" GCol="text,SUBSFL" GF="S 1">서브Item플래그</td>   <!--서브Item플래그-->
                               ...
                               <td GH="90 STD_SAPSTS" GCol="text,SAPSTS" GF="S 4">상단시스템 Mvt</td>   <!--상단시스템 Mvt-->
                               <td GH="90 STD_QTYSTL" GCol="text,QTYSTL" GF="N 20,0">전산재고</td>   <!--전산재고-->
                               ...
                               <td GH="90 STD_QTSALO" GCol="text,QTSALO" GF="N 20,0">할당수량</td>   <!--할당수량-->
                               <td GH="50 STD_QTSPMI" GCol="text,QTSPMI" GF="N 20,0">입고중</td>   <!--입고중-->
                               <td GH="50 STD_QTSPMO" GCol="text,QTSPMO" GF="N 20,0">이동중</td>   <!--이동중-->
                               <td GH="90 STD_QTSBLK" GCol="text,QTBLKD" GF="N 20,0">보류수량</td>   <!--보류수량-->
                           </tr>
                        </tbody>
                     </table>
                  </div>
