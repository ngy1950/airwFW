	...
	function searchList(){
 	...
 	function saveData(){
		if(gridList.validationCheck("gridList", "all")){
			...
			param.put("TRNUTG", trnutg);
			param.put("JOBTYP", "380C");
			param.put("JOBTYPDOC", "380");
			
			netUtil.send({
				url : "/mobile/mobileOutbound/json/saveMTO05.data",
				param : param,
...
<body>
	...
	<div class="mobile_order">
		...
		<div class="m_menutitle"><span>기타출고</span></div>
					...
					<table>
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" id="LOCATG"  name="LOCATG" class="input input-width" value = "RCVLOC">
								</td>
							</tr>
							<tr>
						...
						<table>
							<tbody id="gridList">
								<tr CGRow="true">
									...
									<td GH="100 STD_LOCAKEY" GCol="text,LOCAKY" GF="S 20"></td>  <!--지번-->
									<td GH="300 STD_DESC01" GCol="text,DESC01" GF="S 20"></td>  <!--제품명-->
									<td GH="100 STD_BARCOD" GCol="text,TRNUID" GF="S 20"></td>  <!--1D09999-->
									...
									<td GH="120 STD_KEY" GCol="text,KEY" GF="S 20"></td>  <!--KEY-->
									<td GH="80 STD_SKUKEY" GCol="text,SKUKEY" GF="S 20"></td>  <!--품목-->
								</tr>
							</tbody>
						</table>
					</div>
