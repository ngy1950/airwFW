...
var mode = '';
	$(document).ready(function(){
		...
		$("#TRNUTG").keyup(function(e){if(e.keyCode == 13)searchList();});
		$("#TASKKY").focus();
	...
	function searchList(){
 	...
 	function saveData(){
		if(gridList.validationCheck("gridList", "all")){
			...
			param.put("JOBTYP", "300");
			
			netUtil.send({
				url : "/mobile/mobileOutbound/json/saveMTO11.data",
				param : param,
...
<body>
	...
	<div class="mobile_order">
		...
		<div class="m_menutitle"><span>작업오더완료</span></div>
					...
					<table>
						<tbody>
							<tr>
								...
								<td><input type="text" id="TASKKY" name="TASKKY" class="input input-width" ></td> <!-- validate="required(STD_DOC_NO)" -->
							</tr>
							<tr>
								<th>To바코드<span class="make">*</span></th>
								<td><input type="text" id="TRNUTG" name="TRNUTG" class="input input-width" ></td>
							</tr>
							<tr>
						...
						<table>
							<tbody id="gridList">
								<tr CGRow="true">
									...
									<td GH="100" GCol="text,LOCASR"></td>  <!--로케이션-->
									...
									<td GH="100" GCol="text,TRNUTG"></td>  <!--To 팔렛트 ID-->
