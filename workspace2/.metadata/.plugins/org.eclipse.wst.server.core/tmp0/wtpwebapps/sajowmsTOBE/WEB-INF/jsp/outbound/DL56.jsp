...
<script type="text/javascript">
	...
	function commonBtnClick(btnName){
		if(btnName == "Create"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "DL56");
		}else if(btnName == "Getvariant"){
		sajoUtil.openGetVariantPop("searchArea", "DL56");
		}
	}
	...
	<div class="content_inner">
		...
		<div class="content_serch" id="searchArea">
			<div class="btn_wrap">
				...
				<div class="fl_r">
					<input type="button" CB="Create SEARCH STD_CREATE" />
							...
							<table class="table_c">
								<tbody id="gridList">
									<tr CGRow="true">
    									...
    									<td GH="100 택배송장번호" GCol="input,SHPOKY" GF="S 40">택배송장번호</td>	<!--택배송장번호-->
									</tr>
								</tbody>
							</table>
						</div>
