...
<script type="text/javascript">
		...
		if(validate.check("searchArea")){
			...
			switch (selectIdx){
				...
				case 4:
					...
					break;
				case 5:
					selectGrid = "gridList6";
					break;
				case 6:
					selectGrid = "gridList7";
					break;
				case 7:
					selectGrid = "gridList8";
					break;
			}
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			searchList();
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "RL02");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "RL02");
 		}
	}
	...
	function searchHelpEventOpenBefore(searchCode, multyType, $inputObj, rowNum){
        ...
        }else if(searchCode == "SHDOCTM" && $inputObj.name == "SH.SHPMTY"){
			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>  <!--배송일자-->  
						<dt CL="STD_CARDAT"></dt> 
						<dd> 
							<input type="text" class="input" name="SD.CARDAT" UIInput="B" UIFormat="C N"/> 
						</dd> 
					</dl> 
					<dl>  <!--문서일자-->  
						<dt CL="STD_DOCDAT"></dt> 
        ...
        <div class="search_next_wrap">
			<div class="content_layout tabs">
				<ul class="tab tab_style02" id="tabs">
					...
					<li><a href="#tab1-6"><span>주문부서별</span></a></li>
					<li><a href="#tab1-7"><span>주문부서/문서별</span></a></li>
					<li><a href="#tab1-8"><span>주문부서/문서/제품별</span></a></li>
							...
							<table class="table_c">
								<tbody id="gridList1">
									<tr CGRow="true">                         
			    						...
			    						<td GH="80 STD_TOTBOX" GCol="text,TOTBOX" GF="N 20,2">총박스</td>	<!--총박스-->
			    						<td GH="80 STD_TOTWGT" GCol="text,TOTWGT" GF="N 20,2">총중량(KG)</td>	<!--총중량(KG)-->
									</tr>	
								</tbody>
							</table>
						</div>
							...
							<table class="table_c">
								<tbody id="gridList4">
									<tr CGRow="true">                         
			    						<td GH="40 STD_NUMBER"           GCol="rownum">1</td>   
			    						<td GH="120 STD_WAREKY" GCol="text,WAREKY" GF="S 10">거점</td>	<!--거점-->
			    						<td GH="120 STD_DOCUTY" GCol="text,DOCUTY" GF="S 10">출고유형</td>	<!--출고유형-->
			    						<td GH="80 STD_QTSHPD" GCol="text,QTSHPD" GF="N 20,0">출고수량</td>	<!--출고수량-->
			    						<td GH="80 STD_TOTBOX" GCol="text,TOTBOX" GF="N 20,2">총박스</td>	<!--총박스-->
			    						<td GH="80 STD_TOTWGT" GCol="text,TOTWGT" GF="N 20,2">총중량(KG)</td>	<!--총중량(KG)-->
									</tr>	
				...
				<div class="table_box section" id="tab1-8">
					<div class="table_list01">
						<div class="scroll">
							<table class="table_c">
								<tbody id="gridList8">
