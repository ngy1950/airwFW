	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_COMPNAME"></th>
						<td>
							<input type="text" name="COMPNAME" IAname="COMPNAME"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,COMPLABEL"></td>
												<td GH="140" GCol="input,COMPNAME"></td>
												<td GH="140" GCol="input,SORTORDER"></td>
												<td GH="140" GCol="input,AUTOSORT"></td>
												<td GH="140" GCol="input,PCOMID"></td>
