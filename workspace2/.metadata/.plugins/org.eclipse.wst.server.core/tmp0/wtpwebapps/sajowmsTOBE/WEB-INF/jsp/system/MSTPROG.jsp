	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_MSTPROG"></th>
						<td>
							<input type="text" name="MSTPROG" IAname="MSTPROG"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,PROGLABEL"></td>
												<td GH="140" GCol="input,PROGNAME"></td>
												<td GH="140" GCol="input,PROGTYPE"></td>
												<td GH="140" GCol="input,PAUTHTYPE"></td>
