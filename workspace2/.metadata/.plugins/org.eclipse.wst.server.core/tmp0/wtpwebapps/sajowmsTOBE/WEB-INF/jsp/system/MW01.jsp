			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>
						<dt CL="STD_WAREKY"></dt>
						<dd>
							<input type="text" class="input" name="WAREKY"  UIFormat="U"/>
						</dd>
					</dl>
				</div>
				<div class="btn_tab">
								...
								<table class="table_c">
									<tbody id="gridList">
										<tr CGRow="true">
											...
											<td GH="100 STD_WAREKY"   GCol="add,WAREKY" GF="U 10"></td>
											<td GH="100 STD_WAREKYNM" GCol="input,NAME01" GF="S 180"></td>
											<td GH="100 STD_POSTCD"   GCol="input,POSTCD" GF="S 30"></td>
											<td GH="100 STD_FAXTL1"   GCol="input,FAXTL1" GF="S 20"></td>
                                            <td GH="150 STD_ADDR01"   GCol="input,ADDR01" GF="S 180"></td>
                                            <td GH="100 STD_TELN01"   GCol="input,TELN01" GF="S 20"></td>
										</tr>
									</tbody>
								</table>
							</div>
