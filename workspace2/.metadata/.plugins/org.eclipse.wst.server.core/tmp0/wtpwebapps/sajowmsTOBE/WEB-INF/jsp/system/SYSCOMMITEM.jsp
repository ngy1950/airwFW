	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_CODENAME"></th>
						<td>
							<input type="text" name="CODENAME" IAname="CODENAME"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,COMMONID"></td>
												<td GH="140" GCol="input,CITEMID"></td>
												<td GH="140" GCol="input,CODELABEL"></td>
												<td GH="140" GCol="input,CODENAME"></td>
