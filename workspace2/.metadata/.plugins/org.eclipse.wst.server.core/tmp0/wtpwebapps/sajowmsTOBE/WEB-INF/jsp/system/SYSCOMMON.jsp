	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_COMMNAME"></th>
						<td>
							<input type="text" name="COMMNAME" IAname="COMMNAME"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,COMMLABEL"></td>
												<td GH="140" GCol="input,COMMNAME"></td>
												<td GH="140" GCol="input,COMMTYPE"></td>
