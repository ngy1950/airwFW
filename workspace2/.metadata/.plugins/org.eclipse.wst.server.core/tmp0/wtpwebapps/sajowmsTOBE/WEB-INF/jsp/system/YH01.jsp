...
var headMap = new DataMap();
	...
	function commonBtnClick(btnName){
		if(btnName == "Create"){
			...
			saveData();
// 		}else if(btnName == "PwdClen"){ //사용안함
// 			pwdClen();
		}else if(btnName == "Savevariant"){
	 		sajoUtil.openSaveVariantPop("searchArea", "YH01");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "YH01");
 		}
	}
	...
	function gridListEventRowAddBefore(gridId, rowNum, beforeData){
		...
		//newData.put("CPOPITEMID", $("#CPOPITEMID").val());
		return newData;
	}
			...
			<div class="search_inner">
				<div class="search_wrap ">
					<dl>
						...
						<dd>
							<input type="text" class="input" name="COMMPOPID" id="CPOPITEMID" maxlength="50" UIInput="S,SYSCOMMPOP" validate="required"/>
						</dd>
					</dl>
					...
					<dl>
						...
						<dd>
							<input type="checkbox" class="input" name="CPOPTYPE" readonly="readonly" onChange="inputChange('CPOPTYPE')" style="margin:0;"/>
						</dd>
					</dl>
					...
					<dl>
						...
						<dd>
							<input type="checkbox" class="input" name="EXETYPE" readonly="readonly" onChange="inputChange('EXETYPE')" style="margin:0;"/>
						</dd>
					</dl>
					<dl>
						<dt CL="STD_SIZEW"></dt><!--팝업 Width 가로 -->
						<dd>
					...
					<dl>
						<dt CL="STD_SIZEH"></dt><!--팝업 Height 세로 -->
						<dd>
