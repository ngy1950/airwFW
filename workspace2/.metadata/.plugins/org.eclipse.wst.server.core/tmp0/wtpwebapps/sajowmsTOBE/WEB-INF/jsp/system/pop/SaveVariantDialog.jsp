...
// 		});
	...
	function saveData(){
		if(validate.check("searchArea")){
			...
			param.put(configData.VARIANT_RANGE_PARAM, pageData.get(configData.VARIANT_RANGE_PARAM));
			param.put("SEARCH", pageData.get("SEARCH"));
			
			sajoUtil.saveVariant(param);
		}
	}
</script>
</head>
...
<!-- 					<input type="button" CB="Cancel CANCEL BTN_CANCEL" /> -->
			...
			<div class="search_inner" >
				<div class="search_wrap" style="height: auto;">
					...
					<dl>
						<dt CL="STD_VARIANT"></dt><!-- VARIANT -->
						<dd>
							<input type="text" class="input" name="PARMKY" id="VARIANT" validate="required(STD_VARIANT)"/>
						</dd>
					</dl>
					 <dl> 
					...
					<dl> 
						...
						<dd>
							<input type="text" class="input" name="SHORTX" style="width:300px;"/>
						</dd>
					</dl>
				</div>
