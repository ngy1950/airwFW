							...
							<table class="table_c">
								<tbody id="gridList">
									<tr CGRow="true">
										...
										<td GH="80 STD_ICONIM"  GCol="icon,ICON" GB="icon"></td> <!-- 아이콘 -->
										<td GH="100 STD_ICONNM"  GCol="text,NAME"></td> <!-- 아이콘파일명 -->
										<td GH="100 STD_ICOEXT"  GCol="text,EXT,center"></td> <!-- 확장자 -->
										<td GH="370 STD_ICOPLS"  GCol="text,PATH"></td> <!-- 아이콘파일경로 -->
									</tr>
								</tbody>
							</table>
						</div>
