...
{
	var andValue = "";
	var url = "/common/common_ezprint.page";
	...
	//alert(andValue)
	//window.open("/common/common_ezprint.page", "common_print_popup", "menubar=no,resizable=yes,scrollbars=yes,status=no,titlebar=no,toolbar=no,location=no");
}
