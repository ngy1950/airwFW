							...
							<table class="table_c">
								<tbody id="gridList">
									<tr CGRow="true">
										...
										<td GH="100"			GCol="add,MENUID" validate="required"></td>
										<td GH="150 STD_MENUTX"	GCol="input,MENUNAME"></td>
										<td GH="150 STD_PGPATH"	GCol="input,URI"></td>
										<td GH="340 STD_ICPATH"	GCol="input,IMGPTH,SHIMGPTH"></td>
