...
<style type="text/css">
.content_layout_audit{width: calc((100% - 40px) / 3); box-sizing:border-box; height: calc(100% - 20px); margin: 12px 20px 12px 0;}
.content_layout_audit:last-child{margin-right: 0;}
</style>
</head>
...
<div class="content_wrap">
	<div class="content_inner">
        ...
        <div class="search_next_wrap">
			<div class="content-horizontal-wrap top_layout">
				<div class="content_layout_audit">
					<!-- 그래프 1 -->
				</div>
				<div class="content_layout_audit">
					<!-- 그래프 2 -->
			...
			<div class="content-horizontal-wrap bottom_layout" >
				<div class="content_layout tabs content_3set">
...
<!-- 							<button type='button' GBtn="excelUpload"></button> -->
				...
				<div class="content_layout tabs content_3set">
					<ul class="tab tab_style02">
						...
						<li><a href="#tab2-2"><span>상세</span></a></li>
						<li class="btn_zoom_wrap">
							<ul>
								<!-- <li><button class="btn btn_smaller"><span>축소</span></button></li> -->
								<li><button class="btn btn_bigger"><span>확대</span></button></li>
