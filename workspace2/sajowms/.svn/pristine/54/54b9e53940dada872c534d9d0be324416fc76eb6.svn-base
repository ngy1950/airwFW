...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		%>
		var bgDiv = "<div class='bgDiv' style='height:"+wh+"px;width:"+ww+"px;position:absolute;top:-80px;left:0; z-index:-1;background:url(/common/theme/webdek/images/bg_full.png) repeat center center;'></div>";
		<%
			}
		%>
...
<div class="tab_wrap"> 
 ...
 <div id="tab1" class="tab_content">	
		<!-- lnb wrap -->
	<div class="lnb_wrap">
		<ul class="lnb_dep01" id="menuList">
<%
	DataMap row;
	String url;
