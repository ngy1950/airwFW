	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_CPOPNAME"></th>
						<td>
							<input type="text" name="CPOPNAME" IAname="CPOPNAME"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,CPOPLABEL"></td>
												<td GH="140" GCol="input,CPOPNAME"></td>
												<td GH="140" GCol="input,VIEWTNAME"></td>
												<td GH="140" GCol="input,CPOPDESC"></td>
												<td GH="140" GCol="input,CPOPTYPE"></td>
												<td GH="140" GCol="input,EXETYPE"></td>
