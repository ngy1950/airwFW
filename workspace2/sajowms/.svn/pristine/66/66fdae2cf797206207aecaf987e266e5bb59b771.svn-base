...
<script type="text/javascript">
	...
	function gridListEventItemGridSearch(gridId, rowNum, itemGridList){
		if(gridId == "gridHeadList"){
			...
			var searchData = inputList.setRangeDataParam("searchArea");
			var data = new DataMap();
			if(searchData.get("RANGE_DATA_PARAM").get("I.SKUKEY_Single")){
				var singleMap = new DataMap();
				singleMap.put("I.SKUKEY_Single",searchData.get("RANGE_DATA_PARAM").get("I.SKUKEY_Single"));
				data.put("RANGE_DATA_PARAM",singleMap);
				param.putAll(data);
			}
			if(searchData.get("RANGE_DATA_PARAM").get("I.SKUKEY_Range")){
				var rangeMap = new DataMap();
				rangeMap.put("I.SKUKEY_Single",searchData.get("RANGE_DATA_PARAM").get("I.SKUKEY_Range"));
				data.put("RANGE_DATA_PARAM",rangeMap);
				param.putAll(data);
			}
	...
	function comboEventDataBindeBefore(comboAtt, $comboObj){
		if(comboAtt = "Common,DOCTM_COMCOMBO"){
			...
			param.put("DOCCAT", "000");
			param.put("DOCGRP", "100");
			return param;
		}		
	}
	...
	function saveData(){
		if(gridList.validationCheck("gridHeadList", "select")){
			...
			param.put("item",item);
			netUtil.send({
				url : "/inbound/json/saveAS05.data",
				param : param,
	...
	function successSaveCallBack(json, status){
		if(json && json.data){
			if(json.data["RESULT"] == "S"){
				...
				commonUtil.msgBox("IN_M1000",[json.data["ASNDKY"]]);
			}else{
			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>
						<dt CL="STD_RCPTTY"></dt>
						<dd>
							<select name="ASNTTY" class="input" Combo="Common,DOCTM_COMCOMBO"></select>
						</dd>
					</dl>
					<dl>
						<dt CL="STD_ASNDAT"></dt>
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									<tr CGRow="true">
										...
										<td GH="140 STD_RCPTTY"  GCol="text,ASNTNM"></td>
										<td GH="140 STD_SEBELN"  GCol="text,SEBELN"></td>
										<td GH="140 STD_OWNRKY"  GCol="text,OWNRNM"></td>
										<td GH="140 STD_ASNDAT"  GCol="text,DOCDAT" GF="D"></td>
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
										<td GH="40" GCol="rownum">1</td>
										<td GH="40" GCol="rowCheck"></td>
										<td GH="140 STD_ASNDIT"  GCol="text,ASNDIT"></td>
										<td GH="140 STD_SKUKEY"  GCol="text,SKUKEY"></td>
										<td GH="140 STD_DESC01"  GCol="text,DESC01"></td>
										<td GH="140 STD_QTYASN"  GCol="text,QTYASN" GF="N 20"></td>
										<td GH="140 STD_UOMKEY"  GCol="text,UOMKEY"></td>	
										<td GH="140 STD_SRLNUM"  GCol="text,SZMIPNO"></td>
										<td GH="140 STD_LGSNUM"  GCol="text,STDLNR"></td>
										<td GH="140 STD_LOTA01"  GCol="text,LT01NM"></td>
