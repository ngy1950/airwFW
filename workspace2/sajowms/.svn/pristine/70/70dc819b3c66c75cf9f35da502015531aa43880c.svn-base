	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_DEPTNAME"></th>
						<td>
							<input type="text" name="DEPTNAME" IAname="DEPTNAME"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,DEPTLABEL"></td>
												<td GH="140" GCol="input,DEPTNAME"></td>
												<td GH="140" GCol="input,SORTORDER"></td>
												<td GH="140" GCol="input,PDEPTID"></td>
