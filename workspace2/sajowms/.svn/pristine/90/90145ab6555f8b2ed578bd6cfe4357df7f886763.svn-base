		...
		<div class="content_inner">
			...
			<div class="content_layout tabs" style="height:80%;">
				<ul class="tab tab_style02">
					<li class="selected"><a href="#tab1-1"><span CL="STD_UNPR_RESN_REG"></span></a></li>
				</ul>
							...
							<table class="table_c">
								...
								<tbody id="gridList">
									<tr CGRow="true"> 
										...
										<td GH="120 STD_UNPR_GB"   GCol="select,UNPR_RESN_CD">
											<select class="input" Combo="BLCOMMON,BLCDCOMBO" ComboCodeView="false"><option value=""></option></select>
										</td><!-- 미처리구분 -->
										<td GH="200 STD_UNPR_CNTS" GCol="input,UNPR_RESN_CNTS"></td>
									</tr>
								</tbody>
							</table>
						</div>
