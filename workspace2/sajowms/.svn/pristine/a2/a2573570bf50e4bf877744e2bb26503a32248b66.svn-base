...
<script type="text/javascript">
	$(document).ready(function(){
		...
		gridList.setReadOnly("gridList", true, ["LABELTYPE"]);
	});
	...
	function test1(){
		gridList.setColValue("gridList", 0, "LANGCODE", "T", true);
	}
	
	function test2(){
		gridList.setColValue("gridList", 0, "LANGCODE", "KO", true);
	}
</script>
</head>
<body>
		...
		<div class="content_serch" id="searchArea">
			<div class="btn_wrap">
				...
				<div class="fl_r">
					...
					<input type="button" CB="Test1 SAVE BTN_TEST1" />
					<input type="button" CB="Test2 SAVE BTN_TEST2" />
				</div>
			</div>
