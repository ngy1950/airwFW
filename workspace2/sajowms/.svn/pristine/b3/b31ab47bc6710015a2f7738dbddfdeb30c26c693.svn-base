...
<script type="text/javascript">
	$(document).ready(function(){
		...
		//$('#CTEST').datepicker( "option", "minDate",date);
	});
	...
	function Reset(){
		$("[name='Search2']").removeAttr("readonly").removeProp("readonly");
		$("[name='Calendar2']").removeAttr("readonly").removeProp("readonly");
	}
</script>
</head>
<body>
		...
		<div class="content_serch" id="searchArea">
			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>
						<dt CL="Search readonly"></dt>
						<dd>
							<input type="text" class="input" name="Search2" UIInput="S,SYSLABEL" IAname="Search" UIFormat="U" validate="required" readonly="readonly"/>
						</dd>
					</dl>
					<dl>
						<dt CL="SearchText"></dt>
						<dd>
							<input type="text" class="input" name="Search" UIInput="S,SYSLABEL,text" />
						</dd>
					</dl>
					<dl>
						<dt CL="Calendar"></dt>
						<dd>
							<input type="text" class="input" name="Calendar" id="CTEST" UIFormat="C M1" />
						</dd>
					</dl>
					<dl>
						<dt CL="Calendar readonly"></dt>
						<dd>
							<input type="text" class="input" name="Calendar2" UIFormat="C Y" readonly="readonly"/>
						</dd>
					</dl>
					<dl>
					...
					<dl>
						<dt CL="ComboText"></dt>
						<dd>
							<select name="ComboText" class="input" Combo="Demo,COMCODE_PARAM" ComboCodeView="false">
							</select>
						</dd>
					</dl>
					<dl>
						...
						<dd class="multiCombo">
							<select name="SearchCombo" class="input" Combo="Demo,COMCODE" ComboType="SC">
							</select>
						</dd>
					</dl>
					<dl>
						<dt CL="MultiCombo"></dt>
						<dd class="multiCombo">
							<select name="MultiCombo" class="input" Combo="Demo,COMCODE" ComboType="MC">
							</select>
						</dd>
					</dl>
					<dl>
						...
						<dd class="multiCombo">
							<select name="MultiSearchCombo" class="input" Combo="Demo,COMCODE" ComboType="MS">
							</select>
						</dd>
					</dl>
					<dl>
					...
					<dl>
						<dt CL="Number"></dt>
						<dd>
							<input type="text" class="input" name="Number" UIFormat="N" />
						</dd>
					</dl>
					<dl>
						<dt CL="Number String"></dt>
						<dd>
							<input type="text" class="input" name="NumberString" UIFormat="NS" />
						</dd>
					</dl>
					<dl>
						<dt CL="Korea"></dt>
						<dd>
							<input type="text" class="input" name="Korea" UIFormat="KO" />
						</dd>
					</dl>
				</div>
				<div class="btn_tab">
        ...
        <div class="search_next_wrap">
			<div class="content_layout tabs">
				...
				<div class="table_box" id="tab1-2">
					<div class="inner_search_wrap" id="detailSearch">
						<table class="detail_table">
							...
							<tbody>			
								<tr>
									<th CL="Search"></th>
									<td class="input_box btn1">
										<input type="text" class="input" name="Search" UIInput="S,SYSLABEL" IAname="Search" UIFormat="U"/>
									</td>
									<th CL="Calendar"></th>
									<td>
