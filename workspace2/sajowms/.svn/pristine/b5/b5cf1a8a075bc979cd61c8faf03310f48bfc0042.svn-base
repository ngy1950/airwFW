...
<div class="layer_popup" id="gridBodyMenuLayer" style="left:100px;top:100px;width:147px;display:none;"><!-- 팝업 위치는 알아서 변경해주세요 -->
	<div class="right_click_box">
		<ul class="right_click_list">
			<!-- li><input type="button" class="btn_l btn_cut off" value="Cut" onClick="gridList.contextMenuExec('Cut')"/></li--><!-- 회색아이콘은 off 추가 -->
			<!-- li><input type="button" class="btn_l btn_copy" value="Copy" onClick="gridList.contextMenuExec('Copy')"/></li--><!-- 회색아이콘은 off 추가 -->
			<li><input type="button" class="btn_l btn_paste" value="Paste" onClick="gridList.contextMenuExec('Paste')"/></li>
			<!-- li><input type="button" value="Remove" /></li-->
		</ul>
		<ul class="right_click_list">
			<li class="addMenu"><input type="button" class="btn_l btn_add_r" value="Add" onClick="gridList.contextMenuExec('Add')"/></li>
			<li class="addMenu"><input type="button" class="btn_l btn_insertion" value="Insert" onClick="gridList.contextMenuExec('Insert')"/></li>
			<li class="addMenu"><input type="button" class="btn_l btn_cloning" value="Clone" onClick="gridList.contextMenuExec('Clone')" /></li>
			<li class="delMenu"><input type="button" value="Delete" onClick="gridList.contextMenuExec('Delete')"/></li>
		</ul>
		<!-- ul class="right_click_list">
			<li><input type="button" class="btn_l btn_filter" value="Filter" /></li>
			<li><input type="button" class="btn_l btn_fixed_frame" value="Freeze panes" /></li>
		</ul-->
	</div>
</div>
<!-- grid body menu popup -->
...
<div class="layer_popup" id="gridHeadMenuLayer" style="left:200px;top:200px;width:147px;display:none;"><!-- 팝업 위치는 알아서 변경해주세요 -->
	<div class="right_click_box">
		<ul class="right_click_list">
			<li class="sortMenu"><input type="button" class="btn_l btn_ascending" value="Sort(asc)" onClick="gridList.contextMenuExec('SortAsc')"/></li>
			<li class="sortMenu"><input type="button" class="btn_l btn_descending" value="Sort(desc)" onClick="gridList.contextMenuExec('SortDesc')" /></li>
			<li class="sortMenu"><input type="button" class="btn_l btn_sort_del" value="Sort reset" onClick="gridList.contextMenuExec('SortReset')" /></li>
			<!-- li><input type="button" class="btn_l btn_sort_edit" value="Sort edit" /></li>
			<li><input type="button" class="btn_l btn_hide" value="Hidden" /></li>
			<li><input type="button" class="btn_l btn_column_w" value="Column width" /></li-->
		</ul>
		<ul class="right_click_list">
			<li class="columnEdit"><input type="button" class="btn_l btn_column_edit" value="Column edit" onClick="gridList.contextMenuExec('ColumnEdit')" /></li>
			<!-- li><input type="button" class="btn_l btn_filter" value="Filter" /></li-->
			<li class="totalMenu"><input type="button" class="btn_l btn_sum_r" value="Total" onClick="gridList.contextMenuExec('Total')" /></li>
			<li class="totalMenu"><input type="button" value="Sub total" onClick="gridList.contextMenuExec('SubTotal')"/></li>
		</ul>
		<!-- ul class="right_click_list">
			<li><input type="button" class="btn_l btn_filter" value="Filter" /></li>
			<li><input type="button" class="btn_l btn_fixed_frame" value="Freeze panes" /></li>
		...
		<!-- >ul class="right_click_list">
			<li><input type="button" class="btn_l btn_cut" value="Cut" /></li>
			<li><input type="button" class="btn_l btn_copy" value="Copy" /></li>
			<li><input type="button" class="btn_l btn_paste" value="Paste" /></li>
			<li><input type="button" value="Clear" /></li>
		</ul-->
	</div>
</div>
<!-- grid head menu popup -->
