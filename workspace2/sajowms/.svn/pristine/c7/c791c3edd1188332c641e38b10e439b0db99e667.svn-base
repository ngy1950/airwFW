...
<script type="text/javascript">
	...
	function attachedFile(gridId, rowNum, colName, colValue){
		return "<img src='/common/theme/webdek/images/icon_attached.png' height='20px' width='auto'/>"; 
	}
	
	function newNotice(gridId, rowNum, colName, colValue){
		return "<img src='/common/theme/webdek/images/icon_new.png' height='20px' width='auto'/>"; 
	}
							...
							<table class="table_c">
								<tbody id="gridList">
									<tr CGRow="true">
										...
										<td GH="80" GCol="fn,LANGCODE,attachedFile"></td>
										<td GH="150" GCol="fn,LABEL,newNotice"></td>
