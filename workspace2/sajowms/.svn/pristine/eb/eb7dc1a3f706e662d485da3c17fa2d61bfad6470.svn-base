...
<script type="text/javascript">
	...
	function saveData(){
		if(gridList.validationCheck("gridHeadList", "select")){
			...
			netUtil.send({
				url : "/inbound/json/saveGR04.data",
				param : param,
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									<tr CGRow="true">
										...
										<td GH="140 STD_ASNRTN"  GCol="text,SEBELN"></td>
										<td GH="140 STD_RCPTTY"  GCol="text,RCPTNM"></td>
										<td GH="140 STD_OWNRKY"  GCol="text,OWNRNM"></td>
										<td GH="140 STD_EXPTNK"  GCol="text,DNAME3"></td>
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
										<td GH="40" GCol="rownum">1</td>
										<td GH="40" GCol="rowCheck"></td>
										<td GH="140 STD_ASNRIT"  GCol="text,SEBELP"></td>
										...
										<td GH="140 STD_DPTNKY1" GCol="text,LOTA05"></td>	
										<td GH="140 STD_LOTA01"  GCol="text,LT01NM"></td>
										<td GH="140 STD_LOTA02"  GCol="text,LOTA02" GF="D"></td>
										<td GH="140 STD_LOTA03"  GCol="text,LOTA03" GF="D"></td>								
										<td GH="140 STD_SHPOKY"  GCol="text,SVBELN"></td>					
										<td GH="140 STD_SHPOIT"  GCol="text,SPOSNR"></td>					
									</tr>
								</tbody>
							</table>
						</div>
