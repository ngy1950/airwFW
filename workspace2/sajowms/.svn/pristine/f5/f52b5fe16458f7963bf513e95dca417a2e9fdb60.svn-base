			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>
						<dt CL="STD_SRLNUM"></dt>
						<dd>
							<input type="text" class="input" name="I.SZMIPNO" UIInput="SR"/>
						</dd>
					</dl>
					<dl>
						<dt CL="STD_SKUKEY"></dt>
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									<tr CGRow="true">
										...
										<td GH="140 STD_ASNPRD"  GCol="text,SEBELN"></td>
										<td GH="140 STD_RCPTTY"  GCol="text,RCPTNM"></td>
										<td GH="140 STD_OWNRKY"  GCol="text,OWNRNM"></td>
										<td GH="140 STD_BZPFCT"  GCol="text,DNAME1"></td>
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
										<td GH="40" GCol="rownum">1</td>
										<td GH="40" GCol="rowCheck"></td>
										<td GH="140 STD_ASNPIT"  GCol="text,SEBELP"></td>
										...
										<td GH="140 STD_LOTA01"  GCol="select,LOTA01">
											<select Combo="Common,CMCDV_COMBO" name="LOTA01" ComboCodeView="false">
