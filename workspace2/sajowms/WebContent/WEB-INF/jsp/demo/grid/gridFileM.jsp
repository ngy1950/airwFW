...
<script type="text/javascript">
	...
	function saveData(){
		var dataList = gridList.getModifyData("gridList", "A");
		commonUtil.debugMsg("data : ", dataList);
	}
							...
							<table class="table_c">
								<tbody id="gridList">
									<tr CGRow="true">
										...
										<td GH="80" GCol="text,GUUID"></td>
										<td GH="250 STD_ATTACH"   GCol="file,ATTACH,multi"/></td>
