...
<script type="text/javascript">
	...
	function saveData(){
		var dataList = gridList.getModifyData("gridList");
		commonUtil.debugMsg("getModifyData : ", dataList);
		dataList = gridList.getModifyData("gridList", "E");
		commonUtil.debugMsg("getModifyData E : ", dataList);
		dataList = gridList.getModifyData("gridList", "A");
		commonUtil.debugMsg("getModifyData A : ", dataList);
	}
	
	function saveData2(){
		var dataList = gridList.getModifyData("gridList2");
		commonUtil.debugMsg("getModifyData : ", dataList);
		dataList = gridList.getModifyData("gridList2", "E");
		commonUtil.debugMsg("getModifyData E : ", dataList);
		dataList = gridList.getModifyData("gridList2", "A");
		commonUtil.debugMsg("getModifyData A : ", dataList);
	}
...
<div class="content_wrap">
	<div class="content_inner">
		...
		<div class="content_serch" id="searchArea">
			<div class="btn_wrap">
				...
				<div class="fl_r">
					...
					<input type="button" CB="Save2 SAVE BTN_SAVE" />
				</div>
			</div>
        ...
        <div class="search_next_wrap">
							...
							<table class="table_c">
								<tbody id="gridList">
									<tr CGRow="true">
										...
										<td GH="80" GCol="input,LABELGID"></td>
										<td GH="150" GCol="input,LABELID"></td>
			...
			<div class="content_layout tabs content_H_3set">
				<ul class="tab tab_style02">
					<li><a href="#tab2-1"><span>일반</span></a></li>
					<li class="btn_zoom_wrap">
						<ul>
							<!-- <li><button class="btn btn_smaller"><span>축소</span></button></li> -->
							<li><button class="btn btn_bigger"><span>확대</span></button></li>
							...
							<table class="table_c">
								<tbody id="gridList2">
									<tr CGRow="true">
										<td GH="40" GCol="rownum">1</td>
										<td GH="40" GCol="rowCheck"></td>
										<td GH="80" GCol="add,LABELGID"></td>
										<td GH="150" GCol="add,LABELID"></td>
										<td GH="80" GCol="select,LANGCODE">
											<select class="input" CommonCombo="LANGKY">
											</select>
										</td>
			...
			<div class="content_layout tabs content_H_3set">
				<ul class="tab tab_style02">
					<li><a href="#tab3-1"><span>일반</span></a></li>
					<li><a href="#tab3-2"><span>상세</span></a></li>
					<li class="btn_zoom_wrap">
						<ul>
							<!-- <li><button class="btn btn_smaller"><span>축소</span></button></li> -->
							<li><button class="btn btn_bigger"><span>확대</span></button></li>
