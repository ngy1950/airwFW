...
// 	String serverName = "172.21.1.51"; 
// 	String url = "http://portal.g-hub.kr";
// 	String url = "gccl.g-hub.kr";
// 	String url = "http://gclc.g-hub.kr";
	String compid = "GCLC";
	if(url.indexOf("gccl.g-hub.kr") != -1
	|| url.indexOf("172.21.1.53") != -1
	|| url.indexOf("172.21.1.54") != -1
	|| url.indexOf("172.21.1.55") != -1
	|| url.indexOf("218.235.251.62") != -1){
		compid = "GCCL";
	}
%>
...
<%
	if(url.indexOf("portal.g-hub.kr") != -1){
%>
	this.location.href = "/portal/index.data";
<%
	}
%>
...
%>
<%
	if(url.indexOf("gclc.g-hub.kr") != -1){
%>
	$("#COMPID").val("GCLC");
<%
}
	...
	if(validate.check("searchArea")){
		...
		if(json && json.data){
			if(json.data == "N"){
				...
				if(json && json.data){
					this.location.href = "/gcim/intro.page";
				}
			}
		}
	}	
...
<body class="<%=compid%>">
	...
	%>
			<img src="/common/theme/webdek/images/login/LOGO_1.png" />
			<img src="/common/theme/webdek/images/login/LOGO_2.png" />
			<img src="/common/theme/webdek/images/login/LOGO_TEXT.png" />
	<%
		}
	%>
		</div>
	...
	<footer>
		<p>Copyright ⓒ 2020 Green Cross. All rights reserved.</p>
