...
<script type="text/javascript">
	...
	function gridListEventRowAddBefore(gridId, rowNum) {
    	if(gridId == "gridList"){
            ...
            newData.put("ALSTKY","");
            newData.put("SHORTX","");
            newData.put("STEP01","001");
            newData.put("ALFTKY","001");
            newData.put("SSORKY","ASC");
	...
	function resetDetailArea(type,data){
		...
		if(type == "init"){
			param.put("ALSTKY","");
			param.put("SHORTX","");
			param.put("STEP01","001");
			param.put("ALFTKY","001");
			param.put("SSORKY","ASC");
		}else{
			param.putAll(data);
		}
			...
			<div class="search_inner">
				<div class="search_wrap ">
					<dl>
						<dt CL="STD_PASTKY"></dt>
						<dd>
							<input type="text" class="input" name="A.ALSTKY" UIInput="SR"/>
						</dd>
					</dl>
					<dl>
						<dt CL="STD_SHORTX"></dt>
						<dd>
							<input type="text" class="input" name="A.SHORTX" UIInput="SR" />
						</dd>
					</dl>
				</div>
				<div class="btn_tab">
								...
								<table class="table_c">
									<tbody id="gridList">
										<tr CGRow="true">
											...
											<td GH="100 STD_PASTKY" GCol="text,ALSTKY"></td>
		                    ...
		                    <table class="detail_table" id="detail" style="min-width: 500px;">
		                        ...
		                        <tbody>         
		                            <tr>
		                                <th CL="STD_PASTKY"></th>
		                                <td>
		                                    <input type="text" class="input" name="ALSTKY" readonly="readonly" style="width: 100%;height: 100%;border: 0;margin: 0;"/>
		                                </td>
		                            </tr>   
		                            <tr>    
		                                <th CL="STD_SHORTX"></th>
		                            ...
		                            <tr>
		                            	<th CL="STD_TFSSRT"></th>
		                                <td>
		                                    <select name="ALFTKY" class="input" Combo="Common,CMCDV_COMBO" ComboCodeView="false" onchange="fn_change_input('ALFTKY');"></select>
		                                    <select name="SSORKY" class="input" Combo="Common,CMCDV_COMBO" ComboCodeView="false" onchange="fn_change_input('SSORKY');"></select>
		                                </td>
		                            </tr>
		                        </tbody>
		                    </table>
