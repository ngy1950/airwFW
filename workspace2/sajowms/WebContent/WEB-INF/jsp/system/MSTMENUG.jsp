	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_MENUGNAME"></th>
						<td>
							<input type="text" name="MENUGNAME" IAname="MENUGNAME"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="160" GCol="input,MENUGROUPID"></td>
												<td GH="150" GCol="input,MENUGLABEL"></td>
												<td GH="145" GCol="input,MENUGNAME"></td>
