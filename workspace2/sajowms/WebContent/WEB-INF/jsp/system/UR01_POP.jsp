...
// 	});
	...
	function create(){
		if(validate.check("searchArea")){
			...
			netUtil.send({
				url : "/admin/json/createUR01.data",
				param : param,
		...
		<div class="content_serch" id="searchArea">
            ...
            <div class="search_inner">
                <table class="find_idpw" id="detail">
                    ...
                    <tr>
                        <th CL="STD_MENUGID"></th> <!-- 메뉴그룹ID -->
                        <td>
                            <input type="text" class="input" name="MENUGID" maxlength="35" validate="required"/>
                        </td>
                    </tr>
                    <tr>
                        <th CL="STD_MENUGNAME"></th> <!-- 비밀번호 -->
                        <td>
                            <input type="text" class="input" name="MENUGNAME" maxlength="100" validate="required"/>
                        </td>
                    </tr>
                </table>
            </div>
