...
<script type="text/javascript">
	...
	function closeWindow(menuId, tmpActiveMenuId){
		...
		if(menuTabMap.size() == 0){
			$rightFrame.attr("rows", "29.55px,*,0,0,0,0,0,0,0,41px");
		}
	}
...
<frameset id="topFrame" name="topFrame" rows="50.55px,*" noresize framespacing=0 frameborder=no border=0 >
    <frame id="header" name="header" src="/webdek/top.data" noresize framespacing=0 frameborder=no border=0 scrolling="no">
    <frameset id="middleFrame" name="middleFrame" cols="280px,*" noresize framespacing=0 frameborder=no border=0 >
        ...
        <frame id="left" name="left" src="/webdek/left.data" name="lnb" noresize framespacing=0 frameborder=no border=0>
        <frameset id="rightFrame" name="rightFrame" rows="30px,*,0,0,0,0,0" noresize framespacing=0 frameborder=no border=0 >
			<frame id="nav" name="nav" src="/webdek/wintab.page" noresize framespacing=0 frameborder=no border=0 scrolling="no">
			<frame id="main" name="main" src="/webdek/info.page" noresize framespacing=0 frameborder=no border=0>
