...
// 				gridList.setRowReadOnly(gridId, rowNum , true);
			...
			var statit = gridList.getColData(gridId, rowNum, "STATDO");
			if(statit != "NEW"){
// 				gridList.setRowReadOnly(gridId, rowNum, true);
				return true;
			}
	...
	function comboEventDataBindeBefore(comboAtt, $comboObj){
		...
		if(comboAtt == "SajoCommon,DOCUTY_COMCOMBO"){
			param.put("DOCUTY", "131,133,137,138,139");
	...
	function saveData(){
		if(gridList.validationCheck("gridHeadList", "select")){
			...
			netUtil.send({
				url : "/inbound/json/saveReturned.data",
				param : param,
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			saveData();
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "GR40");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "GR40");
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									<tr CGRow="true">
			    						...
			    						<td GH="120 STD_BOXQTY" GCol="text,BOXQTY" GF="N 11,1">박스수량</td>	<!--박스수량-->
