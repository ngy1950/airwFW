...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//$("input[name=VW.ORDDAT]").val(data.get("ORDDAT"));
...
//		$("#searchArea").hide();
	...
	function gridListEventRowDblclick(gridId, rowNum, colName, colValue){
		if(gridId == "gridList2"){
			...
			page.linkPopOpen("/wms/report/pop/DRBzptn.page", data, option);
							...
							<table class="table_c">
								<tbody id="gridList1">
									<tr CGRow="true">
			    						...
			    						<td GH="60 STD_EZG_DST" GCol="text,REMQTY" GF="N 20,0">낱개수량</td>	<!--낱개수량-->
							...
							<table class="table_c">
								<tbody id="gridList2">
									<tr CGRow="true">
			    						...
			    						<td GH="50 STD_WAREKY" GCol="text,WAREKY" GF="S 10">거점</td>	<!--거점-->
			    						<td GH="50 STD_WAREKYNM" GCol="text,NAME01" GF="S 10">거점명</td>	<!--거점명-->
			    						<td GH="60 STD_ORDDAT" GCol="text,ORDDAT2" GF="S 20">출고일자</td>	<!--출고일자-->
			    						<td GH="60 STD_CARNUM" GCol="text,CARNUM" GF="S 20">차량번호</td>	<!--차량번호-->
			    						<td GH="130 STD_DRCARNUM" GCol="text,CNUMNM" GF="S 20">배송코스</td>	<!--배송코스-->
