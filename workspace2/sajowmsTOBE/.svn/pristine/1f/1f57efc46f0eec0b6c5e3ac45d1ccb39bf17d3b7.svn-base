...
//			param.put("TRNUTG", $("#TRNUTG").val());
			param.put("JOBTYP", "213");
			
			netUtil.send({
				url : "/mobile/MobileOutbound/json/saveMDL06.data",
				param : param,
...
<body>
	...
	<div class="mobile_order">
		...
		<div class="m_menutitle"><span>차량별 피킹완료</span></div>
						...
						<table>
							<tbody id="gridList">
								<tr CGRow="true">
									...
									<td GH="80 STD_QTYWRK" GCol="input,QTYWRK" GF="N 13,1"  validate="required"></td>  <!--작업수량-->
