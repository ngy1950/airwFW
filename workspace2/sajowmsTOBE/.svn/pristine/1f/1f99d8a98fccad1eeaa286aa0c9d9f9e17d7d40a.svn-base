...
<script type="text/javascript">
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "DR30");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DR30");
		}
	}
	...
	function saveData(){
		if (gridList.validationCheck("gridHeadList", "select") && gridList.validationCheck("gridItemList", "select")) {
			...
			if(!commonUtil.msgConfirm("SYSTEM_SAVECF")){ //저장하시겠습니까?
		 	...
		 	netUtil.send({
				url : "/daerimOutbound/json/saveDR30.data",
				param : param,
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									<tr CGRow="true">
			    						...
			    						<td GH="150 STD_WARETG" GCol="select,WARETG" ><!--도착거점-->
											<select class="input" Combo="SajoCommon,WAREKYNM_COMCOMBO" validate="required"></select>
			    						</td>	
			    						<td GH="120 IFT_DOCUTY" GCol="select,DOCUTY"><!--출고유형-->
											<select class="input" Combo="SajoCommon,DOCUTY_COMCOMBO" validate="required"></select>
			    						</td>	
			    						<td GH="80 IFT_SVBELN" GCol="text,SVBELN" GF="S 40">S/O 번호</td>	<!--S/O 번호-->
			    						<td GH="80 STD_OTRQDT" GCol="input,OTRQDT" GF="C 8" validate="required">출고요청일</td>	<!--출고요청일-->
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
			    						...
			    						<td GH="80 STD_DPTNKY" GCol="select,WARETG" ><!--업체코드-->
											<select class="input" Combo="SajoCommon,WAREKYNM_COMCOMBO"></select>
			    						</td>	
			    						<td GH="80 STD_DOCDAT" GCol="text,DOCDAT" GF="D 6">문서일자</td>	<!--문서일자-->
			    						<td GH="80 STD_SKUKEY" GCol="text,SKUKEY" GF="S 80" validate="required">제품코드</td>	<!--제품코드-->
			    						...
			    						<td GH="80 STD_MAXQTY" GCol="text,QTYREQ" GF="N 20">최대수량</td>	<!--최대수량-->
			    						<td GH="80 STD_QTYRCV" GCol="input,QTYORG" GF="N 20">입고수량</td>	<!--입고수량-->
			    						<td GH="80 STD_QTYUOM" GCol="text,QTYUOM" GF="N 20">Quantity by unit of measure</td>	<!--Quantity by unit of measure-->
			    						<td GH="80 STD_QTYSTD" GCol="text,QTYSTD" GF="N 20">팔렛트 적재수량</td>	<!--팔렛트 적재수량-->
