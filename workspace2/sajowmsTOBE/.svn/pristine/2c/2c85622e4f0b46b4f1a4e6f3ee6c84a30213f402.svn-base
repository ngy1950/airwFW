...
<script type="text/javascript">
	...
	function commonBtnClick(btnName) {
		if (btnName == "Search") {
			...
			sajoUtil.openSaveVariantPop("searchArea", "DR19");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DR19");
		}
	}
	...
	function saveData() {
		...
		if (gridList.validationCheck("gridList", "data")) {
			...
			netUtil.send({
				url : "/daerimOutbound/json/saveDR19.data",
				param : param,
				...
				<div class="search_inner">
					<div class="search_wrap ">
						...
						<dl>  <!--피킹그룹-->  
							<dt CL="STD_PICGRP"></dt> 
							<dd> 
								<input type="text" class="input" name="NVL(PK.PICGRP, '000')" UIInput="SR,SHCMCDV"/> 
							</dd> 
						</dl> 
						<dl>  <!--제품코드-->  
							<dt CL="IFT_SKUKEY"></dt> 
									...
									<tbody id="gridList">
										<tr CGRow="true">
				    						...
				    						<td GH="80 STD_OWNRKY" GCol="select,OWNRKY">	<!--화주-->
												<select class="input" Combo="SajoCommon,OWNRKYNM_COMCOMBO">
													<option></option>
												</select>
				    						</td>
				    						...
				    						<td GH="80 STD_SKUKEY" GCol="input,SKUKEY,SHSKUMAGD" GF="S 20" validate="required">제품코드</td>	<!--제품코드-->
				    						<td GH="80 STD_DESC01" GCol="text,DESC01" GF="S 20">제품명</td>	<!--제품명-->
				    						<td GH="80 STD_PICGRP" GCol="select,PICGRP" validate="required"><!--피킹그룹-->
												<select class="input" commonCombo="PICGRP">
													<option></option>
												</select>
				    						</td>	
