...
<script type="text/javascript">
	...
	function commonBtnClick(btnName) {
		if (btnName == "Search") {
			...
			sajoUtil.openSaveVariantPop("searchArea", "OD05");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "OD05");
		}
	}
				...
				<div class="search_inner">
					<div class="search_wrap ">
						<dl> <!--화주-->  
							<dt CL="STD_OWNRKY"></dt>
							<dd>
								<select name="OWNRKY" id="OWNRKY2"  class="input" Combo="SajoCommon,OWNRKY_COMCOMBO" ComboCodeView="true" disabled="disabled"></select>
							</dd>
						</dl>
						<dl>
							<dt CL="STD_WAREKY"></dt>
						...
						<dl>  <!--위탁여부-->  
							<dt CL="STD_ENTRST_YN"></dt> 
							<dd> 
								<input type="text" class="input" name="LOTA07" UIInput="SR" value="21SV" readonly="readonly"/> 
							</dd> 
						</dl> 
						<dl>  <!--위탁타입-->  
							<dt CL="STD_ENTRST_TYP"></dt> 
							<dd> 
								<input type="text" class="input" name="LOTA08" UIInput="SR" value="OD" readonly="readonly"/> 
							</dd> 
						</dl> 
						<dl>  <!--유통기한-->  
							<dt CL="STD_LOTA13"></dt> 
			...
			<div class="search_next_wrap">
				<div class="content_layout tabs">
					<ul class="tab tab_style02">
						...
						<li><a href="#tab1-7" onclick="moveTab($(this));"><span id="atab1-1">유통기한별 장기재고</span></a></li>
					</ul>
