...
<script type="text/javascript">
	...
	function saveData(){
		if(gridList.validationCheck("gridHeadList", "select")){
			...
			netUtil.send({
				url : "/outbound/json/saveSH02.data",
				param : param,
	...
	function deleteData(){
		if(gridList.validationCheck("gridHeadList", "select")){
			...
			netUtil.send({
				url : "/outbound/json/saveSH01Cancel.data",
				param : param,
			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>
						<dt CL="STD_SEBELN"></dt>
						<dd>
							<input type="text" class="input" name="H.SVBELN" UIInput="SR"/>
						</dd>
					</dl>
					<dl>
						<dt CL="STD_EXPTNK"></dt>
						<dd>
							<input type="text" class="input" name="H.PTNRKY" UIInput="SR"/>
						</dd>
					</dl>
					<dl>
						<dt CL="STD_PGRC04"></dt>
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									<tr CGRow="true">
										...
										<td GH="140 STD_EXPTNK" GCol="text,DPTNNM"></td>
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
										<td GH="40" GCol="rownum">1</td>
										<td GH="40" GCol="rowCheck"></td>
										<td GH="100 STD_SHPOIT"  GCol="text,SHPOIT"></td>
										<td GH="100 STD_STATIT"  GCol="text,STATNM"></td>
										<td GH="140 STD_SKUKEY"  GCol="text,SKUKEY"></td>
										<td GH="250 STD_DESC01"  GCol="text,DESC01"></td>
										<td GH="100 STD_QTSIWH"  GCol="text,QTSIWH" GF="N 20"></td>
										<td GH="100 STD_QTYORD"  GCol="text,QTSHPO" GF="N 20"></td>
										<td GH="100 STD_QTTAOR"  GCol="input,QTTAOR" GF="N 20"></td>
										<td GH="100 STD_QTALOC"  GCol="text,QTALOC" GF="N 20"></td>
										<td GH="100 STD_QTJCMP"  GCol="text,QTJCMP" GF="N 20"></td>
										<td GH="100 STD_QTSHPD"  GCol="text,QTSHPD" GF="N 20"></td>
										<td GH="100 STD_UOMKEY"  GCol="text,UOMKEY"></td>	
										<td GH="140 STD_SEBELN"  GCol="text,SVBELN"></td>
										<td GH="100 STD_SEBELP"  GCol="text,SPOSNR"></td>
									</tr>
								</tbody>
							</table>
						</div>
