...
public class User implements Serializable {
	...
	private String mmenugid;
	private String llogownm;
	...
	public String getMmenugid() {
		return mmenugid;
	}

	public void setMmenugid(String mmenugid) {
		this.mmenugid = mmenugid;
	}
	

	public String getLlogownm() {
		return llogownm;
	}

	public void setLlogownm(String llogownm) {
		this.llogownm = llogownm;
	}
