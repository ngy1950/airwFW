...
<script type="text/javascript">
	...
	function commonBtnClick(btnName) {
		if (btnName == "Search") {
			...
			sajoUtil.openSaveVariantPop("searchArea", "OY28");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "OY28");
		} 
	}
	...
	function searchList(gridId, param){
		...
		if(getSingleRangeData('SW.WAREKY')[0] != null || getSingleRangeData('SW.WAREKY')[0] != ''){
			param.put("WAREKY",getSingleRangeData('SW.WAREKY')[0]);
		}
		...
		netUtil.send({
			url : "/OyangOutbound/json/displayOY28.data",
			param : param,
			sendType : "list",
	...
	function searchHelpEventOpenBefore(searchCode, multyType, $inputObj, rowNum){
        ...
        }else if(searchCode == "SHCMCDV" && $inputObj.name == "SW.WAREKY" ){
				...
				<div class="search_inner">
					<div class="search_wrap ">
						...
						<dl>  <!--거점-->  
							<dt CL="STD_WAREKY"></dt> 
							<dd> 
								<input type="text" class="input" name="SW.WAREKY" id="WAREKY" UIInput="SR,SHCMCDV" value = "<%=wareky %>"/> 
							</dd> 
						</dl> 
						<dl>  <!--입/출고실적만 조회 -->  
								...
								<table class="table_c">
									<tbody id="gridList1">
										<tr CGRow="true">                                     
				    						...
				    						<td GH="80 STD_WEIGHT" GCol="text,NETWGT" GF="S 20">중량</td>	<!--중량-->
				    						...
				    						<td GH="80 STD_QTSHPD2" GCol="text,QTSHPD2" GF="N 20,0">위탁이고</td>	<!--위탁이고-->
				    						<td GH="80 STD_QTSHPD2_BOX" GCol="text,SHPBOX2" GF="N 20,1">위탁이고(BOX)</td>	<!--위탁이고(BOX)-->
				    						<td GH="80 STD_STKQTY2" GCol="text,STKQTY2" GF="N 20,0">상온위탁 당일재고(SD01)</td>	<!--상온위탁 당일재고(SD01)-->
				    						<td GH="80 STD_STKBOX2" GCol="text,STKBOX2" GF="N 20,1">상온위탁 당일재고(BOX)</td>	<!--상온위탁 당일재고(BOX)-->
										</tr>
									</tbody>
								</table>
							</div>
