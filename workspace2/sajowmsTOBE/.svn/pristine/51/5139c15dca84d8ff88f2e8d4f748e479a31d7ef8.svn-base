        ...
        <div class="search_next_wrap">
			<div class="content_layout tabs">
				<ul class="tab tab_style02">
					<li onclick="moveTab(0);"><a href="#tab1-1"><span>지시</span></a></li>
					<li onclick="moveTab(1);"><a href="#tab1-2"><span>완료</span></a></li>
					<li onclick="moveTab(2);"><a href="#tab1-3"><span>결과</span></a></li>
							...
							<table class="table_c">
								<tbody id="gridTaskList">
									<tr CGRow="true">
										...
										<td GH="140 STD_LOCATG"  GCol="input,LOCATG" GF="U 20"></td>	
