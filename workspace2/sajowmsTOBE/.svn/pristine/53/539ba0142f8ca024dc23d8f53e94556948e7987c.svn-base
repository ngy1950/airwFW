	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_SYSLABEL"></th>
						<td>
							<input type="text" name="SYSLABEL" IAname="SYSLABEL"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,LABELGID"></td>
												<td GH="140" GCol="input,LABELID"></td>
												<td GH="140" GCol="input,LANGCODE"></td>
												<td GH="140" GCol="input,LABEL"></td>
												<td GH="140" GCol="input,LABELTYPE"></td>
