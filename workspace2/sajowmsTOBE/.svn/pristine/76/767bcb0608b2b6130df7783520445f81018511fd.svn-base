...
<script type="text/javascript">
    ...
    function gridListEventDataBindEnd(gridId, dataLength, excelLoadType) {
    	if(gridId == "gridItemList"){
            gridList.setReadOnly(gridId, true,["RSNADJ"]);
    	}
    }
</script>
</head>
			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>
						<dt CL="STD_SADJKY"></dt>
						<dd>
							<input type="text" class="input" name="SADJKY"  UIFormat="U"/>
						</dd>
					</dl>
				</div>
				<div class="btn_tab">
								...
								<table class="table_c">
									<tbody id="gridList">
										<tr CGRow="true">
											...
											<td GH="100" GCol="text,ADJUTY"></td>
											<td GH="100" GCol="text,ADJSTX"></td>
<!-- 											<td GH="100" GCol="text,DOCDAT" GF="C 8"></td> -->
											<td GH="100" GCol="text,DOCTXT" GF="S 1000"></td>
...
<!-- 											<td GH="40"  GCol="rowCheck"></td> -->
											...
											<td GH="100" GCol="text,QTADJU" GF="N 20" validate="required max(GRID_COL_QTSIWH_* min(1)"></td>
											<td GH="100" GCol="text,DUOMKY"></td>
											<td GH="100" GCol="select,RSNADJ" validate="required">
												<select Combo="Common,RSNCD_COMBO" ComboCodeView="false">
													<option value=""></option>
												</select>
											</td>
											<td GH="100" GCol="text,ADJRSN"  GF="S 255"></td>
