...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		gridList.setReadOnly("gridHeadList", true, ["N00105"]);
		gridList.setReadOnly("gridItemList", true, ["SHPMTY", "N00105"]);
		gridList.setReadOnly("gridItemList2", true, ["SHPMTY", "N00105"]);
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "OY14");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "OY14");
		}
	}
	...
	function saveData(){
		...
		param.put("head",head);
	 	...
	 	netUtil.send({
			url : "/OyangOutbound/json/saveOY14.data",
			param : param,
			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>  <!--납품요청일-->  
						<dt CL="STD_VDATU"></dt> 
						<dd> 
							<input type="text" class="input" name="OTRQDT" UIFormat="C N" validate="required(STD_VDATU)"/> 
						</dd> 
					</dl> 
					<dl>  <!--주문차수-->  
						<dt CL="STD_N00105"></dt> 
								...
								<table class="table_c">
									<tbody id="gridHeadList">
										<tr CGRow="true">
				    						...
				    						<td GH="100 IFT_N00105" GCol="select,N00105"><!--차수-->
												<select class="input" commonCombo="N00105"></select> 
				    						</td>	
				    						<td GH="70 STD_DPTCNT" GCol="text,SUMQTY" GF="N 10,0">거래처수</td>	<!--거래처수-->
				    						<td GH="70 STD_SHPCOM" GCol="text,ALLOCCNT" GF="N 10,0">출고완료</td>	<!--출고완료-->
								...
								<table class="table_c">
									<tbody id="gridItemList2">
										<tr CGRow="true">
				    						...
				    						<td GH="100 IFT_N00105" GCol="select,N00105"><!--차수-->
												<select class="input" commonCombo="N00105"><option></option></select> 
				    						</td>	
