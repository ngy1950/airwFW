...
var param = null;
	...
	function commonBtnClick(btnName){
		if (btnName == 'Savevariant') {
			sajoUtil.openSaveVariantPop("searchArea", "RL33");
		} else if (btnName == 'Getvariant') {
			sajoUtil.openGetVariantPop("searchArea", "RL33");
			...
			<div class="search_inner" id="searchArea">
				<div class="search_wrap ">
					...
					<dl>  <!-- 조정문서 유형 -->  
						<dt CL="STD_ADJUTY"></dt> 
						<dd> 
							<input type="text" class="input" name="h.adjuty" UIInput="SR" value="998" readonly/> 
						</dd> 
					</dl> 
					...
					<dl>  <!-- 조정사유코드 -->  
						<dt CL="STD_RSNADJ"></dt> 
						<dd> 
							<input type="text" class="input" name="i.rsnadj" UIInput="SR"/> 
						</dd> 
					</dl> 
