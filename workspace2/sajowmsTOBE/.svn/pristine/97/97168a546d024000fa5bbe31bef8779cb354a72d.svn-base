	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_SYSMESSAGE"></th>
						<td>
							<input type="text" name="SYSMESSAGE" IAname="SYSMESSAGE"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,MESSAGEGID"></td>
												<td GH="140" GCol="input,MESSAGEID"></td>
												<td GH="140" GCol="input,LANGCODE"></td>
												<td GH="140" GCol="input,MESSAGE"></td>
												<td GH="150" GCol="input,MESSAGETYPE"></td>
