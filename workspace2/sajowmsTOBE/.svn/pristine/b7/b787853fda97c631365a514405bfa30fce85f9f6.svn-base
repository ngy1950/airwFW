...
<script type="text/javascript">
	...
	function commonBtnClick(btnName) {
		if (btnName == "Search") {
			...
			sajoUtil.openSaveVariantPop("searchArea", "DR18");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DR18");
		}
	}
	...
	function saveData() {
		...
		if (gridList.validationCheck("gridList", "data")) { 
			...
			netUtil.send({
				url : "/daerimDASController/json/saveDR18.data",
				param : param,
								...
								<table class="table_c">
									<tbody id="gridList">
										<tr CGRow="true">
				    						...
				    						<td GH="80 STD_DASTYP" GCol="select,DASTYP">	<!--DAS유형-->
