...
var mode = '';
	...
	function saveData(){
		if(gridList.validationCheck("gridList", "all")){
			...
			netUtil.send({
				url : "/mobile/mobileInventory/json/saveMSD02.data",
				param : param,
...
<body>
	...
	<div class="mobile_order">
		...
		<div class="m_menutitle"><span>수시조정</span></div>
			...
			<div class="mobile-data-box">
				<div class="content_layout_wrap" id="searchArea">
					<table>
						<tbody>
							<tr>
								<th CL="STD_BARCODE">바코드<span class="make">*</span></th>
								<td><input type="text" id="BARCODE" name="BARCODE" class="input input-width" validate="required(STD_BARCODE)" /></td>
							</tr>
							<tr>
						...
						<table>
							<tbody id="gridList">
								<tr CGRow="true">
									...
									<td GH="40 STD_QTSIWH" GCol="text,QTSIWH" GF="N 13,1"></td>  <!-- 재고수량 -->
									<td GH="40 STD_QTYWRK" GCol="input,QTYWRK" GF="N 13,1"></td>  <!-- 작업수량 -->
									<td GH="40 STD_QTDUOM" GCol="text,QTDUOM" GF="N 13,1"></td>  <!-- 입수 -->
									<td GH="40 STD_BOXQTY" GCol="text,BOXQTY" GF="N 13,1"></td>  <!-- 박스수량 -->
