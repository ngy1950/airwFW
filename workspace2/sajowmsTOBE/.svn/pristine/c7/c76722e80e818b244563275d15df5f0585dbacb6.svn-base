...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var data = page.getLinkPageData("DL24");
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "DL36");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DL36");
		...
		<div class="content_serch" id="searchArea">
			<div class="btn_wrap">
				...
				<div class="fl_r">
					...
					<input type="button" CB="Confirm SAVE BTN_CFMREP" />
					<input type="button" CB="Save DELETE BTN_DELETE" />
					<input type="button" CB="Print PRINT BTN_REPPRINT_COS" /> <!-- (담당자)-->
			...
			<div class="search_inner" id="searchArea">
				<div class="search_wrap ">
                    ...
                    <dt CL="STD_CARDAT"></dt> 
	                    <dd> 
						  <input type="text" class="input" id="CARDAT" name="SR.CARDAT" UIFormat="C 1"/> 
	                    </dd> 
	                  </dl> 
	                  <dl>  <!--배송차수-->  
			              <dt CL="STD_SHIPSQ"></dt> 
...
<!-- 						<dt CL="STD_WORKNM"></dt>  -->
<!-- 						<dd>  -->
<!-- 							<input type="text" class="input" name="WORKNM" UIInput="SR"/>  -->
<!-- 						</dd>  -->
<!-- 					</dl>  -->
				</div>
				<div class="btn_tab">
						...
						<div class="scroll">
							<table class="table_c">
								<tbody id="gridItem01List">
									<tr CGRow="true">
										<td GH="40 STD_NUMBER"           GCol="rownum">1</td>   
			    						<td GH="50 STD_TASKKY" GCol="text,TASKKY" GF="S 100">작업지시번호</td>	<!--작업지시번호-->
			    						<td GH="50 STD_TASKIT" GCol="text,TASKIT" GF="S 10">작업오더아이템</td>	<!--작업오더아이템-->
			    						...
			    						<td GH="88 STD_SORTSQ" GCol="text,SORTSQ" GF="S 60,0">배송순서</td>	<!--배송순서-->
