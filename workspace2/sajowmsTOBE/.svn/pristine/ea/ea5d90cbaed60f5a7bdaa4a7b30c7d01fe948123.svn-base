...
<script type="text/javascript">
	...
	$(".lnb_wrap").css("height", "calc(100vh - 104px)");
...
<div class="tab_wrap"> 
 ...
 <div class="tab_container">
    <fieldset>
		...
		<p class="search_box">
		<input type="text" class="serch_input" id="menuSearch" placeholder="메뉴명" onkeypress="commonUtil.enterKeyCheck(event,'menuSearch()')"/>
		<button type="button" class="btn btn_search" onclick="menuSearch()"><span>메뉴명</span></button>
		<div class="sort_box">		
			<button type="button" class="btn_asc"></button>
...
<script type="text/javascript">
	...
	$menuList.find('[AMNUID=root]').each(function(index,findElement){
	...
	*/
	...
	if($menuList.find('[AMNUID=root]').length == 1){
		$menuList.find('[AMNUID=root]').eq(0).addClass("open");
	}
</script>
<!-- // left_wrap -->
</body>
