...
var mode = '';
	$(document).ready(function(){
		...
		$("#SVBELN").focus();
		$("#SVBELN").keyup(function(e){if(e.keyCode == 13)searchList();});
		
// 		//검색값 클릭시 초기화
		$("#SVBELN").click(function(){$(this).select()}) 
// 		//지번 클릭시 초기화
	...
	function searchList(){
		if(validate.check("searchArea")){
			...
			if ($("#SVBELN").val() == null || $("#SVBELN").val() == ""){
				commonUtil.msgBox("* 반품오더를 입력해주세요 *");
				return;
			}
	...
	function saveData(){
		if(gridList.validationCheck("gridList", "all")){
			...
			param.put("JOBTYP", "131");			
			
			netUtil.send({
				url : "/mobile/MobileInbound/json/saveMGR04.data",
				param : param,
...
<body>
	...
	<div class="mobile_order">
		...
		<div class="m_menutitle"><span>매출반품입하</span></div>
			...
			<div class="mobile-data-box">
				<div class="content_layout_wrap" id="searchArea">
					<table>
						<tbody>
							<tr>
								<th CL="STD_RETNOD">반품오더<span class="make">*</span></th>
								<td><input type="text" id="SVBELN" name="SVBELN" class="input input-width"></td>
							</tr>
							<tr>
						...
						<table>
							<tbody id="gridList">
								<tr CGRow="true">
									...
									<td GH="50 STD_QTYWRK" GCol="input,QTYWRK" GF="N 13,1"></td>  <!-- 작업수량 -->
									<td GH="40 STD_QTDUOM" GCol="text,QTDUOM" GF="N 13,1"></td>  <!-- 입수 -->
									<td GH="50 STD_BOXQTY" GCol="text,BOXQTY" GF="N 13,1"></td>  <!-- 박스수량 -->
