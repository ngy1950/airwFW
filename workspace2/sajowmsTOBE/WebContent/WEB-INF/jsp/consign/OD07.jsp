...
<script type="text/javascript">
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			Print2(); 
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "OD07");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "OD07");
 		}
	}
	...
	function returnSAVE(json, status) {
		...
		orderbystr += getMultiRangeDataSQLEzgen('IT.DOCUTY', 'I.DOCUTY');	
		orderbystr += getMultiRangeDataSQLEzgen('IT.DIRSUP', 'I.DIRSUP');	
		orderbystr += getMultiRangeDataSQLEzgen('IT.DIRDVY', 'I.DIRDVY');	
		orderbystr += getMultiRangeDataSQLEzgen('IT.TEXT02', 'I.TEXT02');	
		orderbystr += getMultiRangeDataSQLEzgen('IT.OTRQDT', 'I.OTRQDT');	
		orderbystr += getMultiRangeDataSQLEzgen('IT.PTNROD', 'I.PTNROD');	
		orderbystr += getMultiRangeDataSQLEzgen('IT.PTNRTO', 'I.PTNRTO');	
		orderbystr += getMultiRangeDataSQLEzgen('SM.ASKU05', 'SM.ASKU05');	
	...
	function Print2(){  /* 거래처명세표(해표ASN), 제품 피킹(낱개박스추가) */
	...
	function gridListEventColBtnClick(gridId, rowNum, colName) {
		if(colName == "BTN_ASNINST"){
			...
			var option = "height=800,width=1300,resizable=yes,help=no,status=no";
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									<tr CGRow="true">
			    						...
			    						<td GH="100 STD_ASNINST" Gcol="btn,BTN_ASNINST" GB="USERCOPY SAVE STD_ASNINST"></td> <!--ASN정보입력-->
									</tr>
								</tbody>
							</table>
						</div>
