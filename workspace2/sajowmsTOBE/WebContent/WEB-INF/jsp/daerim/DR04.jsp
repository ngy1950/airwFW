...
<script type="text/javascript">
	...
	function commonBtnClick(btnName) {
		if (btnName == "Search") {
			...
			sajoUtil.openSaveVariantPop("searchArea", "DR04");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DR04");
		} 
	}	
								...
								<table class="table_c">
									<tbody id="gridList1">
										<tr CGRow="true">               
				    						...
				    						<td GH="180 STD_DESC01" GCol="text,SKUNM" GF="S 30">제품명</td>	<!--제품명-->
				    						<td GH="80 STD_DESC02" GCol="text,SKUNM2" GF="S 20">규격</td>	<!--규격-->
