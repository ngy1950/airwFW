...
<script type="text/javascript">
	...
	function commonBtnClick(btnName) {
		if (btnName == "Search") {
			...
			sajoUtil.openSaveVariantPop("searchArea", "DR23");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DR23");
		} 
	}
	...
	function searchList(gridId, param){
		...
		if($("#CHKMAK").prop("checked") == true) param.put("CHKMAK", "CHK");
								...
								<table class="table_c">
									<tbody id="gridList1">
										<tr CGRow="true">                                     
				    						...
				    						<td GH="200 STD_RATENM"   GCol="select,SKUG03">
