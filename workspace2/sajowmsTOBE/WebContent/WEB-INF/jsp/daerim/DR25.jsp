...
<script type="text/javascript">
	...
	function commonBtnClick(btnName) {
		if (btnName == "Search") {
			...
			sajoUtil.openSaveVariantPop("searchArea", "DR25");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DR25");
		} 
	}
	...
	function saveData() {
		...
		netUtil.send({
			url : "/daerimOutbound/json/saveDR25.data",
			param : param,
				...
				<div class="search_inner">
					<div class="search_wrap ">
						...
						<dl>  <!--기준일자-->  
							<dt CL="STD_STDDAT"></dt> 
							<dd> 
								<input type="text" class="input" name="STDDAT" id="STDDAT" UIFormat="C N" validate="required(STD_STDDAT)"/> 
							</dd> 
						</dl> 
						<dl>  <!--제품코드-->  
							<dt CL="IFT_SKUKEY"></dt> 
								...
								<table class="table_c">
									<tbody id="gridList1">
										<tr CGRow="true">                                     
				    						...
				    						<td GH="60 ITF_WAREKY" GCol="text,WAREKY" GF="S 20">거점코드</td>	<!--거점코드-->
				    						<td GH="100 STD_WANAME" GCol="text,NAME01" GF="S 20">거점명</td>	<!--거점명-->
				    						<td GH="60 STD_SKUKEY" GCol="text,SKUKEY" GF="S 20">제품코드</td>	<!--제품코드-->
				    						<td GH="180 STD_DESC01" GCol="text,DESC01" GF="S 30">제품명</td>	<!--제품명-->
				    						<td GH="60 STD_DESC02" GCol="text,DESC02" GF="S 20">규격</td>	<!--규격-->
				    						<td GH="80 STD_STDQTY" GCol="text,PREQTY" GF="N 20,0">전일재고</td>	<!--전일재고-->
				    						<td GH="80 STD_QTYASN2" GCol="text,QTYASN" GF="N 20,0">입고예정수량(ASN)</td>	<!--입고예정수량(ASN)-->
				    						<td GH="80 STD_QTYTRF2" GCol="text,QTYTRF" GF="N 20,0">입고예정수량(이고)</td>	<!--입고예정수량(이고)-->
				    						<td GH="80 STD_QTYREQ2" GCol="text,QTYREQ" GF="N 20,0">입고예정수량(부산)</td>	<!--입고예정수량(부산)-->
				    						<td GH="80 STD_PRDQTY2" GCol="text,PRDQTY" GF="N 20,0">입고예정수량(생산)</td>	<!--입고예정수량(생산)-->
				    						<td GH="80 STD_QTYRCV4" GCol="text,QTYRCV" GF="N 20,0">입고완료수량</td>	<!--입고완료수량-->
				    						<td GH="80 STD_QTSHPD_1" GCol="text,QTSHPD" GF="N 20,0">출고수량(출고지시)</td>	<!--출고수량(출고지시)-->
				    						<td GH="80 STD_QTSHPD_2" GCol="text,QTSHPD2" GF="N 20,0">출고수량(미확정)</td>	<!--출고수량(미확정)-->
				    						<td GH="80 STD_QTJCMP2" GCol="text,QTSHPD3" GF="N 20,0">출고완료수량</td>	<!--출고완료수량-->
				    						<td GH="80 STD_ADJQTY1" GCol="text,ADJQTY1" GF="N 20,0">SET조립/해체</td>	<!--SET조립/해체-->
				    						<td GH="80 STD_ADJQTY2" GCol="text,ADJQTY2" GF="N 20,0">M-TO-M</td>	<!--M-TO-M-->
				    						<td GH="80 STD_GRDOCUTY_06" GCol="text,PHYQTY" GF="N 20,0">재고조정수량</td>	<!--재고조정수량-->
				    						<td GH="80 STD_STKQTY_EA" GCol="text,STKQTY" GF="N 20,0">당일재고(EA)</td>	<!--당일재고(EA)-->
				    						<td GH="80 STD_QTSIWH_SD01" GCol="text,QTSIWH" GF="N 20,0">현재고(SD01)</td>	<!--현재고(SD01)-->
				    						<td GH="85 STD_DIFQTY" GCol="text,QTYDIF" GF="N 20,0">차이수량</td>	<!--차이수량-->
										</tr>
									</tbody>
								</table>
							</div>
							...
							<div class="scroll">
								<table class="table_c">
									<tbody id="gridList2">
										<tr CGRow="true">                   
				    						<td GH="40 STD_NUMBER"           GCol="rownum">1</td>   
				    						<td GH="60 STD_MONTH" GCol="text,VMONTH" GF="S 20">월</td>	<!--월-->
							...
							<div class="scroll">
								<table class="table_c">
									<tbody id="gridList3">
										<tr CGRow="true">
				    						<td GH="40 STD_NUMBER"           GCol="rownum">1</td>   
				    						<td GH="80 STD_DAY" GCol="text,VDAY" GF="D 20">일</td>	<!--일-->
				    						<td GH="80 ITF_WAREKY" GCol="text,WAREKY" GF="S 20">거점코드</td>	<!--거점코드-->
				    						<td GH="120 STD_WANAME" GCol="text,NAME01" GF="S 20">거점명</td>	<!--거점명-->
				    						<td GH="80 STD_SKUKEY" GCol="text,SKUKEY" GF="S 20">제품코드</td>	<!--제품코드-->
				    						<td GH="180 STD_DESC01" GCol="text,DESC01" GF="S 30">제품명</td>	<!--제품명-->
				    						...
				    						<td GH="80 STD_QTJCMP2" GCol="text,QTSHPD3" GF="N 20,0">출고완료수량</td>	<!--출고완료수량-->
				    						<td GH="80 STD_ADJQTY1" GCol="text,ADJQTY1" GF="N 20,0">SET조립/해체</td>	<!--SET조립/해체-->
				    						<td GH="80 STD_ADJQTY1" GCol="text,ADJQTY2" GF="N 20,0">M-TO-M</td>	<!--M-TO-M-->
				    						<td GH="80 STD_GRDOCUTY_06" GCol="text,PHYQTY" GF="N 20,0">재고조정수량</td>	<!--재고조정수량-->
				    						<td GH="80 STD_STKQTY_EA" GCol="text,STKQTY" GF="N 20,0">당일재고(EA)</td>	<!--당일재고(EA)-->
										</tr>
									</tbody>
