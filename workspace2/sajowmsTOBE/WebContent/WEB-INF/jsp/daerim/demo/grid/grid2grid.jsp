...
<script type="text/javascript">
	...
	function moveData(){
		var selectDataList = gridList.getSelectData("gridList", true);
		if(selectDataList && selectDataList.length > 0){
			gridList.setRowFocus("gridList2", 100, false);
			var rowData;
			var rowNum;
			for(var i=0;i<selectDataList.length;i++){
				rowData = selectDataList[i];
				rowNum = rowData.get(configData.GRID_ROW_NUM);
				gridList.addFocusRow("gridList2", rowData, false);
