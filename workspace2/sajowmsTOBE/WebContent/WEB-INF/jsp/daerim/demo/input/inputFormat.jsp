			...
			<div class="search_inner">
				<div class="search_wrap ">
					<dl>
						<dt CL="Number"></dt>
						<dd>
							<input type="text" class="input" name="Number" UIFormat="N 20,3"/>
						</dd>
					</dl>
					<dl>
						<dt CL="Date"></dt>
						<dd>
							<input type="text" class="input" name="Calendar" UIFormat="D" />
						</dd>
					</dl>
					<dl>
						<dt CL="Uppercase"></dt>
						<dd>
							<input type="text" class="input" name="Uppercase" UIFormat="U"/>
						</dd>
					</dl>
					<dl>
						<dt CL="Comcode"></dt>
						<dd>
							<input type="text" class="input" name="Comcode" UIFormat="COM_CODE"/>
						</dd>
					</dl>					
				</div>
				<div class="btn_tab">
