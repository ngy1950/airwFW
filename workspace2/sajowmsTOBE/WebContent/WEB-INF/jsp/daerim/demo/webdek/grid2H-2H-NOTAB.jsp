...
<div class="content_wrap">
	<div class="content_inner contentH_inner">
        ...
        <div class="search_next_wrap">
			<div class="content-horizontal-wrap h-wrap-min top_layout">
				<div class="content_layout tabs content_left">
					<ul class="tab tab_style02">
						<li><a href="#tab1-1"><span>타이틀 1</span></a></li>
				...
				<div class="content_layout tabs content_right">
					<ul class="tab tab_style02">
						<li><a href="#tab1-1"><span>타이틀 2</span></a></li>
						<li class="btn_zoom_wrap">
							<ul>
								<!-- <li><button class="btn btn_smaller"><span>축소</span></button></li> -->
								<li><button class="btn btn_bigger"><span>확대</span></button></li>
			...
			<div class="content-horizontal-wrap h-wrap-min bottom_layout">
				<div class="content_layout tabs content_left">
					<ul class="tab tab_style02">
						<li><a href="#tab1-1"><span>타이틀 3</span></a></li>
						<li class="btn_zoom_wrap">
							<ul>
								<!-- <li><button class="btn btn_smaller"><span>축소</span></button></li> -->
								<li><button class="btn btn_bigger"><span>확대</span></button></li>
				...
				<div class="content_layout tabs content_right">
					<ul class="tab tab_style02">
						<li><a href="#tab1-1"><span>타이틀 4</span></a></li>
						<li class="btn_zoom_wrap">
							<ul>
								<!-- <li><button class="btn btn_smaller"><span>축소</span></button></li> -->
								<li><button class="btn btn_bigger"><span>확대</span></button></li>
