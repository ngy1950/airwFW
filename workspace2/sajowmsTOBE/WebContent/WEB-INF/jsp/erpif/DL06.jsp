...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//콤보박스 리드온리
		gridList.setReadOnly("gridHeadList", true, ["OWNRKY", "WARESR", "DOCUTY","DIRDVY", "DIRSUP", "ORDTYP","PTNG08","C00102"]);
...
//		    });
	...
	function cancelAccept(){		
       ...
       var param = new DataMap();
		...
		netUtil.send({
			url : "/outbound/json/cancelAcceptDL06.data",
			param : param,
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "DL06");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DL06");
		}
	}
			...
			<div class="search_inner" id="searchArea">
				<div class="search_wrap ">
					...
					<dl>  <!--요청수량(BOX)-->  
						...
						<dd> 
							<input type="text" class="input" name="I.QTYREM" UIInput="SR"/> 
						</dd> 
					</dl> 
					<dl>  <!--요청수량(낱개)-->  
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
			    						...
			    						<td GH="80 STD_PLTBOX" GCol="text,PLTBOX" GF="N 17">PLT별BOX적재수량</td>	<!--PLT별BOX적재수량-->
			    						...
			    						<td GH="80 STD_REMQTY" GCol="text,REMQTY" GF="N 17">잔량</td>	<!--잔량-->
									</tr>
								</tbody>
							</table>
						</div>
