...
<script type="text/javascript">
	...
	$(window).load(function(){
		...
		%>
		var bgDiv = "<div class='bgDiv' style='height:"+wh+"px;width:"+ww+"px;position:fixed;bottom:0;right:0; z-index:-1;background:url(/common/theme/webdek/images/bg_full.png) repeat center center;'></div>";
		<%
			}
		%>
	...
	$(document).ready(function(){
		...
		//2020.07.30 NSH 서버 반영 공지 팝업 호출
		page.linkPopOpen("/gcim/server_deploy.page", null,"height=600,width=500,resizeble=no");
	});
	...
	function reloadInfo(pmenuId){
		//frames.left.reloadPage();
		frames.main.location.href="/gcim/<%=compky%>_"+pmenuId+".data";
	}
...
<frameset id="topFrame" name="topFrame" rows="80px,*" noresize framespacing=0 frameborder=no border=0 >
    <frame id="header" name="header" src="/gcim/top.data" noresize framespacing=0 frameborder=no border=0 scrolling="no">
    <frameset id="middleFrame" name="middleFrame" cols="280px,*" noresize framespacing=0 frameborder=no border=0 >
        ...
        <frame id="left" name="left" src="/gcim/left.data" name="lnb" noresize framespacing=0 frameborder=no border=0>
        <frameset id="rightFrame" name="rightFrame" rows="40px,*,0,0,0,0,0" noresize framespacing=0 frameborder=no border=0 >
			...
			<frame id="main" name="main" src="/gcim/info.page" noresize framespacing=0 frameborder=no border=0>
