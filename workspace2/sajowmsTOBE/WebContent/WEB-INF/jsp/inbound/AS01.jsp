...
<script type="text/javascript">
	...
	function saveData(){
		if(gridList.validationCheck("gridList", "modifiy")){
			...
			netUtil.send({
				url : "/inbound/json/saveAS01.data",
				param : param,
	...
	function commonBtnClick(btnName){
		if(btnName == "Save"){
			saveData();
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "AS01");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "AS01");
 		}
	}
							...
							<table class="table_c">
								<tbody id="gridList">
									<tr CGRow="true">
										...
										<td GH="140 STD_RCPTTY"  GCol="input,ASNTTY"></td>
										<td GH="140 STD_SEBELN"  GCol="input,SEBELN"></td>
										<td GH="140 STD_SZMBLNO" GCol="input,SZMBLNO"></td>
										<td GH="140 STD_DPTNKY1" GCol="input,PTNRKY"></td>
										<td GH="140 STD_ORDMVNO" GCol="input,SVBELN"></td>
										<td GH="140 STD_ORDITM"  GCol="input,SEBELP"></td>
										...
										<td GH="140 STD_SRLNUM"  GCol="input,SZMIPNO"></td>
										<td GH="140 STD_LGSNUM"  GCol="input,STDLNR"></td>
										<td GH="140 STD_LOTA01"  GCol="input,LOTA01"></td>
