...
<script type="text/javascript">
	...
	function saveData(){
		if(gridList.validationCheck("gridList", "modifiy")){
			...
			netUtil.send({
				url : "/inbound/json/saveAS02.data",
				param : param,
	...
	function commonBtnClick(btnName){
		if(btnName == "Save"){
			saveData();
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "AS02");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "AS02");
 		}
	}
							...
							<table class="table_c">
								<tbody id="gridList">
									<tr CGRow="true">
										...
										<td GH="140 STD_ASNPRD"  GCol="input,SEBELN"></td>
										<td GH="140 STD_ASNPIT"  GCol="input,SEBELP"></td>
										<td GH="140 STD_BZPFCT"  GCol="input,PTNRKY"></td>
