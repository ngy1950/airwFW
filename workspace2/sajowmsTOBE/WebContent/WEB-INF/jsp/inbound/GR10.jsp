	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			print();
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "GR10");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "GR10");
		}
	}
...
<!-- 										<td GH="100 STD_CUSRNM" GCol="text,CUSRNM" GF="S 50">생성자명</td>	생성자명 -->
										...
										<td GH="100 STD_ORDQTY" GCol="text,ORDQTY" GF="N 17,0">지시수량</td>	<!--지시수량-->
										...
										<td GH="100 STD_OUTDMT" GCol="text,OUTDMT" GF="N 20,0" validate="required">로케이션>유통기한(일수)</td>	<!--유통기한(일수)-->
