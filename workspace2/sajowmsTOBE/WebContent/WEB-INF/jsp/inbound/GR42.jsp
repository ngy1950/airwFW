...
<script type="text/javascript">
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			print();
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "GR42");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "GR42");
 		}
	}
	...
	function print(){
		if(gridList.validationCheck("gridHeadList", "select")){
			...
			var xstat = "D";  //구버전에 입력되어있으나 이지젠에 주석처리 되어있음!
	...
	function searchHelpEventOpenBefore(searchCode, multyType, $inputObj, rowNum){
		...
		//제품코드
    		...
    		rangeDataMap.put(configData.INPUT_RANGE_SINGLE_DATA, "131");
    		//배열에 맵 탑제 
    		rangeArr.push(rangeDataMap);
    	 	
    		rangeDataMap = new DataMap();
    		rangeDataMap.put(configData.INPUT_RANGE_OPERATOR,"="); // =  != > < 표시
    		rangeDataMap.put(configData.INPUT_RANGE_SINGLE_DATA, "134");
    		rangeArr.push(rangeDataMap); 
    	 	
    		rangeDataMap = new DataMap();
    		rangeDataMap.put(configData.INPUT_RANGE_OPERATOR,"="); // =  != > < 표시
    		rangeDataMap.put(configData.INPUT_RANGE_SINGLE_DATA, "135");
    		rangeArr.push(rangeDataMap); 
    	 	
    		rangeDataMap = new DataMap();
    		rangeDataMap.put(configData.INPUT_RANGE_OPERATOR,"="); // =  != > < 표시
    		rangeDataMap.put(configData.INPUT_RANGE_SINGLE_DATA, "136");
    		rangeArr.push(rangeDataMap); 

            param.put("DOCUTY", returnSingleRangeDataArr(rangeArr));
		}
		return param;
	}
...
<div class="content_wrap">
	<div class="content_inner">
		...
		<div class="content_serch" id="searchArea">
			...
			<div class="search_inner" id="searchArea"> <!-- GR42  출고반품입고조회 -->
				<div class="search_wrap ">
					...
					<dl>
						...
						<dd>
							...
							<!-- <select name="IFWMS113.DOCUTY" id="RCPTTY" class="input" comboType="MS" Combo="GoodReceipt,COMBO_RCPTTY"></select> -->
						</dd>
					</dl>
					<dl>
						<dt CL="STD_SVBELN"></dt> <!-- S/O번호-->
						<dd>
							<input type="text" class="input" name="IFWMS113.SVBELN" id="SVBELN" UIInput="SR"/>
						</dd>
					</dl>
					<dl>
						<dt CL="IFT_OTRQDT2"></dt> <!-- 출고반품일자 -->
						<dd>
							<input type="text" class="input" name="IFWMS113.OTRQDT" UIInput="B" UIFormat="C N"/>
						</dd>
					</dl>
					<dl>
						<dt CL="IFT_PTNRTO"></dt><!-- 납품처코드ㅡ -->
						<dd>
			...
			<div class="content_layout tabs top_layout">
				...
				<div class="table_box section" id="tab1-1">
					<div class="table_list01">
						<div class="scroll">
							<table class="table_c">
								<tbody id="gridHeadList"> <!-- GR42  출고반품입고 조회 Head --> 
									<tr CGRow="true">
										...
										<td GH="120 STD_RECNUM" GCol="text,CARNUM" GF="S 100">재배차 차량번호</td> <!--재배차 차량번호-->
									</tr>
								</tbody>
							</table>
						</div>
			...
			<div class="content_layout tabs bottom_layout">
				...
				<div class="table_box section" id="tab1-1" >
					<div class="table_list01">
						<div class="scroll">
							<table class="table_c">
								<tbody id="gridItemList"> <!-- GR42  출고반품입고 조회 Item --> 
									<tr CGRow="true">
										<td GH="40 STD_ROWCK" GCol="rowCheck" ></td>  
										...
										<td GH="120 STD_QTSHPD" GCol="text,QTSHPD" GF="N 17,0">출고수량</td> <!--출고수량-->
