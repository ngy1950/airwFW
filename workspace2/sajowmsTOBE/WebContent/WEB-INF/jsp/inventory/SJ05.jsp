...
<script type="text/javascript">
	$(document).ready(function(){
		...
		//콤보박스 리드온리
		gridList.setReadOnly("gridItemList", true, ["LOTA06", "TGSKUKEY", "TGLOCAKY"]); 
	...
	function commonBtnClick(btnName){
		...
		if(btnName == "Search"){
			...
			saveData();
	 		...
	 		sajoUtil.openSaveVariantPop("searchArea", "SJ05");
 		}else if(btnName == "Getvariant"){
 			sajoUtil.openGetVariantPop("searchArea", "SJ05");
 		}
	...
	function saveData(){
		if(gridList.validationCheck("gridHeadList", "select")&& gridList.validationCheck("gridItemList", "select")){
			...
			for(var i=0; i<item.length; i++){
				...
				if(itemMap.TGRSNADJ == "" || itemMap.TGRSNADJ == " "){
...
// 			}else if(colName == "LOCAKY"){ //로케이션 변경시
// 				param.put("WAREKY", $("#WAREKY").val());
...
// 	} 
	...
	function searchHelpEventOpenBefore(searchCode, multyType, $inputObj, rowNum){
		...
		//재고유형    
        }else  if(searchCode == "SHCMCDV" && $inputObj.name == "LOTA06" ){ 
			...
			<div class="search_inner" id="searchArea">
				<div class="search_wrap ">
					...
					<dl>
						...
						<dd>
							<input type="text" class="input" name="LOTA06" UIInput="SR,SHCMCDV" />
						</dd>
					</dl>
				</div>
				<div class="btn_tab">
							...
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
								        ...
								        <td GH="80 STD_FROWNRKY" GCol="text,OWNRKY" GF="S 10">From화주</td>	<!--From화주-->
								        <td GH="80 STD_TGOWNRKY" GCol="input,TGOWNRKY" GF="S 10">To화주</td>	<!--To화주-->
										<td GH="30 STD_UOMKEY" GCol="text,UOMKEY" GF="S 3">단위</td> <!--단위-->
										<td GH="60 STD_USEQTY" GCol="text,USEQTY" GF="S 20">가용수량</td> <!--가용수량--> 
								        ...
								        <td GH="80 STD_LOTA11" GCol="text,LOTA11" GF="C 8">제조일자</td> <!--제조일자-->
										...
										<td GH="80 STD_SBKTXT" GCol="text,SBKTXT" GF="S 75">비고</td> <!--비고-->
								        ...
								        <td GH="50 STD_REMQTY" GCol="text,REMQTY" GF="N 20,0">잔량</td> <!--잔량-->
