...
var mode = '';
	...
	function saveData(){
		if(gridList.validationCheck("gridList", "all")){
			...
			netUtil.send({
				url : "/mobile/mobileOutbound/json/saveMDL03.data",
				param : param,
...
<body>
	...
	<div class="mobile_order">
		...
		<div class="m_menutitle"><span>오더할당피킹완료</span></div>
					...
					<table>
						<tbody>
							<tr>
								...
								<td><input type="text" id="TASKKY" name="TASKKY" class="input input-width" validate="required(STD_DOCKEY)"></td>
							</tr>
							<tr>
						...
						<table>
							<tbody id="gridList">
								<tr CGRow="true">                  
									...
									<td GH="80 STD_LOCAKY" GCol="text,LOCASR" </td>  <!--로케이션 --> 
...
<!-- 									<td GH="60" GCol="text,OLDSKU" GF="N 13,1" </td>  품목   -->
								</tr>
							</tbody>
						</table>
					</div>
