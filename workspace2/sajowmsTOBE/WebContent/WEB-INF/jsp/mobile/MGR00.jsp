...
// 		//지번 클릭시 초기화
	...
	function saveData(){
		if(gridList.validationCheck("gridList", "all")){
			...
			param.put("JOBTYP", "151");			
			
			netUtil.send({
				url : "/mobile/MobileInbound/json/saveMGR00.data",
				param : param,
...
<body>
	...
	<div class="mobile_order">
		...
		<div class="m_menutitle"><span>생산입고(IPT)</span></div>
					...
					<table>
						<tbody>
							<tr>
								...
								<td><input type="text" id="TRNUID" name="TRNUID" class="input input-width" validate="required(STD_BACODE)"></td>
							</tr>
							<tr>
						...
						<table>
							<tbody id="gridList">
								<tr CGRow="true">
									...
									<td GH="120 STD_LOTA11" GCol="text,LOTA11" GF="D"></td> <!-- 제조일자 -->
									<td GH="120 STD_LOTA13" GCol="text,LOTA13" GF="D"></td> <!-- 유통기한 -->
									<td GH="80 STD_QTSIWH" GCol="text,QTSIWH" GF="N 13,1"></td>  <!--  재고수량? QTSIWH--> 
									...
									<td GH="80 STD_WAREKY" GCol="text,WAREKY" GF="S 20"></td>  <!-- 거점 -->
									<td GH="80 STD_LOCAKY" GCol="input,LOCAKY" GF="S 20"></td>  <!-- 로케이션 -->
									<td GH="80 STD_SKUKEY" GCol="text,SKUKEY" GF="S 20"></td>  <!-- 제품코드 -->
									<td GH="120 STD_PLBRCD" GCol="text,TRNUID" GF="S 20"></td>  <!-- 팔렛트바코드 -->
