...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		gridList.setReadOnly("gridHeadList", true, ["WARESR", "WARETG"]);
...
//			param.put('TOTALPICKING','N')
	...
	function commonBtnClick(btnName){
		if(btnName == "Search"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "DL19");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "DL19");
		}
	}
		...
		<div class="content_serch" id="searchArea">
			<div class="btn_wrap">
				...
				<div class="fl_r">
					...
					<input type="button" CB="Create SAVE BTN_SAVECRE"  id="BTN_SAVECRE"/> <!-- 출고문서 생성 -->
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									...
									<!--화면에 조회 값과 상관없이 로우 선택하는 체크박스 확인   -->
			    						...
			    						<td GH="150 IFT_WARESR" GCol="select,WARESR"><!--요구사업장-->
			    						...
			    						<td GH="120 STD_ALSTKY" GCol="select,ALSTKY"><!--할당전략키-->
											<select class="input" Combo="SajoCommon,ALSTKY_COMCOMBO">
												<option></option>
											</select>
			    						</td>
			    						<td GH="100 STD_SVBELN" GCol="text,SVBELN" GF="S 40">S/O 번호</td>	<!--S/O 번호-->
			    						<td GH="150 STD_DOCTXT" GCol="text,DOCTXT" GF="S 100">비고</td>	<!--비고-->
			    						<td GH="72 STD_PLTQTY" GCol="text,PLTQTY" GF="N 20,2">팔레트수량</td>	<!--팔레트수량-->
			    						<td GH="72 IFT_BOXQTYORG" GCol="text,DLBOX" GF="N 20,2">원주문수량</td>	<!--원주문수량-->
