  ...
  function gridListEventItemGridSearch(gridId, rowNum, itemGridList){
    if(gridId == "gridHeadList"){
	  ...
	  **/	  	  
	  ...
	  if("61" != svbeln){
			if(("266" == shpmty || "267" == shpmty) && !"SAJOSV" == ownrky){
				param.put('LOTA07','21SV')
			}
	  }	  
      ...
      if(colName == "QTTAOR" || colName == "BOXQTY" || colName == "REMQTY" || colName == "PLTQTY"){
        ...
        var remqtyChk = 0;
          ...
          if( colName == "QTTAOR" ) {   
            ...
            boxqty = ((Number)(qttaor)- (floatingFloor((Number)(pltqty), 0)*(Number)(pliqty)) ) / floatingFloor((Number)(bxiqty), 0) ;    	
          ...
          if( colName == "BOXQTY" ){ //박스수량 변경시
		  	...
		  	boxqty = ( (Number)(qttaor)- (floatingFloor((Number)(pltqty), 2)*(Number)(pliqty)) ) / floatingFloor((Number)(bxiqty), 1) ;
		  ...
		  $('#qttaorSum').text(qttaorSum);
		  $('#pltqtySum').text(pltqtySum);
		  $('#boxqtySum').text(boxqtySum);
       }
    }
  }
...
//	  gridList.setReadOnly("gridHeadList", false, ["CARNUM", "SHIPSQ", "PERHNO", "CASTIM"]);
	...
	function searchHelpEventCloseAfter(searchCode, multyType, selectData, rowData){
		if( searchCode == "VSHPOKY"){
			 $('#SHPOKY').val(rowData[0].map.SHPOKY);
		}
	}
	...
	function saveData(){ // 출고명세서 인쇄 -> saveDL51 사용
      ...
      <div class="search_inner" id="searchArea">
        <div class="search_wrap ">
          ...
          <dl>  <!--출고문서번호-->  
            <dt CL="STD_SHPOKY"></dt> 
            <dd> 
              <input type="text" class="input" name="SHPOKY" id="SHPOKY" UIInput="S,VSHPOKY" validate="required"/> 
            </dd> 
          </dl> 
        </div>
        <div class="btn_tab">
              ...
              <table class="table_c">
                <tbody id="gridHeadList">
                  ...
                  <!--화면에 조회 값과 상관없이 로우 선택하는 체크박스 확인   -->
                      ...
                      <td GH="80 STD_CARDAT" GCol="input,CARDAT" GF="C">배송일자</td>  <!--배송일자-->
                      <td GH="80 STD_CARNUM" GCol="input,CARNUM,SHCARMA2" GF="S 30">차량번호</td>  <!--차량번호-->
                      <td GH="60 STD_SHIPSQ" GCol="input,SHIPSQ" GF="N 5,0">배송차수</td> <!--배송차수-->
                ...
                <tbody id="gridItemList">
                  ...
                  <!--화면에 조회 값과 상관없이 로우 선택하는 체크박스 확인   -->
                    ...
                    <td GH="40 STD_NUMBER" GCol="rownum">1</td>   
                      ...
                      <td GH="80 STD_QTSAVLB" GCol="input,AVAILABLEQTY" GF="N 20,0">가용수량</td>  <!--가용수량-->
