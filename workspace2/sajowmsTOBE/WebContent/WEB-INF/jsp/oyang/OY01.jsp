...
<script type="text/javascript">
	...
	function commonBtnClick(btnName){
		if(btnName == "Create"){
			...
			sajoUtil.openSaveVariantPop("searchArea", "OY01");
		}else if(btnName == "Getvariant"){
			sajoUtil.openGetVariantPop("searchArea", "OY01");
		}
	}
...
/* 				
			...
			netUtil.send({
				url : "/OyangOutbound/json/saveOY01.data",
				param : param,
	...
	function gridListEventRowAddBefore(gridId, rowNum){
		...
		if(gridId == "gridHeadList"){
			//기본값 세팅 
			newData.put("ORDDAT", getSingleRangeData("V.EXPDAT")[0]);
			newData.put("OTRQDT", getSingleRangeData("V.EXPDAT")[0]);
				...
				<div class="search_wrap ">
					...
					<dl>  <!--구분자 -->
						...
						<dd style="width:350px">
							<input type="radio" class="input" id="GRPRL1" name="GRPRL" value="GRPRL1" checked /> <label for="GRPRL1">공장/센터간이고 </label>
							<input type="radio" class="input" id="GRPRL2" name="GRPRL" value="GRPRL2" /> <label for="GRPRL2" >센터간이고 </label>
						</dd>
					</dl>
					<dl>  <!--문서유형-->  
						<dt CL="IFT_DOCUTY"></dt> 
					...
					<dl>  <!--출고요청일-->  
						<dt CL="IFT_OTRQDT"></dt> 
						<dd> 
							<input type="text" class="input" name="V.EXPDAT" id="ORDDAT" UIInput="B" UIFormat="C N"/> 
						</dd> 
					</dl>
					<dl>
					...
					<dl>  <!--부족수량 합계 거점-->  
						<dt CL="STD_REQTYWAR"></dt> 
						<dd> 
							<input type="text" class="input" name="V.WAREKY" UIInput="SR,SHCMCDV"/> 
						</dd> 
					</dl> 
				</div> 
				<div class="btn_tab">
							...
							<table class="table_c">
								<tbody id="gridHeadList">
									<tr CGRow="true">
			    						...
			    						<td GH="90 STD_VDATU" GCol="input,ORDDAT" GF="C">납품요청일 </td>	<!--납품요청일 -->
			    						<td GH="80 IFT_SVBELN" GCol="text,SVBELN" GF="S 40">S/O 번호</td>	<!--S/O 번호-->
			    						<td GH="80 STD_ARV_DD" GCol="input,OTRQDT" GF="C">도착일</td>	<!--도착일-->
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div class="scroll">
							<table class="table_c">
								<tbody id="gridItemList">
									<tr CGRow="true">
										<td GH="40 STD_NUMBER"           GCol="rownum">1</td>  
			    						<td GH="80 STD_SKUG03" GCol="select,SKUG03"><!--소분류-->
			    							<select class="input" commonCombo="SKUG03"><option></option></select>
										</td>	
			    						<td GH="80 IFT_SVBELN" GCol="text,SVBELN" GF="S -2">S/O 번호</td>	<!--S/O 번호-->
			    						<td GH="80 IFT_SKUKEY" GCol="input,SKUKEY,SHSKU_INFO" GF="S 20">제품코드</td>	<!--제품코드-->
			    						<td GH="50 STD_DESC02" GCol="text,DESC02" GF="S 120">규격</td>	<!--규격-->
			    						<td GH="200 STD_DESC01" GCol="text,DESC01" GF="S 200">제품명</td>	<!--제품명-->
			    						<td GH="80 STD_OY01QTY18" GCol="input,QTYORG" GF="N 13,0">요청수량</td>	<!--요청수량-->
			    						<td GH="60 STD_OY01QTY19" GCol="input,BOXQTY" GF="N 17,1">요청수량(BOX)</td>	<!--요청수량(BOX)-->
			    						<td GH="60 STD_BXIQTY" GCol="text,BXIQTY" GF="S 17" style="text-align:right;" >박스입수</td>	<!--박스입수-->
			    						<td GH="60 STD_REMQTY" GCol="input,REMQTY" GF="N 17,0">잔량</td>	<!--잔량-->
			    						<td GH="60 STD_PLIQTY" GCol="text,PLIQTY" GF="S 17" style="text-align:right;" >팔렛당수량</td>	<!--팔렛당수량-->
			    						<td GH="60 STD_PLTQTY" GCol="text,PLTQTY" GF="N 17,2">팔레트수량</td>	<!--팔레트수량-->
			    						<td GH="80 IFT_DUOMKY" GCol="text,DUOMKY" GF="S 220">기본단위</td>	<!--기본단위-->
			    						<td GH="80 STD_ASKU01" GCol="text,ASKU01" GF="S -2">포장단위</td>	<!--포장단위-->
			    						<td GH="80 STD_WGTUNT" GCol="text,WGTUNT" GF="S -2">중량단위</td>	<!--중량단위-->
			    						<td GH="50 STD_UOMKEY" GCol="text,UOMKEY" GF="S -2">단위</td>	<!--단위-->
			    						<td GH="100 IFT_TEXT01" GCol="input,TEXT01" GF="S 100">비고</td>	<!--비고-->
			    						<td GH="80 STD_OY01QTY1" GCol="text,OUTSTK" GF="N 13,0">출고거점재고수량</td>	<!--출고거점재고수량-->
			    						<td GH="80 STD_OY01QTY2" GCol="text,NUM01" GF="N 13,0">출고거점주문수량</td>	<!--출고거점주문수량-->
			    						<td GH="80 STD_OY01QTY3" GCol="text,OUTREQ" GF="N 13,0">출고거점부족재고</td>	<!--출고거점부족재고-->
			    						<td GH="80 STD_OY01QTY4" GCol="text,INNSTK" GF="N 13,0">입고거점재고수량</td>	<!--입고거점재고수량-->
			    						<td GH="80 STD_OY01QTY5" GCol="text,NUM02" GF="N 13,0">입고거점주문수량</td>	<!--입고거점주문수량-->
			    						<td GH="80 STD_OY01QTY6" GCol="text,INNREQ" GF="N 13,0">입고거점부족재고</td>	<!--입고거점부족재고-->
			    						<td GH="80 STD_OY01QTY7" GCol="text,NUM03" GF="N 13,0">안성주문수량</td>	<!--안성주문수량-->
			    						<td GH="80 STD_OY01QTY8" GCol="text,WHQTY1" GF="N 13,0">안성부족재고</td>	<!--안성부족재고-->
			    						<td GH="80 STD_OY01QTY9" GCol="text,NUM04" GF="N 13,0">칠곡주문수량</td>	<!--칠곡주문수량-->
			    						<td GH="80 STD_OY01QTY10" GCol="text,WHQTY2" GF="N 13,0">칠곡부족재고</td>	<!--칠곡부족재고-->
			    						<td GH="80 STD_OY01QTY11" GCol="text,NUM05" GF="N 13,0">김해주문수량</td>	<!--김해주문수량-->
			    						<td GH="80 STD_OY01QTY12" GCol="text,WHQTY3" GF="N 13,0">김해부족재고</td>	<!--김해부족재고-->
			    						<td GH="80 STD_OY01QTY13" GCol="text,NUM06" GF="N 13,0">광주주문수량</td>	<!--광주주문수량-->
			    						<td GH="80 STD_OY01QTY14" GCol="text,WHQTY4" GF="N 13,0">광주부족재고</td>	<!--광주부족재고-->
			    						<td GH="80 STD_OY01QTY15" GCol="text,NUM07" GF="N 13,0">오포주문수량</td>	<!--오포주문수량-->
			    						<td GH="80 STD_OY01QTY16" GCol="text,WHQTY5" GF="N 13,0">오포부족재고</td>	<!--오포부족재고-->
			    						<td GH="80 STD_OY01QTY17" GCol="text,WHQTY6" GF="N 13,0">부족재고합계거점</td>	<!--부족재고합계거점-->
			    						<td GH="80 IFT_STATUS" GCol="text,STATUS" GF="S -2">C:신규,M:변경,D:삭제)</td>	<!--C:신규,M:변경,D:삭제)-->
			    						<td GH="80 IFT_TDATE" GCol="text,TDATE" GF="S -2">yyyymmddhhmmss(생성일자)</td>	<!--yyyymmddhhmmss(생성일자)-->
			    						<td GH="80 IFT_IFFLG" GCol="text,XDATS" GF="S -2">Default:N, 처리완료시:Y, 미사용:X</td>	<!--Default:N, 처리완료시:Y, 미사용:X-->
			    						<td GH="80 IFT_IFFLG" GCol="text,XTIMS" GF="S -2">Default:N, 처리완료시:Y, 미사용:X</td>	<!--Default:N, 처리완료시:Y, 미사용:X-->
			    						<td GH="80 IFT_IFFLG" GCol="text,XSTAT" GF="S -2">Default:N, 처리완료시:Y, 미사용:X</td>	<!--Default:N, 처리완료시:Y, 미사용:X-->
			    						<td GH="80 IFT_ERTXT" GCol="text,ERTXT" GF="S -2">ERR TEXT</td>	<!--ERR TEXT-->
			    						<td GH="80 STD_SKUG02" GCol="text,SKUG02" GF="S -2">중분류</td>	<!--중분류-->
			    						<td GH="80 STD_SKUG05" GCol="text,SKUG05" GF="S -2">제품용도</td>	<!--제품용도-->
			    						<td GH="80 STD_GRSWGT" GCol="text,GRSWGT" GF="N -2,0">포장중량</td>	<!--포장중량-->
			    						<td GH="80 STD_NETWGT" GCol="text,NETWGT" GF="N -2,0">순중량</td>	<!--순중량-->
			    						<td GH="80 STD_SKUG04" GCol="text,SKUG04" GF="S -2">세분류</td>	<!--세분류-->
			    						<td GH="80 STD_ASKU03" GCol="text,ASKU03" GF="S -2">피킹그룹</td>	<!--피킹그룹-->
			    						<td GH="80 STD_LENGTH" GCol="text,LENGTH" GF="N -2,0">포장가로</td>	<!--포장가로-->
			    						<td GH="80 STD_WIDTHW" GCol="text,WIDTHW" GF="N -2,0">포장세로</td>	<!--포장세로-->
			    						<td GH="80 STD_HEIGHT" GCol="text,HEIGHT" GF="N -2,0">포장높이</td>	<!--포장높이-->
			    						<td GH="80 STD_CUBICM" GCol="text,CUBICM" GF="N -2,0">CBM</td>	<!--CBM-->
			    						<td GH="80 STD_CAPACT" GCol="text,CAPACT" GF="N -2,0">CAPA</td>	<!--CAPA-->
			    						<td GH="80 STD_ASKU04" GCol="text,ASKU04" GF="S -2">제품구분</td>	<!--제품구분-->
			    						<td GH="80 STD_ASKU05" GCol="text,ASKU05" GF="S -2">상온구분</td>	<!--상온구분-->
			    						<td GH="80 STD_EANCOD" GCol="text,EANCOD" GF="S -2">BARCODE(88코드)</td>	<!--BARCODE(88코드)-->
			    						<td GH="80 STD_GTINCD" GCol="text,GTINCD" GF="S -2">BOX BARCODE</td>	<!--BOX BARCODE-->
			    						<td GH="80 STD_SKUG01" GCol="text,SKUG01" GF="S -2">대분류</td>	<!--대분류-->
									</tr>
								</tbody>
							</table>
						</div>
