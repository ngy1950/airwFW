...
<script type="text/javascript">
	...
	function gridListEventRowDblclick(gridId, rowNum, colName, colValue){
		if(gridId == "gridList2"){
			...
			page.linkPopOpen("/wms/report/pop/OYBzptnList_OY25.page", data, option);
							...
							<table class="table_c">
								<tbody id="gridList1">
									<tr CGRow="true">
			    						...
			    						<td GH="40 STD_WAREKY" GCol="text,WAREKY" GF="S 10">거점</td>	<!-- 거점 -->
			    						<td GH="40 STD_WAREKYNM" GCol="text,NAME01" GF="S 10">거점명</td>	<!-- 거점명 -->
							...
							<table class="table_c">
								<tbody id="gridList2">
									<tr CGRow="true">
			    						...
			    						<td GH="100 STD_OTRQDT2" GCol="text,OTRQDT2" GF="S 10">출고예정일</td>	<!--출고예정일-->
			    						<td GH="100 STD_OTRQDT" GCol="text,OTRQDT" GF="S 10">출고요청일</td>	<!--출고요청일-->
			    						<td GH="60 STD_CARNUM" GCol="text,CARNUM" GF="S 20">차량번호</td>	<!--차량번호-->
			    						<td GH="130 STD_DRCARNUM" GCol="text,CNUMNM" GF="S 20">배송코스</td>	<!--배송코스-->
