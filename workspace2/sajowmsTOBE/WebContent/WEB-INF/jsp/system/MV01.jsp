...
<script type="text/javascript">
	...
	function saveData(){
		if(gridList.validationCheck("gridItemList", "select")){
			...
			netUtil.send({
				url : "/inventory/json/saveMV01.data",
				param : param,
...
<!-- 											<td GH="100" GCol="text,DOCCATNM"></td> -->
											...
											<td GH="100" GCol="text,TASOTYNM"></td>
											<td GH="100" GCol="text,STATDO"></td>
											<td GH="100" GCol="text,STATDONM"></td>
								...
								<table class="table_c">
									<tbody id=gridItemList>
										<tr CGRow="true">
											...
											<td GH="100 STD_QTSAVLB" GCol="text,QTSIWH" GF="N"></td>
											<td GH="100" GCol="text,DUOMKY"></td>
											<td GH="100" GCol="input,QTTAOR" GF="N 20" validate="required max(GRID_COL_QTSIWH_*),INV_M0715 min(1)"></td>
											<td GH="100" GCol="input,LOCATG" GF="S 20" validate="required"></td>
<!-- VZ											<td GH="100" GCol="text,LOTA01"></td>	 -->
