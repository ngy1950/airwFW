...
<script type="text/javascript">
	$(document).ready(function(){
		gridList.setGrid({
	    	...
	    	module : "System",
			command : "RC01",
			pkcol : "COMPKY,DOCCAT,DOCUTY,RSNCOD",
			menuId : "RC01"
	    });
	});
			...
			<div class="search_inner">
				<div class="search_wrap ">
					...
					<dl>
						<dt CL="STD_DOCCAT"></dt>
						<dd>
							<input type="text" class="input" name="DOCCAT"  UIFormat="U"/>
						</dd>
					</dl>
					<dl>
						<dt CL="STD_DOCUTY"></dt>
						<dd>
							<input type="text" class="input" name="DOCUTY"  UIFormat="U"/>
						</dd>
					</dl>
				</div>
				<div class="btn_tab">
								...
								<table class="table_c">
									<tbody id="gridList">
										<tr CGRow="true">
											...
											<td GH="100"     GCol="input,DOCCAT"			GF="U 4"	validate="required"></td>
											<td GH="100"     GCol="input,DOCUTY" 			GF="U 8"	validate="required"></td>
											<td GH="100"     GCol="input,RSNCOD" 			GF="U 4"	validate="required"></td>
											<td GH="100"     GCol="input,SHORTX" 			GF="S 180"></td>
                                            <td GH="200"     GCol="input,DIFLOC" 			GF="S 20"></td>
