	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_SYSEDIERR"></th>
						<td>
							<input type="text" name="SYSEDIERR" IAname="SYSEDIERR"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,EDIITEM"></td>
												<td GH="140" GCol="input,ERRTYPE"></td>
												<td GH="140" GCol="input,EDIDATA"></td>
												<td GH="140" GCol="input,DBDATA"></td>
												<td GH="140" GCol="input,EXCDATA"></td>
