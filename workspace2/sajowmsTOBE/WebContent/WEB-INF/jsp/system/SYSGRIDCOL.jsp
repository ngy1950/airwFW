	...
	<div class="searchInnerContainer">
		...
		<div class="searchInBox">
			...
			<table class="table type1">
				...
				<tbody>
					<tr>
						<th CL="STD_SYSGRIDCOL"></th>
						<td>
							<input type="text" name="SYSGRIDCOL" IAname="SYSGRIDCOL"/>
						</td>
					</tr>
				</tbody>
			</table>
									...
									<table>
										<tbody id="gridList">
											<tr CGRow="true">
												...
												<td GH="140" GCol="input,GRIDID"></td>
												<td GH="140" GCol="input,COLGID"></td>
												<td GH="140" GCol="input,GROUPDATA"></td>
