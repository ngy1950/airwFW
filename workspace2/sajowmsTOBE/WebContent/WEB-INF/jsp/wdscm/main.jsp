...
<frameset id="topFrame" name="topFrame" rows="80px,*" noresize framespacing=0 frameborder=no border=0 >
    <frame id="header" name="header" src="/wdscm/top.data" noresize framespacing=0 frameborder=no border=0 scrolling="no">
    <frameset id="middleFrame" name="middleFrame" cols="280px,*" noresize framespacing=0 frameborder=no border=0 >
        ...
        <frame id="left" name="left" src="/wdscm/left.data" name="lnb" noresize framespacing=0 frameborder=no border=0>
        <frameset id="rightFrame" name="rightFrame" rows="40px,*,0,0,0,0,0" noresize framespacing=0 frameborder=no border=0 >
			...
			<frame id="main" name="main" src="/wdscm/info.page" noresize framespacing=0 frameborder=no border=0>
