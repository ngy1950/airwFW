...
//             	$.cookie("ownrky",$('#OWNRKY').val(),{expries:7});
//             	$.cookie("wareky",$('#WAREKY').val(),{expries:7});
	...
	<div class="show">
		...
		<div class="signin" id="searchArea">
		    <div class="inputbox">
			    ...
			    <select name="OWNRKY" id="OWNRKY"  class="input" Combo="" ComboCodeView="true">
			    </select>
...
<!-- 			    <button class="find_IDPW" onClick="window.open('/FIND_IDPW_POP.jsp','idfind','width=560,height=510,location=no,status=no,scrollbars=no');" style="padding-left: 15px;">ID/비밀번호 찾기</button> -->
			    <button class="find_IDPW"  onclick="linkEZ()">프린트 설치</button>
		    </div>
		    <div class="login_btn">
