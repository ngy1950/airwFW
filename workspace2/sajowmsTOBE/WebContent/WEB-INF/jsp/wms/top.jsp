...
$(document).ready(function(){
	...
	$("#LINKURL").on("change",function(){
		window.open(this.value, this.text, "height=800,width=900,resizable=yes");
	});
...
function linkurl(){
	...
	var json = netUtil.sendData({
		module : "Common",
		command : "LINKURLCOMBO",
		sendType : "list",
		param : param
	});

	$("#LINKURL").find("[UIOption]").remove();

	var optionHtml = inputList.selectHtml(json.data, false);
	$("#LINKURL").append(optionHtml);
...
<body style="min-width:1100px">
	<div class="content_top" >
		...
		<ul class="header_right">
			...
			<li class="link_chk"><a href="#none"><span>LINK</span></a></li>
			<select id="LINKURL" style="width:200px;height:40px;"><option></option></select>
			<li class="user_nm"><span><%=username%></span> 님</li>
