ConfigData = function() {
	...
	this.GRID_COLOR_BG_YELLOW_CLASS2 = "gridColorBgYellow2";
	/* 추가 */
	this.GRID_COLOR_BG_BRIGHT_RED_CLASS = "gridColorbrightRed";
	this.GRID_COLOR_BG_BGBRIGHT_YELLOW_CLASS = "gridColorBgbrightYellow";
	this.GRID_COLOR_BG_NAVY2_CLASS = "gridColorBgNavy2";
	this.GRID_COLOR_BG_NAVY3_CLASS = "gridColorBgNavy3";
	this.GRID_COLOR_BG_WHITE_CLASS = "gridColorBgWhite";
	...
	this.DATA_EXCEL_FORMAT_NUMBER_KEY = "dataExcelFormatNumber";
...
//	this.VALIDATE_MSG.put("image","이미지형식이 맞지않습니다.");							//VALID_image
	...
	this.VARIANT_RANGE_PARAM = "VARIANT_RANGE_PARAM";
};
