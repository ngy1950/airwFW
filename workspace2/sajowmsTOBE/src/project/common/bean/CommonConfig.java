...
public class CommonConfig {
	...
	public final static String DATA_EXCEL_FORMAT_NUMBER_KEY = "dataExcelFormatNumber";
	...
	public final static String SES_USER_ID_CHK_KEY = "SES_USER_CHK_ID"; //사용자 확인 ID
	...
	public final static String SES_USER_OWNER_NM_KEY      = "SES_OWNERNMKY";//회사대표자명
	public final static String SESSION_KEY_OWNER_MANAGE	= "SESSION_KEY_OWNER_MANAGE"; //화주별 관리 키
	...
	public final static String SES_USER_ROOT_MENU_KEY = "SES_ROOT_USER_MENU"; //사용자  최상위 메뉴
	public final static String SES_USER_MENU_KEY = "SES_USER_MENU"; //사용자 메뉴
	public final static String SES_USER_FMENU_KEY = "SES_USER_FMENU"; //사용자  즐겨찾기 메뉴
	...
	public final static String INPUT_PARAM_GROUP = "PGroup";
	...
	public final static String MEMBERSHIP_APPLY_CODE = "membershipAplcod";
	
	//접속 환경
	public final static String SES_ENV_KEY = "SES_ENV";
	
	
	//구버전 로그인
	public static final String SESSION_KEY_USER = "SESSION_KEY_USER"; //세션정보의 사용자빈에 해당되는 환경변수 명
	public static final String SESSION_KEY_USERIP = "SESSION_KEY_USERIP"; //LOGIN 유저 IP 세션 저장
	public static final String SESSION_KEY_USER_BROWSER = "SESSION_KEY_USER_BROWSER"; // LOGIN 유저 브라우저 저장
	public static final String SESSION_KEY_USER_OS = "SESSION_KEY_USER_OS"; // LOGIN 유저 OS 저장
	

	//2021.03.03 get/save variant 
	public final static String VARIANT_RANGE_PARAM = "VARIANT_RANGE_PARAM";
	
	//schema
	public final static String SES_SCHEMA = "SES_SCHEMA";

	//2021.05. 10 운영/개발 구분  
	public final static String DIV_REAL_TEST = "REAL_TEST";
